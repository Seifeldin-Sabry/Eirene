...
*/
(function(){function pa(h,m){h.prototype=eb(m.prototype);h.prototype.constructor=h;h.base=m.prototype}function eb(h){function m(){}m.prototype=h;return new m}function Xa(h,m,E){"millisecond"===E?h.setMilliseconds(h.getMilliseconds()+1*m):"second"===E?h.setSeconds(h.getSeconds()+1*m):"minute"===E?h.setMinutes(h.getMinutes()+1*m):"hour"===E?h.setHours(h.getHours()+1*m):"day"===E?h.setDate(h.getDate()+1*m):"week"===E?h.setDate(h.getDate()+7*m):"month"===E?h.setMonth(h.getMonth()+1*m):"year"===E&&h.setFullYear(h.getFullYear()+
1*m);return h}function ca(h,m){var E=!1;0>h&&(E=!0,h*=-1);h=""+h;for(m=m?m:1;h.length<m;)h="0"+h;return E?"-"+h:h}function Ga(h){if(!h)return h;h=h.replace(/^\s\s*/,"");for(var m=/\s/,E=h.length;m.test(h.charAt(--E)););return h.slice(0,E+1)}function Ca(h){h.roundRect=function(h,E,s,w,ra,A,D,v){D&&(this.fillStyle=D);v&&(this.strokeStyle=v);"undefined"===typeof ra&&(ra=5);this.lineWidth=A;this.beginPath();this.moveTo(h+ra,E);this.lineTo(h+s-ra,E);this.quadraticCurveTo(h+s,E,h+s,E+ra);this.lineTo(h+
s,E+w-ra);this.quadraticCurveTo(h+s,E+w,h+s-ra,E+w);this.lineTo(h+ra,E+w);this.quadraticCurveTo(h,E+w,h,E+w-ra);this.lineTo(h,E+ra);this.quadraticCurveTo(h,E,h+ra,E);this.closePath();D&&this.fill();v&&0<A&&this.stroke()}}function Ra(h,m){return h-m}function O(h){var m=((h&16711680)>>16).toString(16),E=((h&65280)>>8).toString(16);h=((h&255)>>0).toString(16);m=2>m.length?"0"+m:m;E=2>E.length?"0"+E:E;h=2>h.length?"0"+h:h;return"#"+m+E+h}function fb(h,m){var E=this.length>>>0,s=Number(m)||0,s=0>s?Math.ceil(s):
Math.floor(s);for(0>s&&(s+=E);s<E;s++)if(s in this&&this[s]===h)return s;return-1}function s(h){return null===h||"undefined"===typeof h}function Da(h){h.indexOf||(h.indexOf=fb);return h}function gb(h){if(S.fSDec)h[ja("`eeDwdouMhrudods")](ja("e`u`@ohl`uhnoHuds`uhnoDoe"),function(){S._fTWm&&S._fTWm(h)})}function Ya(h,m,E){E=E||"normal";var s=h+"_"+m+"_"+E,w=Za[s];if(isNaN(w)){try{if(!sa){var ra=document.body;sa=document.createElement("span");sa.innerHTML="";var A=document.createTextNode("Mpgyi");sa.appendChild(A);
ra.appendChild(sa)}sa.style.display="";H(sa,{position:"absolute",left:"0px",top:"-20000px",padding:"0px",margin:"0px",border:"none",whiteSpace:"pre",lineHeight:"normal",fontFamily:h,fontSize:m+"px",fontWeight:E});w=Math.round(sa.offsetHeight);sa.style.display="none"}catch(D){w=Math.ceil(1.1*m)}w=Math.max(w,m);Za[s]=w}return w}function J(h,m){var E=[];if(E={solid:[],shortDash:[3,1],shortDot:[1,1],shortDashDot:[3,1,1,1],shortDashDotDot:[3,1,1,1,1,1],dot:[1,2],dash:[4,2],dashDot:[4,2,1,2],longDash:[8,
2],longDashDot:[8,2,1,2],longDashDotDot:[8,2,1,2,1,2]}[h||"solid"])for(var s=0;s<E.length;s++)E[s]*=m;else E=[];return E}function R(h,m,E,w,ia){w=w||[];ia=s(ia)?hb?{passive:!1,capture:!1}:!1:ia;w.push([h,m,E,ia]);return h.addEventListener?(h.addEventListener(m,E,ia),E):h.attachEvent?(w=function(m){m=m||window.event;m.preventDefault=m.preventDefault||function(){m.returnValue=!1};m.stopPropagation=m.stopPropagation||function(){m.cancelBubble=!0};E.call(h,m)},h.attachEvent("on"+m,w),w):!1}function ib(h){if(h._menuButton)h.exportEnabled?
(H(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor}),La(h._menuButton),h._menuButton.title=h._cultureInfo.menuText):va(h._menuButton);else if(h.exportEnabled&&w){var m=!1;h._menuButton=document.createElement("button");wa(h,h._menuButton,"menu");h._toolBar.appendChild(h._menuButton);R(h._menuButton,"touchstart",function(h){m=!0},h.allDOMEventHandlers);R(h._menuButton,"click",function(){"none"!==h._dropdownMenu.style.display||h._dropDownCloseTime&&500>=(new Date).getTime()-
h._dropDownCloseTime.getTime()||(h._dropdownMenu.style.display="block",h._menuButton.blur(),h._dropdownMenu.focus())},h.allDOMEventHandlers,!0);R(h._menuButton,"mousemove",function(){m||(H(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColorOnHover,color:h.toolbar.fontColorOnHover}),0>=navigator.userAgent.search("MSIE")&&H(h._menuButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},h.allDOMEventHandlers,!0);R(h._menuButton,"mouseout",function(){m||(H(h._menuButton,{backgroundColor:h.toolbar.itemBackgroundColor,
color:h.toolbar.fontColor}),0>=navigator.userAgent.search("MSIE")&&H(h._menuButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},h.allDOMEventHandlers,!0)}if(h.exportEnabled&&h._dropdownMenu){H(h._dropdownMenu,{backgroundColor:h.toolbar.itemBackgroundColor,color:h.toolbar.fontColor});for(var E=h._dropdownMenu.childNodes,s=[h._cultureInfo.printText,h._cultureInfo.saveJPGText,h._cultureInfo.savePNGText],ia=0;ia<E.length;ia++)H(E[ia],{backgroundColor:h.toolbar.itemBackgroundColor,
color:h.toolbar.fontColor}),E[ia].innerHTML=s[ia]}else!h._dropdownMenu&&(h.exportEnabled&&w)&&(m=!1,h._dropdownMenu=document.createElement("div"),h._dropdownMenu.setAttribute("tabindex",-1),E=-1!==h.theme.indexOf("dark")?"black":"#888888",H(h._dropdownMenu,{position:"absolute",zIndex:1,userSelect:"none",MozUserSeelct:"none",WebkitUserSelect:"none",msUserSelect:"none",cursor:"pointer",right:"0px",top:"25px",minWidth:"120px",outline:0,fontSize:"14px",fontFamily:"Arial, Helvetica, sans-serif",padding:"5px 0px 5px 0px",
textAlign:"left",lineHeight:"10px",backgroundColor:h.toolbar.itemBackgroundColor,boxShadow:"2px 2px 10px"+E}),h._dropdownMenu.style.display="none",h._toolBar.appendChild(h._dropdownMenu),R(h._dropdownMenu,"blur",function(){va(h._dropdownMenu);h._dropDownCloseTime=new Date},h.allDOMEventHandlers,!0),E=document.createElement("div"),H(E,{padding:"12px 8px 12px 8px"}),E.innerHTML=h._cultureInfo.printText,E.style.backgroundColor=h.toolbar.itemBackgroundColor,E.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(E),
R(E,"touchstart",function(h){m=!0},h.allDOMEventHandlers),R(E,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),R(E,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),R(E,"click",function(){h.print();va(h._dropdownMenu)},h.allDOMEventHandlers,!0),E=document.createElement("div"),H(E,{padding:"12px 8px 12px 8px"}),
E.innerHTML=h._cultureInfo.saveJPGText,E.style.backgroundColor=h.toolbar.itemBackgroundColor,E.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(E),R(E,"touchstart",function(h){m=!0},h.allDOMEventHandlers),R(E,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),R(E,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},
h.allDOMEventHandlers,!0),R(E,"click",function(){h.exportChart({format:"jpeg",fileName:h.exportFileName});va(h._dropdownMenu)},h.allDOMEventHandlers,!0),E=document.createElement("div"),H(E,{padding:"12px 8px 12px 8px"}),E.innerHTML=h._cultureInfo.savePNGText,E.style.backgroundColor=h.toolbar.itemBackgroundColor,E.style.color=h.toolbar.fontColor,h._dropdownMenu.appendChild(E),R(E,"touchstart",function(h){m=!0},h.allDOMEventHandlers),R(E,"mousemove",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColorOnHover,
this.style.color=h.toolbar.fontColorOnHover)},h.allDOMEventHandlers,!0),R(E,"mouseout",function(){m||(this.style.backgroundColor=h.toolbar.itemBackgroundColor,this.style.color=h.toolbar.fontColor)},h.allDOMEventHandlers,!0),R(E,"click",function(){h.exportChart({format:"png",fileName:h.exportFileName});va(h._dropdownMenu)},h.allDOMEventHandlers,!0))}function $a(h,m,E){h*=la;m*=la;h=E.getImageData(h,m,2,2).data;m=!0;for(E=0;4>E;E++)if(h[E]!==h[E+4]|h[E]!==h[E+8]|h[E]!==h[E+12]){m=!1;break}return m?
h[0]<<16|h[1]<<8|h[2]:0}function ma(h,m,E){return h in m?m[h]:E[h]}function Ma(h,m,E){if(w&&ab){var s=h.getContext("2d");Na=s.webkitBackingStorePixelRatio||s.mozBackingStorePixelRatio||s.msBackingStorePixelRatio||s.oBackingStorePixelRatio||s.backingStorePixelRatio||1;la=Sa/Na;h.width=m*la;h.height=E*la;Sa!==Na&&(h.style.width=m+"px",h.style.height=E+"px",s.scale(la,la))}else h.width=m,h.height=E}function jb(h){if(!kb){var m=!1,s=!1;"undefined"===typeof qa.Chart.creditHref?(h.creditHref=ja("iuuqr;..b`ow`rkr/bnl."),
h.creditText=ja("B`ow`rKR/bnl")):(m=h.updateOption("creditText"),s=h.updateOption("creditHref"));if(h.creditHref&&h.creditText){h._creditLink||(h._creditLink=document.createElement("a"),h._creditLink.setAttribute("class","canvasjs-chart-credit"),h._creditLink.setAttribute("title","JavaScript Charts"),H(h._creditLink,{outline:"none",margin:"0px",position:"absolute",right:"2px",top:h.height-14+"px",color:"dimgrey",textDecoration:"none",fontSize:"11px",fontFamily:"Calibri, Lucida Grande, Lucida Sans Unicode, Arial, sans-serif"}),
h._creditLink.setAttribute("tabIndex",-1),h._creditLink.setAttribute("target","_blank"));if(0===h.renderCount||m||s)h._creditLink.setAttribute("href",h.creditHref),h._creditLink.innerHTML=h.creditText;h._creditLink&&h.creditHref&&h.creditText?(h._creditLink.parentElement||h._canvasJSContainer.appendChild(h._creditLink),h._creditLink.style.top=h.height-14+"px"):h._creditLink.parentElement&&h._canvasJSContainer.removeChild(h._creditLink)}}}function ua(h,m){Ha&&(this.canvasCount|=0,window.console.log(++this.canvasCount));
var s=document.createElement("canvas");s.setAttribute("class","canvasjs-chart-canvas");Ma(s,h,m);w||"undefined"===typeof G_vmlCanvasManager||G_vmlCanvasManager.initElement(s);return s}function H(h,m){for(var s in m)h.style[s]=m[s]}function wa(h,m,s){m.getAttribute("state")||(m.style.backgroundColor=h.toolbar.itemBackgroundColor,m.style.color=h.toolbar.fontColor,m.style.border="none",H(m,{WebkitUserSelect:"none",MozUserSelect:"none",msUserSelect:"none",userSelect:"none"}));m.getAttribute("state")!==
s&&(m.setAttribute("state",s),m.setAttribute("type","button"),H(m,{padding:"5px 12px",cursor:"pointer","float":"left",width:"40px",height:"25px",outline:"0px",verticalAlign:"baseline",lineHeight:"0"}),m.setAttribute("title",h._cultureInfo[s+"Text"]),m.innerHTML="<img src='"+lb[s].image+"' alt='"+h._cultureInfo[s+"Text"]+"' />",H(m.childNodes[0],{height:"95%",pointerEvents:"none"}))}function La(){for(var h=null,m=0;m<arguments.length;m++)h=arguments[m],h.style&&(h.style.display="inline")}function va(){for(var h=
null,m=0;m<arguments.length;m++)(h=arguments[m])&&h.style&&(h.style.display="none")}function Ta(h,m,s,w,ia){if(null===h||"undefined"===typeof h)return"undefined"===typeof s?m:s;h=parseFloat(h.toString())*(0<=h.toString().indexOf("%")?m/100:1);"undefined"!==typeof w&&(h=Math.min(w,h),"undefined"!==typeof ia&&(h=Math.max(ia,h)));return!isNaN(h)&&h<=m&&0<=h?h:"undefined"===typeof s?m:s}function U(h,m,E,w,ia){this._defaultsKey=h;this._themeOptionsKey=m;this._index=w;this.parent=ia;this._eventListeners=
[];h={};this.theme&&s(this.parent)&&s(m)&&s(w)?h=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[m])&&(null===w?h=this.parent.themeOptions[m]:0<this.parent.themeOptions[m].length&&(w=Math.min(this.parent.themeOptions[m].length-1,w),h=this.parent.themeOptions[m][w]));this.themeOptions=h;this.options=E?E:{_isPlaceholder:!0};this.setOptions(this.options,h)}function Ea(h,m,s,w,ia){"undefined"===
typeof ia&&(ia=0);this._padding=ia;this._x1=h;this._y1=m;this._x2=s;this._y2=w;this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding}function ka(h,m){ka.base.constructor.call(this,"TextBlock",null,m,null,null);this.ctx=h;this._isDirty=!0;this._wrappedText=null;this._initialize()}function Ua(h,m){Ua.base.constructor.call(this,"Toolbar","toolbar",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="toolbar"}function ya(h,m){ya.base.constructor.call(this,
"Title","title",m,null,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="title";if(s(this.options.margin)&&h.options.subtitles)for(var E=h.options.subtitles,w=0;w<E.length;w++)if((s(E[w].horizontalAlign)&&"center"===this.horizontalAlign||E[w].horizontalAlign===this.horizontalAlign)&&(s(E[w].verticalAlign)&&"top"===this.verticalAlign||E[w].verticalAlign===this.verticalAlign)&&!E[w].dockInsidePlotArea===!this.dockInsidePlotArea){this.margin=0;break}"undefined"===typeof this.options.fontSize&&
(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function Ia(h,m,s){Ia.base.constructor.call(this,"Subtitle","subtitles",m,s,h);this.chart=h;this.canvas=h.canvas;this.ctx=this.chart.ctx;this.optionsName="subtitles";this.isOptionsInArray=!0;"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.height=this.width=null;this.bounds={x1:null,y1:null,x2:null,y2:null}}function Va(){this.pool=
[]}function Ja(h){var m;h&&Ka[h]&&(m=Ka[h]);Ja.base.constructor.call(this,"CultureInfo",null,m,null,null)}var Ha=!1,S={},w=!!document.createElement("canvas").getContext,qa={Chart:{width:500,height:400,zoomEnabled:!1,zoomType:"x",backgroundColor:"white",theme:"light1",animationEnabled:!1,animationDuration:1200,dataPointWidth:null,dataPointMinWidth:null,dataPointMaxWidth:null,colorSet:"colorSet1",culture:"en",creditText:"CanvasJS",interactivityEnabled:!0,exportEnabled:!1,exportFileName:"Chart",rangeChanging:null,
...
Ka={en:{}},D=w?"Trebuchet MS, Helvetica, sans-serif":"Arial",Fa=w?"Impact, Charcoal, sans-serif":"Arial",za={colorSet1:"#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #7F6084 #77A033 #33558B #E59566".split(" "),colorSet2:"#6D78AD #51CDA0 #DF7970 #4C9CA0 #AE7D99 #C9D45C #5592AD #DF874D #52BCA8 #8E7AA3 #E3CB64 #C77B85 #C39762 #8DD17E #B57952 #FCC26C".split(" "),colorSet3:"#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")},
K,ba,V,T,Y;ba="#333333";V="#000000";K="#666666";Y=T="#000000";var fa=20,v=14,Wa={colorSet:"colorSet1",backgroundColor:"#FFFFFF",title:{fontFamily:Fa,fontSize:32,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Fa,fontSize:v,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:D,indexLabelFontSize:v,indexLabelFontColor:ba,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:ba,
titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",
spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisX2:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:ba,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,
labelFontSize:v,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:ba,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:D,
labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:ba,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,
labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,
lineDashType:"solid"}}],legend:{fontFamily:D,fontSize:14,fontColor:ba,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:D,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};V=ba="#F5F5F5";K="#FFFFFF";T="#40BAF1";Y="#F5F5F5";var fa=20,v=14,bb={colorSet:"colorSet2",title:{fontFamily:D,
fontSize:33,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"top",margin:5},subtitles:[{fontFamily:D,fontSize:v,fontColor:"#3A3A3A",fontWeight:"normal",verticalAlign:"top",margin:5}],data:[{indexLabelFontFamily:D,indexLabelFontSize:v,indexLabelFontColor:"#666666",indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:"#666666",labelFontWeight:"normal",
lineThickness:1,lineColor:"#BBBBBB",tickThickness:1,tickColor:"#BBBBBB",gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,
lineDashType:"solid"}}],axisX2:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:1,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,
labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:"#666666",titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",
stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],axisY2:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:"#666666",titleFontWeight:"normal",
labelFontFamily:D,labelFontSize:v,labelFontColor:"#666666",labelFontWeight:"normal",lineThickness:0,lineColor:"#BBBBBB",tickColor:"#BBBBBB",tickThickness:1,gridThickness:1,gridColor:"#BBBBBB",stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FFA500",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FFA500",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#EEEEEE",labelFontWeight:"normal",labelBackgroundColor:"black",color:"black",thickness:1,lineDashType:"dot"},
scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#BBBBBB",lineThickness:1,lineDashType:"solid"}}],legend:{fontFamily:D,fontSize:14,fontColor:"#3A3A3A",fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:D,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1},toolbar:{itemBackgroundColor:"white",itemBackgroundColorOnHover:"#2196f3",buttonBorderColor:"#2196f3",buttonBorderThickness:1,fontColor:"black",fontColorOnHover:"white"}};V=ba="#F5F5F5";K="#FFFFFF";
T="#40BAF1";Y="#F5F5F5";fa=20;v=14;Fa={colorSet:"colorSet12",backgroundColor:"#2A2A2A",title:{fontFamily:Fa,fontSize:32,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:Fa,fontSize:v,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:D,indexLabelFontSize:v,
indexLabelFontColor:V,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,
labelFontSize:v,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:D,
labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,
labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,
lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:D,fontSize:14,fontColor:ba,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:D,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:V,backgroundColor:"rgba(0, 0, 0, .7)"}};K="#FFFFFF";V=ba="#FAFAFA";T="#40BAF1";Y="#F5F5F5";
var fa=20,v=14,cb={light1:Wa,light2:bb,dark1:Fa,dark2:{colorSet:"colorSet2",backgroundColor:"#32373A",title:{fontFamily:D,fontSize:32,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5},subtitles:[{fontFamily:D,fontSize:v,fontColor:ba,fontWeight:"normal",verticalAlign:"top",margin:5}],toolbar:{itemBackgroundColor:"#666666",itemBackgroundColorOnHover:"#FF7372",buttonBorderColor:"#FF7372",buttonBorderThickness:1,fontColor:"#F5F5F5",fontColorOnHover:"#F5F5F5"},data:[{indexLabelFontFamily:D,
indexLabelFontSize:v,indexLabelFontColor:V,indexLabelFontWeight:"normal",indexLabelLineThickness:1}],axisX:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,
labelFontSize:v,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisX2:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:V,labelFontWeight:"normal",lineThickness:1,lineColor:K,tickThickness:1,tickColor:K,gridThickness:0,gridColor:K,stripLines:[{labelFontFamily:D,
labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],axisY:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,
labelFontColor:V,labelFontWeight:"normal",lineThickness:0,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#000000",labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,
lineDashType:"solid",color:"#111111"}}],axisY2:[{titleFontFamily:D,titleFontSize:fa,titleFontColor:V,titleFontWeight:"normal",labelFontFamily:D,labelFontSize:v,labelFontColor:V,labelFontWeight:"normal",lineThickness:0,lineColor:K,tickThickness:1,tickColor:K,gridThickness:1,gridColor:K,stripLines:[{labelFontFamily:D,labelFontSize:v,labelFontColor:"#FF7300",labelFontWeight:"normal",labelBackgroundColor:null,color:"#FF7300",thickness:1}],crosshair:{labelFontFamily:D,labelFontSize:v,labelFontColor:"#000000",
labelFontWeight:"normal",labelBackgroundColor:Y,color:T,thickness:1,lineDashType:"dash"},scaleBreaks:{type:"zigzag",spacing:"2%",lineColor:"#777777",lineThickness:1,lineDashType:"solid",color:"#111111"}}],legend:{fontFamily:D,fontSize:14,fontColor:ba,fontWeight:"bold",verticalAlign:"bottom",horizontalAlign:"center"},toolTip:{fontFamily:D,fontSize:14,fontStyle:"normal",cornerRadius:0,borderThickness:1,fontColor:V,backgroundColor:"rgba(0, 0, 0, .7)"}},theme1:Wa,theme2:bb,theme3:Wa},W={numberDuration:1,
yearDuration:314496E5,monthDuration:2592E6,weekDuration:6048E5,dayDuration:864E5,hourDuration:36E5,minuteDuration:6E4,secondDuration:1E3,millisecondDuration:1,dayOfWeekFromInt:"Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" ")};(function(){S.fSDec=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(h[s]-111);return m};S.str={ncv:[189,222,221,156,178,222,220,220,212,225,210,216,208,219,143,197,212,225,226,216,222,221],fntStr:[223,231,143,178,208,219,216,209,225,216,
155,143,187,228,210,216,211,208,143,182,225,208,221,211,212,155,143,187,228,210,216,211,208,143,194,208,221,226,143,196,221,216,210,222,211,212,155,143,176,225,216,208,219,155,143,226,208,221,226,156,226,212,225,216,213],tBl:[227,212,231,227,177,208,226,212,219,216,221,212],fnt:[213,222,221,227],fSy:[213,216,219,219,194,227,232,219,212],fTx:[213,216,219,219,195,212,231,227],gr:[214,225,212,232],ct:[210,227,231],tp:[227,222,223]};delete qa[S.fSDec([178,215,208,225,227])][S.fSDec([210,225,212,211,216,
227,183,225,212,213])];S.pro={sCH:qa[S.fSDec([178,215,208,225,227])][S.fSDec([210,225,212,211,216,227,183,225,212,213])]};S._fTWm=function(h){if("undefined"===typeof S.pro.sCH&&!db){var m=h[S.fSDec(S.str.ct)];m[S.fSDec(S.str.tBl)]=S.fSDec(S.str.tp);m[S.fSDec(S.str.fnt)]=11+S.fSDec(S.str.fntStr);m[S.fSDec(S.str.fSy)]=S.fSDec(S.str.gr);m[S.fSDec(S.str.fTx)](S.fSDec(S.str.ncv),2,h.height-11-2)}}})();var hb=function(){var h=!1;try{var m=Object.defineProperty&&Object.defineProperty({},"passive",{get:function(){h=
!0;return!1}});window.addEventListener&&(window.addEventListener("test",null,m),window.removeEventListener("test",null,m))}catch(s){h=!1}return h}(),Za={},sa=null,mb=function(){this.ctx.clearRect(0,0,this.width,this.height);this.backgroundColor&&(this.ctx.fillStyle=this.backgroundColor,this.ctx.fillRect(0,0,this.width,this.height))},xa=function(h){h.width=1;h.height=1;h.getContext("2d")&&h.getContext("2d").clearRect(0,0,1,1)},nb=function(h,m,s){m=Math.min(this.width,this.height);return Math.max("theme4"===
this.theme?0:300<=m?12:11,Math.round(m*(h/400)))},Aa=function(){var h=/D{1,4}|M{1,4}|Y{1,4}|h{1,2}|H{1,2}|m{1,2}|s{1,2}|f{1,3}|t{1,2}|T{1,2}|K|z{1,3}|"[^"]*"|'[^']*'/g,m="Sunday Monday Tuesday Wednesday Thursday Friday Saturday".split(" "),s="Sun Mon Tue Wed Thu Fri Sat".split(" "),w="January February March April May June July August September October November December".split(" "),ia="Jan Feb Mar Apr May Jun Jul Aug Sep Oct Nov Dec".split(" "),D=/\b(?:[PMCEA][SDP]T|(?:Pacific|Mountain|Central|Eastern|Atlantic) (?:Standard|Daylight|Prevailing) Time|(?:GMT|UTC)(?:[-+]\d{4})?)\b/g,
A=/[^-+\dA-Z]/g;return function(v,J,P){var K=P?P.days:m,O=P?P.months:w,R=P?P.shortDays:s,W=P?P.shortMonths:ia;P="";var S=!1;v=v&&v.getTime?v:v?new Date(v):new Date;if(isNaN(v))throw SyntaxError("invalid date");"UTC:"===J.slice(0,4)&&(J=J.slice(4),S=!0);P=S?"getUTC":"get";var H=v[P+"Date"](),M=v[P+"Day"](),X=v[P+"Month"](),a=v[P+"FullYear"](),d=v[P+"Hours"](),c=v[P+"Minutes"](),b=v[P+"Seconds"](),e=v[P+"Milliseconds"](),f=S?0:v.getTimezoneOffset();return P=J.replace(h,function(l){switch(l){case "D":return H;
case "DD":return ca(H,2);case "DDD":return R[M];case "DDDD":return K[M];case "M":return X+1;case "MM":return ca(X+1,2);case "MMM":return W[X];case "MMMM":return O[X];case "Y":return parseInt(String(a).slice(-2));case "YY":return ca(String(a).slice(-2),2);case "YYY":return ca(String(a).slice(-3),3);case "YYYY":return ca(a,4);case "h":return d%12||12;case "hh":return ca(d%12||12,2);case "H":return d;case "HH":return ca(d,2);case "m":return c;case "mm":return ca(c,2);case "s":return b;case "ss":return ca(b,
2);case "f":return ca(String(e),3).slice(0,1);case "ff":return ca(String(e),3).slice(0,2);case "fff":return ca(String(e),3).slice(0,3);case "t":return 12>d?"a":"p";case "tt":return 12>d?"am":"pm";case "T":return 12>d?"A":"P";case "TT":return 12>d?"AM":"PM";case "K":return S?"UTC":(String(v).match(D)||[""]).pop().replace(A,"");case "z":return(0<f?"-":"+")+Math.floor(Math.abs(f)/60);case "zz":return(0<f?"-":"+")+ca(Math.floor(Math.abs(f)/60),2);case "zzz":return(0<f?"-":"+")+ca(Math.floor(Math.abs(f)/
60),2)+ca(Math.abs(f)%60,2);default:return l.slice(1,l.length-1)}})}}(),da=function(h,m,s){if(null===h)return"";if(!isFinite(h))return h;h=Number(h);var w=0>h?!0:!1;w&&(h*=-1);var D=s?s.decimalSeparator:".",v=s?s.digitGroupSeparator:",",A="";m=String(m);var A=1,J=s="",K=-1,P=[],O=[],S=0,R=0,W=0,H=!1,U=0,J=m.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);m=null;for(var M=0;J&&M<J.length;M++)if(m=J[M],"."===m&&0>K)K=M;else{if("%"===m)A*=100;else if("\u2030"===m){A*=1E3;continue}else if(","===
m[0]&&"."===m[m.length-1]){A/=Math.pow(1E3,m.length-1);K=M+m.length-1;continue}else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||(H=!0);0>K?(P.push(m),"#"===m||"0"===m?S++:","===m&&W++):(O.push(m),"#"!==m&&"0"!==m||R++)}H&&(m=Math.floor(h),J=-Math.floor(Math.log(h)/Math.LN10+1),U=0===h?0:0===m?-(S+J):String(m).length-S,A/=Math.pow(10,U));0>K&&(K=M);A=(h*A).toFixed(R);m=A.split(".");A=(m[0]+"").split("");h=(m[1]+"").split("");A&&"0"===A[0]&&A.shift();for(H=J=M=R=K=0;0<P.length;)if(m=P.pop(),"#"===m||
"0"===m)if(K++,K===S){var X=A,A=[];if("0"===m)for(m=S-R-(X?X.length:0);0<m;)X.unshift("0"),m--;for(;0<X.length;)s=X.pop()+s,H++,0===H%J&&(M===W&&0<X.length)&&(s=v+s)}else 0<A.length?(s=A.pop()+s,R++,H++):"0"===m&&(s="0"+s,R++,H++),0===H%J&&(M===W&&0<A.length)&&(s=v+s);else"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?","===m?(M++,J=H,H=0,0<A.length&&(s=v+s)):s=1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?m.slice(1,m.length-1)+s:m+s:(m=0>U?
m.replace("+","").replace("-",""):m.replace("-",""),s+=m.replace(/[0]+/,function(a){return ca(U,a.length)}));v="";for(P=!1;0<O.length;)m=O.shift(),"#"===m||"0"===m?0<h.length&&0!==Number(h.join(""))?(v+=h.shift(),P=!0):"0"===m&&(v+="0",P=!0):1<m.length&&('"'===m[0]&&'"'===m[m.length-1]||"'"===m[0]&&"'"===m[m.length-1])?v+=m.slice(1,m.length-1):"E"!==m[0]&&"e"!==m[0]||"0"!==m[m.length-1]||!/[eE][+-]*[0]+/.test(m)?v+=m:(m=0>U?m.replace("+","").replace("-",""):m.replace("-",""),v+=m.replace(/[0]+/,function(a){return ca(U,
a.length)}));s+=(P?D:"")+v;return w?"-"+s:s},Oa=function(h){var m=0,s=0;h=h||window.event;h.offsetX||0===h.offsetX?(m=h.offsetX,s=h.offsetY):h.layerX||0==h.layerX?(m=h.layerX,s=h.layerY):(m=h.pageX-h.target.offsetLeft,s=h.pageY-h.target.offsetTop);return{x:m,y:s}},ab=!0,Sa=window.devicePixelRatio||1,Na=1,la=ab?Sa/Na:1,$=function(h,m,s,w,v,D,A,J,K,P,O,R,S){"undefined"===typeof S&&(S=1);A=A||0;J=J||"black";var H=15<w-m&&15<v-s?8:0.35*Math.min(w-m,v-s);h.beginPath();h.moveTo(m,s);h.save();h.fillStyle=
D;h.globalAlpha=S;h.fillRect(m,s,w-m,v-s);h.globalAlpha=1;0<A&&(S=0===A%2?0:0.5,h.beginPath(),h.lineWidth=A,h.strokeStyle=J,h.moveTo(m,s),h.rect(m-S,s-S,w-m+2*S,v-s+2*S),h.stroke());h.restore();!0===K&&(h.save(),h.beginPath(),h.moveTo(m,s),h.lineTo(m+H,s+H),h.lineTo(w-H,s+H),h.lineTo(w,s),h.closePath(),A=h.createLinearGradient((w+m)/2,s+H,(w+m)/2,s),A.addColorStop(0,D),A.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=A,h.fill(),h.restore());!0===P&&(h.save(),h.beginPath(),h.moveTo(m,v),h.lineTo(m+
H,v-H),h.lineTo(w-H,v-H),h.lineTo(w,v),h.closePath(),A=h.createLinearGradient((w+m)/2,v-H,(w+m)/2,v),A.addColorStop(0,D),A.addColorStop(1,"rgba(255, 255, 255, .4)"),h.fillStyle=A,h.fill(),h.restore());!0===O&&(h.save(),h.beginPath(),h.moveTo(m,s),h.lineTo(m+H,s+H),h.lineTo(m+H,v-H),h.lineTo(m,v),h.closePath(),A=h.createLinearGradient(m+H,(v+s)/2,m,(v+s)/2),A.addColorStop(0,D),A.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=A,h.fill(),h.restore());!0===R&&(h.save(),h.beginPath(),h.moveTo(w,
s),h.lineTo(w-H,s+H),h.lineTo(w-H,v-H),h.lineTo(w,v),A=h.createLinearGradient(w-H,(v+s)/2,w,(v+s)/2),A.addColorStop(0,D),A.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=A,A.addColorStop(0,D),A.addColorStop(1,"rgba(255, 255, 255, 0.1)"),h.fillStyle=A,h.fill(),h.closePath(),h.restore())},ja=function(h){for(var m="",s=0;s<h.length;s++)m+=String.fromCharCode(Math.ceil(h.length/57/5)^h.charCodeAt(s));return m},db=window&&window[ja("mnb`uhno")]&&window[ja("mnb`uhno")].href&&window[ja("mnb`uhno")].href.indexOf&&
(-1!==window[ja("mnb`uhno")].href.indexOf(ja("b`ow`rkr/bnl"))||-1!==window[ja("mnb`uhno")].href.indexOf(ja("gdonqhy/bnl"))||-1!==window[ja("mnb`uhno")].href.indexOf(ja("gheemd"))),kb=db&&-1===window[ja("mnb`uhno")].href.indexOf(ja("gheemd")),lb={reset:{image:"data:image/png;base64,"},
...
U.prototype.setOptions=function(h,m){if(qa[this._defaultsKey]){var s=qa[this._defaultsKey],w;for(w in s)"publicProperties"!==w&&s.hasOwnProperty(w)&&(this[w]=h&&w in h?h[w]:m&&w in m?m[w]:s[w])}else Ha&&window.console&&console.log("defaults not set")};U.prototype.get=function(h){var m=qa[this._defaultsKey];if("options"===h)return this.options&&this.options._isPlaceholder?null:this.options;if(m.hasOwnProperty(h)||m.publicProperties&&m.publicProperties.hasOwnProperty(h))return this[h];window.console&&
window.console.log('Property "'+h+"\" doesn't exist. Please check for typo.")};U.prototype.set=function(h,m,s){s="undefined"===typeof s?!0:s;var w=qa[this._defaultsKey];if("options"===h)this.createUserOptions(m);else if(w.hasOwnProperty(h)||w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readWrite"===w.publicProperties[h])this.options._isPlaceholder&&this.createUserOptions(),this.options[h]=m;else{window.console&&(w.publicProperties&&w.publicProperties.hasOwnProperty(h)&&"readOnly"===w.publicProperties[h]?
window.console.log('Property "'+h+'" is read-only.'):window.console.log('Property "'+h+"\" doesn't exist. Please check for typo."));return}s&&(this.stockChart||this.chart||this).render()};U.prototype.addTo=function(h,m,s,w){w="undefined"===typeof w?!0:w;var v=qa[this._defaultsKey];v.hasOwnProperty(h)||v.publicProperties&&v.publicProperties.hasOwnProperty(h)&&"readWrite"===v.publicProperties[h]?(this.options._isPlaceholder&&this.createUserOptions(),"undefined"===typeof this.options[h]&&(this.options[h]=
...
this.parent.createUserOptions(),this.isOptionsInArray){this.parent.options[this.optionsName]||(this.parent.options[this.optionsName]=[]);var m=this.parent.options[this.optionsName],s=m.length;this.options._isPlaceholder||(Da(m),s=m.indexOf(this.options));this.options="undefined"===typeof h?{}:h;m[s]=this.options}else this.options="undefined"===typeof h?{}:h,h=this.parent.options,this.optionsName?m=this.optionsName:(m=this._defaultsKey)&&0!==m.length?(s=m.charAt(0).toLowerCase(),1<m.length&&(s=s.concat(m.slice(1))),
m=s):m=void 0,h[m]=this.options};U.prototype.remove=function(h){h="undefined"===typeof h?!0:h;if(this.isOptionsInArray){var m=this.parent.options[this.optionsName];Da(m);var s=m.indexOf(this.options);0<=s&&m.splice(s,1)}else delete this.parent.options[this.optionsName];h&&(this.stockChart||this.chart||this).render()};U.prototype.updateOption=function(h){!qa[this._defaultsKey]&&(Ha&&window.console)&&console.log("defaults not set");var m=qa[this._defaultsKey],w={},v=this[h],D=this._themeOptionsKey,
J=this._index;this.theme&&s(this.parent)&&s(D)&&s(J)?w=s(this.predefinedThemes[this.theme])?this.predefinedThemes.light1:this.predefinedThemes[this.theme]:this.parent&&(this.parent.themeOptions&&this.parent.themeOptions[D])&&(null===J?w=this.parent.themeOptions[D]:0<this.parent.themeOptions[D].length&&(w=Math.min(this.parent.themeOptions[D].length-1,J),w=this.parent.themeOptions[D][w]));this.themeOptions=w;h in m&&(v=h in this.options?this.options[h]:w&&h in w?w[h]:m[h]);if(v===this[h])return!1;this[h]=
...
this._eventListeners[h]||[],this._eventListeners[h].push({context:s||this,eventHandler:m}))};U.prototype.removeEventListener=function(h,m){if(h&&m&&this._eventListeners[h])for(var s=this._eventListeners[h],w=0;w<s.length;w++)if(s[w].eventHandler===m){s[w].splice(w,1);break}};U.prototype.removeAllEventListeners=function(){this._eventListeners=[]};U.prototype.dispatchEvent=function(h,m,s){if(h&&this._eventListeners[h]){m=m||{};for(var w=this._eventListeners[h],v=0;v<w.length;v++)w[v].eventHandler.call(w[v].context,
m)}"function"===typeof this[h]&&this[h].call(s||this.chart,m)};Ea.prototype.registerSpace=function(h,m){"top"===h?this._topOccupied+=m.height:"bottom"===h?this._bottomOccupied+=m.height:"left"===h?this._leftOccupied+=m.width:"right"===h&&(this._rightOccupied+=m.width)};Ea.prototype.unRegisterSpace=function(h,m){"top"===h?this._topOccupied-=m.height:"bottom"===h?this._bottomOccupied-=m.height:"left"===h?this._leftOccupied-=m.width:"right"===h&&(this._rightOccupied-=m.width)};Ea.prototype.getFreeSpace=
function(){return{x1:this._x1+this._leftOccupied,y1:this._y1+this._topOccupied,x2:this._x2-this._rightOccupied,y2:this._y2-this._bottomOccupied,width:this._x2-this._x1-this._rightOccupied-this._leftOccupied,height:this._y2-this._y1-this._bottomOccupied-this._topOccupied}};Ea.prototype.reset=function(){this._rightOccupied=this._leftOccupied=this._bottomOccupied=this._topOccupied=this._padding};pa(ka,U);ka.prototype._initialize=function(){s(this.padding)||"object"!==typeof this.padding?this.topPadding=
this.rightPadding=this.bottomPadding=this.leftPadding=Number(this.padding)|0:(this.topPadding=s(this.padding.top)?0:Number(this.padding.top)|0,this.rightPadding=s(this.padding.right)?0:Number(this.padding.right)|0,this.bottomPadding=s(this.padding.bottom)?0:Number(this.padding.bottom)|0,this.leftPadding=s(this.padding.left)?0:Number(this.padding.left)|0)};ka.prototype.render=function(h){if(0!==this.fontSize){h&&this.ctx.save();var m=this.ctx.font;this.ctx.textBaseline=this.textBaseline;var s=0;this._isDirty&&
this.measureText(this.ctx);this.ctx.translate(this.x,this.y+s);"middle"===this.textBaseline&&(s=-this._lineHeight/2);this.ctx.font=this._getFontString();this.ctx.rotate(Math.PI/180*this.angle);var w=0,v=this.topPadding,D=null;this.ctx.roundRect||Ca(this.ctx);(0<this.borderThickness&&this.borderColor||this.backgroundColor)&&this.ctx.roundRect(0,s,this.width,this.height,this.cornerRadius,this.borderThickness,this.backgroundColor,this.borderColor);this.ctx.fillStyle=this.fontColor;for(s=0;s<this._wrappedText.lines.length;s++){D=
this._wrappedText.lines[s];if("right"===this.horizontalAlign||"right"===this.textAlign)w=this.width-D.width-this.rightPadding;else if("left"===this.horizontalAlign||"left"===this.textAlign)w=this.leftPadding;else if("center"===this.horizontalAlign||"center"===this.textAlign)w=(this.width-(this.leftPadding+this.rightPadding))/2-D.width/2+this.leftPadding;this.ctx.fillText(D.text,w,v);v+=D.height}this.ctx.font=m;h&&this.ctx.restore()}};ka.prototype.setText=function(h){this.text=h;this._isDirty=!0;this._wrappedText=
null};ka.prototype.measureText=function(){this._lineHeight=Ya(this.fontFamily,this.fontSize,this.fontWeight);if(null===this.maxWidth)throw"Please set maxWidth and height for TextBlock";this._wrapText(this.ctx);this._isDirty=!1;return{width:this.width,height:this.height}};ka.prototype._getLineWithWidth=function(h,m,s){h=String(h);if(!h)return{text:"",width:0};var w=s=0,v=h.length-1,D=Infinity;for(this.ctx.font=this._getFontString();w<=v;){var D=Math.floor((w+v)/2),A=h.substr(0,D+1);s=this.ctx.measureText(A).width;
if(s<m)w=D+1;else if(s>m)v=D-1;else break}s>m&&1<A.length&&(A=A.substr(0,A.length-1),s=this.ctx.measureText(A).width);m=!0;if(A.length===h.length||" "===h[A.length])m=!1;m&&(h=A.split(" "),1<h.length&&h.pop(),A=h.join(" "),s=this.ctx.measureText(A).width);return{text:A,width:s}};ka.prototype._wrapText=function(){var h=new String(Ga(String(this.text))),m=[],s=this.ctx.font,w=0,v=0;this.ctx.font=this._getFontString();if(0===this.frontSize)v=w=0;else for(;0<h.length;){var D=this.maxHeight-(this.topPadding+
this.bottomPadding),A=this._getLineWithWidth(h,this.maxWidth-(this.leftPadding+this.rightPadding),!1);A.height=this._lineHeight;m.push(A);var J=v,v=Math.max(v,A.width),w=w+A.height,h=Ga(h.slice(A.text.length,h.length));D&&w>D&&(A=m.pop(),w-=A.height,v=J)}this._wrappedText={lines:m,width:v,height:w};this.width=v+(this.leftPadding+this.rightPadding);this.height=w+(this.topPadding+this.bottomPadding);this.ctx.font=s};ka.prototype._getFontString=function(){var h;h=""+(this.fontStyle?this.fontStyle+" ":
"");h+=this.fontWeight?this.fontWeight+" ":"";h+=this.fontSize?this.fontSize+"px ":"";var m=this.fontFamily?this.fontFamily+"":"";!w&&m&&(m=m.split(",")[0],"'"!==m[0]&&'"'!==m[0]&&(m="'"+m+"'"));return h+=m};pa(Ua,U);pa(ya,U);ya.prototype.setLayout=function(){if(this.text){var h=this.dockInsidePlotArea?this.chart.plotArea:this.chart,m=h.layoutManager.getFreeSpace(),w=m.x1,v=m.y1,D=0,J=0,A=this.chart._menuButton&&this.chart.exportEnabled&&"top"===this.verticalAlign?22:0,H,K;"top"===this.verticalAlign||
"bottom"===this.verticalAlign?(null===this.maxWidth&&(this.maxWidth=m.width-4-A*("center"===this.horizontalAlign?2:1)),J=0.5*m.height-this.margin-2,D=0):"center"===this.verticalAlign&&("left"===this.horizontalAlign||"right"===this.horizontalAlign?(null===this.maxWidth&&(this.maxWidth=m.height-4),J=0.5*m.width-this.margin-2):"center"===this.horizontalAlign&&(null===this.maxWidth&&(this.maxWidth=m.width-4),J=0.5*m.height-4));var P;s(this.padding)||"number"!==typeof this.padding?s(this.padding)||"object"!==
...
backgroundColor:this.backgroundColor,maxWidth:this.maxWidth,maxHeight:J,cornerRadius:this.cornerRadius,text:this.text,padding:this.padding,textBaseline:"top"});P=J.measureText();"top"===this.verticalAlign||"bottom"===this.verticalAlign?("top"===this.verticalAlign?(v=m.y1+2,K="top"):"bottom"===this.verticalAlign&&(v=m.y2-2-P.height,K="bottom"),"left"===this.horizontalAlign?w=m.x1+2:"center"===this.horizontalAlign?w=m.x1+m.width/2-P.width/2:"right"===this.horizontalAlign&&(w=m.x2-2-P.width-A),H=this.horizontalAlign,
this.width=P.width,this.height=P.height):"center"===this.verticalAlign&&("left"===this.horizontalAlign?(w=m.x1+2,v=m.y2-2-(this.maxWidth/2-P.width/2),D=-90,K="left",this.width=P.height,this.height=P.width):"right"===this.horizontalAlign?(w=m.x2-2,v=m.y1+2+(this.maxWidth/2-P.width/2),D=90,K="right",this.width=P.height,this.height=P.width):"center"===this.horizontalAlign&&(v=h.y1+(h.height/2-P.height/2),w=h.x1+(h.width/2-P.width/2),K="center",this.width=P.width,this.height=P.height),H="center");J.x=
w;J.y=v;J.angle=D;J.horizontalAlign=H;this._textBlock=J;h.layoutManager.registerSpace(K,{width:this.width+("left"===K||"right"===K?this.margin+2:0),height:this.height+("top"===K||"bottom"===K?this.margin+2:0)});this.bounds={x1:w,y1:v,x2:w+this.width,y2:v+this.height};this.ctx.textBaseline="top"}};ya.prototype.render=function(){this._textBlock&&this._textBlock.render(!0)};pa(Ia,U);Ia.prototype.setLayout=ya.prototype.setLayout;Ia.prototype.render=ya.prototype.render;Va.prototype.get=function(h,m){var s=
null;0<this.pool.length?(s=this.pool.pop(),Ma(s,h,m)):s=ua(h,m);return s};Va.prototype.release=function(h){this.pool.push(h)};pa(Ja,U);var Pa={addTheme:function(h,s){cb[h]=s},addColorSet:function(h,s){za[h]=s},addCultureInfo:function(h,s){Ka[h]=s},formatNumber:function(h,s,w){w=w||"en";if(Ka[w])return da(h,s||"#,##0.##",new Ja(w));throw"Unknown Culture Name";},formatDate:function(h,s,w){w=w||"en";if(Ka[w])return Aa(h,s||"DD MMM YYYY",new Ja(w));throw"Unknown Culture Name";}};"undefined"!==typeof module&&
"undefined"!==typeof module.exports?module.exports=Pa:"function"===typeof define&&define.amd?define([],function(){return Pa}):(window.CanvasJS&&window.console&&window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."),window.CanvasJS=window.CanvasJS?window.CanvasJS:Pa);D=Pa.Chart=function(){function h(a,d){return a.x-d.x}function m(a,d,c){d=d||{};s(c)?(this.predefinedThemes=cb,this.optionsName=
...
"top",Ca(this.overlaidCanvasCtx)),this._eventManager=new Y(this),this.windowResizeHandler=R(window,"resize",function(){b._updateSize()&&b.render()},this.allDOMEventHandlers),this._toolBar=document.createElement("div"),this._toolBar.setAttribute("class","canvasjs-chart-toolbar"),H(this._toolBar,{position:"absolute",right:"1px",top:"1px"}),this._canvasJSContainer.appendChild(this._toolBar),this.bounds={x1:0,y1:0,x2:this.width,y2:this.height},R(this.overlaidCanvas,"click",function(a){b._mouseEventHandler(a)},
this.allDOMEventHandlers),R(this.overlaidCanvas,"mousemove",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),R(this.overlaidCanvas,"mouseup",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),R(this.overlaidCanvas,"mousedown",function(a){b._mouseEventHandler(a);va(b._dropdownMenu)},this.allDOMEventHandlers),R(this.overlaidCanvas,"mouseout",function(a){b._mouseEventHandler(a)},this.allDOMEventHandlers),R(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerDown":
"touchstart",function(a){b._touchEventHandler(a)},this.allDOMEventHandlers),R(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerMove":"touchmove",function(a){b._touchEventHandler(a)},this.allDOMEventHandlers),R(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerUp":"touchend",function(a){b._touchEventHandler(a)},this.allDOMEventHandlers),R(this.overlaidCanvas,window.navigator.msPointerEnabled?"MSPointerCancel":"touchcancel",function(a){b._touchEventHandler(a)},this.allDOMEventHandlers),
this.toolTip=new T(this,this.options.toolTip),this.data=null,this.axisX=[],this.axisX2=[],this.axisY=[],this.axisY2=[],this.sessionVariables={axisX:[],axisX2:[],axisY:[],axisY2:[]})):window.console&&window.console.log('CanvasJS Error: Chart Container with id "'+this._containerId+'" was not found')}function v(a,d){for(var c=[],b,e=0;e<a.length;e++)if(0==e)c.push(a[0]);else{var f,l,t;t=e-1;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[l].x-a[t].x?0.01:a[l].x-a[t].x))*(d-1)/
2+1;var C=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<C||a[t].x<a[f].x&&0>C?{x:a[t].x+C/3,y:a[t].y+b/3}:{x:a[t].x,y:a[t].y+b/9};t=e;f=0===t?0:t-1;l=t===a.length-1?t:t+1;b=Math.abs((a[l].x-a[f].x)/(0===a[t].x-a[f].x?0.01:a[t].x-a[f].x))*(d-1)/2+1;C=(a[l].x-a[f].x)/b;b=(a[l].y-a[f].y)/b;c[c.length]=a[t].x>a[f].x&&0<C||a[t].x<a[f].x&&0>C?{x:a[t].x-C/3,y:a[t].y-b/3}:{x:a[t].x,y:a[t].y-b/9};c[c.length]=a[e]}return c}function D(a,d,c,b,e,f,l,t,C,k){var n=0;k?(l.color=f,t.color=f):
k=1;n=C?Math.abs(e-c):Math.abs(b-d);n=0<l.trimLength?Math.abs(n*l.trimLength/100):Math.abs(n-l.length);C?(c+=n/2,e-=n/2):(d+=n/2,b-=n/2);var n=1===Math.round(l.thickness)%2?0.5:0,p=1===Math.round(t.thickness)%2?0.5:0;a.save();a.globalAlpha=k;a.strokeStyle=t.color||f;a.lineWidth=t.thickness||2;a.setLineDash&&a.setLineDash(J(t.dashType,t.thickness));a.beginPath();C&&0<t.thickness?(a.moveTo(b-l.thickness/2,Math.round((c+e)/2)-p),a.lineTo(d+l.thickness/2,Math.round((c+e)/2)-p)):0<t.thickness&&(a.moveTo(Math.round((d+
b)/2)-p,c+l.thickness/2),a.lineTo(Math.round((d+b)/2)-p,e-l.thickness/2));a.stroke();a.strokeStyle=l.color||f;a.lineWidth=l.thickness||2;a.setLineDash&&a.setLineDash(J(l.dashType,l.thickness));a.beginPath();C&&0<l.thickness?(a.moveTo(b-n,c),a.lineTo(b-n,e),a.moveTo(d+n,c),a.lineTo(d+n,e)):0<l.thickness&&(a.moveTo(d,c+n),a.lineTo(b,c+n),a.moveTo(d,e-n),a.lineTo(b,e-n));a.stroke();a.restore()}function K(a,d){K.base.constructor.call(this,"Legend","legend",d,null,a);this.chart=a;this.canvas=a.canvas;
this.ctx=this.chart.ctx;this.ghostCtx=this.chart._eventManager.ghostCtx;this.items=[];this.optionsName="legend";this.height=this.width=0;this.orientation=null;this.dataSeries=[];this.bounds={x1:null,y1:null,x2:null,y2:null};"undefined"===typeof this.options.fontSize&&(this.fontSize=this.chart.getAutoFontSize(this.fontSize));this.lineHeight=Ya(this.fontFamily,this.fontSize,this.fontWeight);this.horizontalSpacing=this.fontSize}function V(a,d,c,b){V.base.constructor.call(this,"DataSeries","data",d,c,
...
this.startValue)+(this.endValue.getTime?this.endValue.getTime():this.endValue))/2,this._thicknessType=null)}function ca(a,d,c){ca.base.constructor.call(this,"Crosshair","crosshair",d,null,c);this.chart=a;this.ctx=this.chart.ctx;this.axis=c;this.optionsName="crosshair";this._thicknessType="pixel"}function T(a,d){T.base.constructor.call(this,"ToolTip","toolTip",d,null,a);this.chart=a;this.canvas=a.canvas;this.ctx=this.chart.ctx;this.currentDataPointIndex=this.currentSeriesIndex=-1;this._prevY=this._prevX=
NaN;this.containerTransitionDuration=0.1;this.mozContainerTransition=this.getContainerTransition(this.containerTransitionDuration);this.optionsName="toolTip";this._initialize()}function Y(a){this.chart=a;this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.ghostCanvas=ua(this.chart.width,this.chart.height);this.ghostCtx=this.ghostCanvas.getContext("2d");this.mouseoveredObjectMaps=[]}function ja(a){this.chart=a;this.ctx=this.chart.plotArea.ctx;
this.animations=[];this.animationRequestId=null}pa(m,U);m.prototype.destroy=function(){var a=this.allDOMEventHandlers;this._animator&&this._animator.cancelAllAnimations();this._panTimerId&&clearTimeout(this._panTimerId);for(var d=0;d<a.length;d++){var c=a[d][0],b=a[d][1],e=a[d][2],f=a[d][3],f=f||!1;c.removeEventListener?c.removeEventListener(b,e,f):c.detachEvent&&c.detachEvent("on"+b,e)}this.allDOMEventHandlers=[];for(this.removeAllEventListeners();this._canvasJSContainer&&this._canvasJSContainer.hasChildNodes();)this._canvasJSContainer.removeChild(this._canvasJSContainer.lastChild);
...
new Ua(this,this.options.toolbar);if(this.options.zoomEnabled||this.panEnabled){if(this._zoomButton)H(this._zoomButton,{borderRight:this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor,backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor}),this._zoomButton.title=this._cultureInfo.zoomText;else{var d=!1;va(this._zoomButton=document.createElement("button"));wa(this,this._zoomButton,"pan");this._zoomButton.title=this._cultureInfo.panText;this._toolBar.appendChild(this._zoomButton);
this._zoomButton.style.borderRight=this.toolbar.buttonBorderThickness+"px solid "+this.toolbar.buttonBorderColor;R(this._zoomButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers);R(this._zoomButton,"click",function(){a.zoomEnabled?(a.zoomEnabled=!1,a.panEnabled=!0,wa(a,a._zoomButton,"zoom")):(a.zoomEnabled=!0,a.panEnabled=!1,wa(a,a._zoomButton,"pan"));a.render()},this.allDOMEventHandlers);R(this._zoomButton,"mousemove",function(){d?d=!1:(H(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,
color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&H(a._zoomButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers);R(this._zoomButton,"mouseout",function(){d||(H(a._zoomButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&H(a._zoomButton.childNodes[0],{WebkitFilter:"invert(0%)",
...
this.toolbar.buttonBorderColor,this._toolBar.appendChild(this._resetButton),R(this._resetButton,"touchstart",function(a){d=!0},this.allDOMEventHandlers),R(this._resetButton,"click",function(){a.toolTip.hide();a.toolTip&&a.toolTip.enabled&&a.toolTip.dispatchEvent("hidden",{chart:a,toolTip:a.toolTip},a.toolTip);a.zoomEnabled||a.panEnabled?(a.zoomEnabled=!0,a.panEnabled=!1,wa(a,a._zoomButton,"pan"),a._defaultCursor="default",a.overlaidCanvas.style.cursor=a._defaultCursor):(a.zoomEnabled=!1,a.panEnabled=
!1);if(a.sessionVariables.axisX)for(var b=0;b<a.sessionVariables.axisX.length;b++)a.sessionVariables.axisX[b].newViewportMinimum=null,a.sessionVariables.axisX[b].newViewportMaximum=null;if(a.sessionVariables.axisX2)for(b=0;b<a.sessionVariables.axisX2.length;b++)a.sessionVariables.axisX2[b].newViewportMinimum=null,a.sessionVariables.axisX2[b].newViewportMaximum=null;if(a.sessionVariables.axisY)for(b=0;b<a.sessionVariables.axisY.length;b++)a.sessionVariables.axisY[b].newViewportMinimum=null,a.sessionVariables.axisY[b].newViewportMaximum=
null;if(a.sessionVariables.axisY2)for(b=0;b<a.sessionVariables.axisY2.length;b++)a.sessionVariables.axisY2[b].newViewportMinimum=null,a.sessionVariables.axisY2[b].newViewportMaximum=null;a.resetOverlayedCanvas();0>=navigator.userAgent.search("MSIE")&&H(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"});va(a._zoomButton,a._resetButton);a.stockChart&&(a.stockChart._rangeEventParameter={stockChart:a.stockChart,source:"chart",index:a.stockChart.charts.indexOf(a),minimum:null,
...
R(this._resetButton,"mousemove",function(){d||(H(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColorOnHover,color:a.toolbar.fontColorOnHover,transition:"0.4s",WebkitTransition:"0.4s"}),0>=navigator.userAgent.search("MSIE")&&H(a._resetButton.childNodes[0],{WebkitFilter:"invert(100%)",filter:"invert(100%)"}))},this.allDOMEventHandlers),R(this._resetButton,"mouseout",function(){d||(H(a._resetButton,{backgroundColor:a.toolbar.itemBackgroundColor,color:a.toolbar.fontColor,transition:"0.4s",WebkitTransition:"0.4s"}),
0>=navigator.userAgent.search("MSIE")&&H(a._resetButton.childNodes[0],{WebkitFilter:"invert(0%)",filter:"invert(0%)"}))},this.allDOMEventHandlers),this.overlaidCanvas.style.cursor=a._defaultCursor);this.zoomEnabled||this.panEnabled||(this._zoomButton?(a._zoomButton.getAttribute("state")===a._cultureInfo.zoomText?(this.panEnabled=!0,this.zoomEnabled=!1):(this.zoomEnabled=!0,this.panEnabled=!1),La(a._zoomButton,a._resetButton)):(this.zoomEnabled=!0,this.panEnabled=!1))}else this.panEnabled=this.zoomEnabled=
!1;ib(this);"none"!==this._toolBar.style.display&&this._zoomButton&&(this.panEnabled?wa(a,a._zoomButton,"zoom"):wa(a,a._zoomButton,"pan"),a._resetButton.getAttribute("state")!==a._cultureInfo.resetText&&wa(a,a._resetButton,"reset"));this.options.toolTip&&this.toolTip.options!==this.options.toolTip&&(this.toolTip.options=this.options.toolTip);for(var c in this.toolTip.options)this.toolTip.options.hasOwnProperty(c)&&this.toolTip.updateOption(c)};m.prototype._updateSize=function(){var a;a=[this.canvas,
...
0<=m._supportedChartTypes.indexOf(this.options.data[c].type)){var b=new V(this,this.options.data[c],a-1,++this._eventManager.lastObjectId);"error"===b.type&&(b.linkedDataSeriesIndex=s(this.options.data[c].linkedDataSeriesIndex)?c-1:this.options.data[c].linkedDataSeriesIndex,0>b.linkedDataSeriesIndex||b.linkedDataSeriesIndex>=this.options.data.length||"number"!==typeof b.linkedDataSeriesIndex||"error"===this.options.data[b.linkedDataSeriesIndex].type)&&(b.linkedDataSeriesIndex=null);null===b.name&&
...
this.legend.render();if("normal"===this.plotInfo.axisPlacement||"xySwapped"===this.plotInfo.axisPlacement)A.render(this.axisX,this.axisX2,this.axisY,this.axisY2,this.plotInfo.axisPlacement);else if("none"===this.plotInfo.axisPlacement)this.preparePlotArea();else return;for(d=0;d<a.length;d++)a[d].setLayout(),a[d].render();var c=[];if(this.animatedRender){var b=ua(this.width,this.height);b.getContext("2d").drawImage(this.canvas,0,0,this.width,this.height)}jb(this);var a=this.ctx.miterLimit,e;this.ctx.miterLimit=
...
t.type&&(C=this.renderBoxAndWhisker(t));for(var k=0;k<t.dataSeriesIndexes.length;k++)this._dataInRenderedOrder.push(this.data[t.dataSeriesIndexes[k]]);this.animatedRender&&(t.targetCanvasCtx.miterLimit=e,C&&c.push(C))}this.ctx.miterLimit=a;this.animatedRender&&this._breaksCanvasCtx&&c.push({source:this._breaksCanvasCtx,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7});this.animatedRender&&0<this._indexLabels.length&&
...
C.animationCallback(C.easingFunction(a,0,1,1),C);n.dispatchEvent("dataAnimationIterationEnd",{chart:n})},function(){c=[];for(var a=0;a<n.plotInfo.plotTypes.length;a++)for(var e=n.plotInfo.plotTypes[a],d=0;d<e.plotUnits.length;d++){var f=e.plotUnits[d];f.targetCanvas&&xa(f.targetCanvas);f.targetCanvas=null}b=null;n.disableToolTip=!1;n.dispatchEvent("dataAnimationEnd",{chart:n})});else{if(n._breaksCanvas)if(w)n.plotArea.ctx.drawImage(n._breaksCanvas,0,0,this.width,this.height);else for(k=0;k<n._axes.length;k++)n._axes[k].createMask();
...
a.axisY.dataInfo,c=a.axisX.dataInfo,b,e,f=!1,l=[],t=[],C=Infinity,k=-Infinity,n=0;n<a.dataSeriesIndexes.length;n++){var p=this.data[a.dataSeriesIndexes[n]],q=0,g=!1,r=!1,h;if("normal"===p.axisPlacement||"xySwapped"===p.axisPlacement)var ga=a.axisX.sessionVariables.newViewportMinimum?a.axisX.sessionVariables.newViewportMinimum:this.options.axisX&&this.options.axisX.viewportMinimum?this.options.axisX.viewportMinimum:this.options.axisX&&this.options.axisX.minimum?this.options.axisX.minimum:-Infinity,
...
b=p.dataPoints[q].x;e=s(p.dataPoints[q].y)?0:p.dataPoints[q].y;b<c.min&&(c.min=b);b>c.max&&(c.max=b);if(0<q){if(a.axisX.logarithmic){var m=b/p.dataPoints[q-1].x;1>m&&(m=1/m);c.minDiff>m&&1!==m&&(c.minDiff=m)}else m=b-p.dataPoints[q-1].x,0>m&&(m*=-1),c.minDiff>m&&0!==m&&(c.minDiff=m);null!==e&&null!==p.dataPoints[q-1].y&&(a.axisY.logarithmic?0<e&&(m=e/p.dataPoints[q-1].y,1>m&&(m=1/m),d.minDiff>m&&1!==m&&(d.minDiff=m)):(m=e-p.dataPoints[q-1].y,0>m&&(m*=-1),d.minDiff>m&&0!==m&&(d.minDiff=m)))}if(b<ga&&
...
(t=!0,b=k.dataPoints[n].x.getTime()):b=k.dataPoints[n].x;if((e=k.dataPoints[n].y)&&e.length){f=Math.min.apply(null,e);l=Math.max.apply(null,e);r=!0;for(var s=0;s<e.length;s++)null===e.k&&(r=!1);r&&(p||(h=g),g=b)}b<c.min&&(c.min=b);b>c.max&&(c.max=b);f<d.min&&(d.min=f);l>d.max&&(d.max=l);0<n&&(a.axisX.logarithmic?(r=b/k.dataPoints[n-1].x,1>r&&(r=1/r),c.minDiff>r&&1!==r&&(c.minDiff=r)):(r=b-k.dataPoints[n-1].x,0>r&&(r*=-1),c.minDiff>r&&0!==r&&(c.minDiff=r)),e&&(null!==e[0]&&k.dataPoints[n-1].y&&null!==
k.dataPoints[n-1].y[0])&&(a.axisY.logarithmic?(r=e[0]/k.dataPoints[n-1].y[0],1>r&&(r=1/r),d.minDiff>r&&1!==r&&(d.minDiff=r)):(r=e[0]-k.dataPoints[n-1].y[0],0>r&&(r*=-1),d.minDiff>r&&0!==r&&(d.minDiff=r))));if(!(b<m)||p){if(!p&&(p=!0,0<n)){n-=2;g=h;continue}if(b>u&&!q)q=!0;else if(b>u&&q)continue;k.dataPoints[n].label&&(a.axisX.labels[b]=k.dataPoints[n].label);b<c.viewPortMin&&(c.viewPortMin=b);b>c.viewPortMax&&(c.viewPortMax=b);if(c.viewPortMin===b&&e)for(s=0;s<e.length;s++)if(null===e[s]&&g<b){c.viewPortMin=
...
b=0,e=0,f=0,l=f=e=0,t=0,C=b=0,k=0;for(a=0;a<this._indexLabels.length;a++){var n=this._indexLabels[a],p=n.chartType.toLowerCase(),q,g,l=ma("indexLabelFontColor",n.dataPoint,n.dataSeries),r=ma("indexLabelFontSize",n.dataPoint,n.dataSeries),t=ma("indexLabelFontFamily",n.dataPoint,n.dataSeries),C=ma("indexLabelFontStyle",n.dataPoint,n.dataSeries),k=ma("indexLabelFontWeight",n.dataPoint,n.dataSeries),h=ma("indexLabelBackgroundColor",n.dataPoint,n.dataSeries);q=ma("indexLabelMaxWidth",n.dataPoint,n.dataSeries);
g=ma("indexLabelWrap",n.dataPoint,n.dataSeries);var m=ma("indexLabelLineDashType",n.dataPoint,n.dataSeries),u=ma("indexLabelLineColor",n.dataPoint,n.dataSeries),y=s(n.dataPoint.indexLabelLineThickness)?s(n.dataSeries.options.indexLabelLineThickness)?0:n.dataSeries.options.indexLabelLineThickness:n.dataPoint.indexLabelLineThickness,b=0<y?Math.min(10,("normal"===this.plotInfo.axisPlacement?this.plotArea.height:this.plotArea.width)<<0):0,x={percent:null,total:null},z=null;if(0<=n.dataSeries.type.indexOf("stacked")||
"pie"===n.dataSeries.type||"doughnut"===n.dataSeries.type)x=this.getPercentAndTotal(n.dataSeries,n.dataPoint);if(n.dataSeries.indexLabelFormatter||n.dataPoint.indexLabelFormatter)z={chart:this,dataSeries:n.dataSeries,dataPoint:n.dataPoint,index:n.indexKeyword,total:x.total,percent:x.percent};var F=n.dataPoint.indexLabelFormatter?n.dataPoint.indexLabelFormatter(z):n.dataPoint.indexLabel?this.replaceKeywordsWithValue(n.dataPoint.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):n.dataSeries.indexLabelFormatter?
n.dataSeries.indexLabelFormatter(z):n.dataSeries.indexLabel?this.replaceKeywordsWithValue(n.dataSeries.indexLabel,n.dataPoint,n.dataSeries,null,n.indexKeyword):null;if(null!==F&&""!==F){var x=ma("indexLabelPlacement",n.dataPoint,n.dataSeries),z=ma("indexLabelOrientation",n.dataPoint,n.dataSeries),B=ma("indexLabelTextAlign",n.dataPoint,n.dataSeries),v=n.direction,e=n.dataSeries.axisX,f=n.dataSeries.axisY,A=!1,h=new ka(d,{x:0,y:0,maxWidth:q?q:0.5*this.width,maxHeight:g?5*r:1.5*r,angle:"horizontal"===
z?0:-90,text:F,padding:0,backgroundColor:h,textAlign:B,fontSize:r,fontFamily:t,fontWeight:k,fontColor:l,fontStyle:C,textBaseline:"middle"});h.measureText();n.dataSeries.indexLabelMaxWidth=h.maxWidth;if("stackedarea100"===p){if(n.point.x<c.x1||n.point.x>c.x2||n.point.y<c.y1-1||n.point.y>c.y2+1)continue}else if("rangearea"===p||"rangesplinearea"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>
...
p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||n.bounds.x1>c.x2||n.bounds.x2<c.x1)continue}else if("candlestick"===p||"ohlc"===p){if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum||Math.max.apply(null,n.dataPoint.y)<f.viewportMinimum||Math.min.apply(null,n.dataPoint.y)>f.viewportMaximum)continue}else if(n.dataPoint.x<e.viewportMinimum||n.dataPoint.x>e.viewportMaximum)continue;l=t=2;"horizontal"===z?(C=h.width,k=h.height):(k=h.width,C=h.height);if("normal"===
this.plotInfo.axisPlacement){if(0<=p.indexOf("line")||0<=p.indexOf("area"))x="auto",t=4;else if(0<=p.indexOf("stacked"))"auto"===x&&(x="inside");else if("bubble"===p||"scatter"===p)x="inside";q=n.point.x-("horizontal"===z?C/2:C/2-r/2);"inside"!==x?(e=c.y1,f=c.y2,0<v?(g=n.point.y+("horizontal"===z?r/2:0)-k-t-b,g<e&&(g="auto"===x?Math.max(n.point.y,e)+r/2+t:e+r/2+t,A=g+k>n.point.y)):(g=n.point.y+r/2+t+b,g>f-k&&(g="auto"===x?Math.min(n.point.y,f)+r/2-k-t:f+r/2-k,A=g<n.point.y))):(e=Math.max(n.bounds.y1,
c.y1),f=Math.min(n.bounds.y2,c.y2-k+r/2),b=0<=p.indexOf("range")||"error"===p?0<v?Math.max(n.bounds.y1,c.y1)+r/2+t:Math.min(n.bounds.y2,c.y2)+r/2-k+t:(Math.max(n.bounds.y1,c.y1)+Math.min(n.bounds.y2,c.y2))/2-k/2+r/2+("horizontal"===z?t:0),0<v?(g=Math.max(n.point.y,b),g<e&&("bubble"===p||"scatter"===p)&&(g=Math.max(n.point.y-k-t,c.y1+t))):(g=Math.min(n.point.y,b),g>f-k-t&&("bubble"===p||"scatter"===p)&&(g=Math.min(n.point.y+t,c.y2-k-t))),g=Math.min(g,f))}else 0<=p.indexOf("line")||0<=p.indexOf("area")||
0<=p.indexOf("scatter")?(x="auto",l=4):0<=p.indexOf("stacked")?"auto"===x&&(x="inside"):"bubble"===p&&(x="inside"),g=n.point.y+r/2-k/2+t,"inside"!==x?(e=c.x1,f=c.x2,0>v?(q=n.point.x-("horizontal"===z?C:C-r/2)-l-b,q<e&&(q="auto"===x?Math.max(n.point.x,e)+l:e+l,A=q+C>n.point.x)):(q=n.point.x+("horizontal"===z?0:r/2)+l+b,q>f-C-l-b&&(q="auto"===x?Math.min(n.point.x,f)-("horizontal"===z?C:C/2)-l:f-C-l,A=q<n.point.x))):(e=Math.max(n.bounds.x1,c.x1),Math.min(n.bounds.x2,c.x2),b=0<=p.indexOf("range")||"error"===
p?0>v?Math.max(n.bounds.x1,c.x1)+r/2+l:Math.min(n.bounds.x2,c.x2)-C/2-l+("horizontal"===z?0:r/2):(Math.max(n.bounds.x1,c.x1)+Math.min(n.bounds.x2,c.x2))/2+("horizontal"===z?0:r/2),q=0>v?Math.max(n.point.x,b)-("horizontal"===z?C/2:0):Math.min(n.point.x,b)-C/2,q=Math.max(q,e));"vertical"===z&&(g+=k-r/2);h.x=q;h.y=g;h.render(!0);y&&("inside"!==x&&(0>p.indexOf("bar")&&("error"!==p||!n.axisSwapped)&&n.point.x>c.x1&&n.point.x<c.x2||!A)&&(0>p.indexOf("column")&&("error"!==p||n.axisSwapped)&&n.point.y>c.y1&&
n.point.y<c.y2||!A))&&(d.lineWidth=y,d.strokeStyle=u?u:"gray",d.setLineDash&&d.setLineDash(J(m,y)),d.beginPath(),d.moveTo(n.point.x,n.point.y),0<=p.indexOf("bar")||"error"===p&&n.axisSwapped?d.lineTo(q+(0<n.direction?-l:C+l)+("vertical"===z?-r/2:0),g+("vertical"===z?-k/2:k/2-r/2)-t):0<=p.indexOf("column")||"error"===p&&!n.axisSwapped?d.lineTo(q+C/2-("horizontal"===z?0:r/2),g+("vertical"===z?(g-k<n.point.y?0:-k)+t:(g-r/2<n.point.y?k:0)-r/2)):d.lineTo(q+C/2-("horizontal"===z?0:r/2),g+("vertical"===
z?g-k<n.point.y?0:-k:(g-r/2<n.point.y?k:0)-r/2)),d.stroke())}}d={source:d,dest:this.plotArea.ctx,animationCallback:M.fadeInAnimation,easingFunction:M.easing.easeInQuad,animationBase:0,startTimePercent:0.7};for(a=0;a<this._indexLabels.length;a++)n=this._indexLabels[a],h=ma("indexLabelBackgroundColor",n.dataPoint,n.dataSeries),n.dataSeries.indexLabelBackgroundColor=s(h)?w?"transparent":null:h;return d};m.prototype.renderLine=function(a){var d=a.targetCanvasCtx||this.plotArea.ctx,c=w?this._preRenderCtx:
...
dataSeriesIndex:C};r=O(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var m=!0,u=0,s,x;c.beginPath();if(0<n.length){for(var z=!1,u=0;u<n.length;u++)if(s=n[u].x.getTime?n[u].x.getTime():n[u].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!z)))if("number"!==typeof n[u].y)0<u&&!(k.connectNullData||z||m)&&(c.stroke(),w&&b.stroke()),z=
!0;else{s=a.axisX.convertValueToPixel(s);x=a.axisY.convertValueToPixel(n[u].y);var F=k.dataPointIds[u];this._eventManager.objectMap[F]={id:F,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:u,x1:s,y1:x};m||z?(!m&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),c.lineTo(s,x),w&&b.lineTo(s,x)):(c.beginPath(),c.moveTo(s,x),w&&(b.beginPath(),
b.moveTo(s,x))),z=m=!1):(c.lineTo(s,x),w&&b.lineTo(s,x),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(s,x),w&&(b.stroke(),b.beginPath(),b.moveTo(s,x))));l={x:s,y:x};u<n.length-1&&(h!==(n[u].lineColor||r)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(s,x),h=n[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[u].markerSize||0<k.markerSize){var B=k.getMarkerProperties(u,
s,x,c);f.push(B);F=O(F);w&&f.push({x:s,y:x,ctx:b,type:B.type,size:B.size,color:F,borderColor:F,borderThickness:B.borderThickness})}(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"line",dataPoint:n[u],dataSeries:k,point:{x:s,y:x},direction:0>n[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();w&&b.stroke()}}X.drawMarkers(f);w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",
...
k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:C};r=O(r);b.strokeStyle=r;b.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];c.strokeStyle=r;var s=!0,u=0,m,x;c.beginPath();if(0<n.length){for(var z=!1,u=0;u<n.length;u++)if(m=n[u].getTime?n[u].x.getTime():n[u].x,!(m<a.axisX.dataInfo.viewPortMin||m>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!z)))if("number"!==typeof n[u].y)0<
u&&!(k.connectNullData||z||s)&&(c.stroke(),w&&b.stroke()),z=!0;else{var F=x;m=a.axisX.convertValueToPixel(m);x=a.axisY.convertValueToPixel(n[u].y);var B=k.dataPointIds[u];this._eventManager.objectMap[B]={id:B,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:u,x1:m,y1:x};s||z?(!s&&k.connectNullData?(c.setLineDash&&(k.options.nullDataLineDashType||p===k.lineDashType&&k.lineDashType!==k.nullDataLineDashType)&&(c.stroke(),c.beginPath(),c.moveTo(l.x,l.y),p=k.nullDataLineDashType,c.setLineDash(q)),
c.lineTo(m,F),c.lineTo(m,x),w&&(b.lineTo(m,F),b.lineTo(m,x))):(c.beginPath(),c.moveTo(m,x),w&&(b.beginPath(),b.moveTo(m,x))),z=s=!1):(c.lineTo(m,F),w&&b.lineTo(m,F),c.lineTo(m,x),w&&b.lineTo(m,x),0==u%500&&(c.stroke(),c.beginPath(),c.moveTo(m,x),w&&(b.stroke(),b.beginPath(),b.moveTo(m,x))));l={x:m,y:x};u<n.length-1&&(h!==(n[u].lineColor||r)||p!==(n[u].lineDashType||k.lineDashType))&&(c.stroke(),c.beginPath(),c.moveTo(m,x),h=n[u].lineColor||r,c.strokeStyle=h,c.setLineDash&&(n[u].lineDashType?(p=n[u].lineDashType,
c.setLineDash(J(p,k.lineThickness))):(p=k.lineDashType,c.setLineDash(g))));if(0<n[u].markerSize||0<k.markerSize)F=k.getMarkerProperties(u,m,x,c),f.push(F),B=O(B),w&&f.push({x:m,y:x,ctx:b,type:F.type,size:F.size,color:B,borderColor:B,borderThickness:F.borderThickness});(n[u].indexLabel||k.indexLabel||n[u].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepLine",dataPoint:n[u],dataSeries:k,point:{x:m,y:x},direction:0>n[u].y===a.axisY.reversed?1:-1,color:r})}c.stroke();
...
var f=this.plotArea;b.beginPath();b.rect(f.x1,f.y1,f.width,f.height);b.clip();for(var l=[],t=0;t<a.dataSeriesIndexes.length;t++){var C=a.dataSeriesIndexes[t],k=this.data[C];b.lineWidth=k.lineThickness;var n=k.dataPoints,p="solid";if(b.setLineDash){var q=J(k.nullDataLineDashType,k.lineThickness),p=k.lineDashType,g=J(p,k.lineThickness);b.setLineDash(g)}var r=k.id;this._eventManager.objectMap[r]={objectType:"dataSeries",dataSeriesIndex:C};r=O(r);e.strokeStyle=r;e.lineWidth=0<k.lineThickness?Math.max(k.lineThickness,
4):0;var r=k._colorSet,h=r=k.lineColor=k.options.lineColor?k.options.lineColor:r[0];b.strokeStyle=r;var m=0,u,s,x=[];b.beginPath();if(0<n.length)for(s=!1,m=0;m<n.length;m++)if(u=n[m].getTime?n[m].x.getTime():n[m].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!s)))if("number"!==typeof n[m].y)0<m&&!s&&(k.connectNullData?b.setLineDash&&(0<x.length&&(k.options.nullDataLineDashType||!n[m-1].lineDashType))&&(x[x.length-1].newLineDashArray=q,p=k.nullDataLineDashType):
(d(x),x=[])),s=!0;else{u=a.axisX.convertValueToPixel(u);s=a.axisY.convertValueToPixel(n[m].y);var z=k.dataPointIds[m];this._eventManager.objectMap[z]={id:z,objectType:"dataPoint",dataSeriesIndex:C,dataPointIndex:m,x1:u,y1:s};x[x.length]={x:u,y:s};m<n.length-1&&(h!==(n[m].lineColor||r)||p!==(n[m].lineDashType||k.lineDashType))&&(h=n[m].lineColor||r,x[x.length-1].newStrokeStyle=h,b.setLineDash&&(n[m].lineDashType?(p=n[m].lineDashType,x[x.length-1].newLineDashArray=J(p,k.lineThickness)):(p=k.lineDashType,
x[x.length-1].newLineDashArray=g)));if(0<n[m].markerSize||0<k.markerSize){var F=k.getMarkerProperties(m,u,s,b);l.push(F);z=O(z);w&&l.push({x:u,y:s,ctx:e,type:F.type,size:F.size,color:z,borderColor:z,borderThickness:F.borderThickness})}(n[m].indexLabel||k.indexLabel||n[m].indexLabelFormatter||k.indexLabelFormatter)&&this._indexLabels.push({chartType:"spline",dataPoint:n[m],dataSeries:k,point:{x:u,y:s},direction:0>n[m].y===a.axisY.reversed?1:-1,color:r});s=!1}d(x)}X.drawMarkers(l);w&&(c.drawImage(this._preRenderCanvas,
...
C=r[f].x,!(C<a.axisX.dataInfo.viewPortMin||C>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){l=a.axisX.convertValueToPixel(C);t=a.axisY.convertValueToPixel(r[f].y);l=a.axisX.reversed?l+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:l-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+n)*p<<0;var m=a.axisX.reversed?l-p<<0:l+p<<0,u;0<=r[f].y?u=k:(u=t,t=k);t>u&&(b=t,t=u,u=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];$(c,a.axisX.reversed?m:l,t,a.axisX.reversed?
l:m,u,b,0,null,h&&(a.axisY.reversed?0>r[f].y:0<=r[f].y),(a.axisY.reversed?0<=r[f].y:0>r[f].y)&&h,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:t,x2:m,y2:u};b=O(b);w&&$(this._eventManager.ghostCtx,a.axisX.reversed?m:l,t,a.axisX.reversed?l:m,u,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"column",dataPoint:r[f],
...
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<r&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);n=n-a.plotType.plotUnits.length*r/2+a.index*r<<0;var x=n+r<<0,z;if(a.axisY.logarithmic||
a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(p=a.axisY.convertValueToPixel(t[b]),z="undefined"!==typeof f[b]?f[b]:q,f[b]=p);else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)C[b]=u[k].y+(C[b]?C[b]:0),z=a.axisY.convertValueToPixel(C[b]),p="undefined"!==typeof l[b]?l[b]:q,l[b]=z;else if(p=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var F="undefined"!==typeof f[b]?f[b]:0;p-=F;z=q-F;f[b]=F+(z-p)}else F=
l[b]?l[b]:0,z=p+F,p=q+F,l[b]=F+(z-p);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];$(c,n,a.axisY.reversed?z:p,x,a.axisY.reversed?p:z,b,0,null,s&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&s,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:n,y1:p,x2:x,y2:z};b=O(b);w&&$(this._eventManager.ghostCtx,n,p,x,z,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||m.indexLabel||u[k].indexLabelFormatter||
m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn",dataPoint:u[k],dataSeries:m,point:{x:n+(x-n)/2,y:0<=u[k].y?p:z},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:n,y1:Math.min(p,z),x2:x,y2:Math.max(p,z)},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),
...
c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],u=m.dataPoints;if(0<u.length)for(var s=5<r&&m.bevelEnabled?!0:!1,k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){n=a.axisX.convertValueToPixel(b);p=0!==a.dataPointYSums[b]?
100*(u[k].y/a.dataPointYSums[b]):0;n=n-a.plotType.plotUnits.length*r/2+a.index*r<<0;var x=n+r<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=p+("undefined"!==typeof t[b]?t[b]:0);if(0>=t[b])continue;p=a.axisY.convertValueToPixel(t[b]);z=f[b]?f[b]:q;f[b]=p}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)C[b]=p+("undefined"!==typeof C[b]?C[b]:0),z=a.axisY.convertValueToPixel(C[b]),p=l[b]?l[b]:q,l[b]=z;
else if(p=a.axisY.convertValueToPixel(p),0<=u[k].y){var F="undefined"!==typeof f[b]?f[b]:0;p-=F;z=q-F;a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.y1-p)&&(p=e.y1);f[b]=F+(z-p)}else F="undefined"!==typeof l[b]?l[b]:0,z=p+F,p=q+F,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.y2-z)&&(z=e.y2),l[b]=F+(z-p);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];$(c,n,a.axisY.reversed?z:p,x,a.axisY.reversed?p:z,b,0,null,s&&(a.axisY.reversed?0>u[k].y:0<=u[k].y),(a.axisY.reversed?0<=u[k].y:0>u[k].y)&&
s,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:n,y1:p,x2:x,y2:z};b=O(b);w&&$(this._eventManager.ghostCtx,n,p,x,z,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||m.indexLabel||u[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedColumn100",dataPoint:u[k],dataSeries:m,point:{x:n+(x-n)/2,y:0<=u[k].y?p:z},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:n,y1:Math.min(p,z),
...
a.dataSeriesIndexes[n],g=this.data[q],r=g.dataPoints;if(0<r.length){var h=5<p&&g.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(f=0;f<r.length;f++)if(r[f].getTime?C=r[f].x.getTime():C=r[f].x,!(C<a.axisX.dataInfo.viewPortMin||C>a.axisX.dataInfo.viewPortMax)&&"number"===typeof r[f].y){t=a.axisX.convertValueToPixel(C);l=a.axisY.convertValueToPixel(r[f].y);t=a.axisX.reversed?t+a.plotType.totalDataSeries*p/2-(a.previousDataSeriesCount+n)*p<<0:t-a.plotType.totalDataSeries*p/2+(a.previousDataSeriesCount+
n)*p<<0;var m=a.axisX.reversed?t-p<<0:t+p<<0,u;0<=r[f].y?u=k:(u=l,l=k);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];$(c,a.axisY.reversed?l:u,a.axisX.reversed?m:t,a.axisY.reversed?u:l,a.axisX.reversed?t:m,b,0,null,h,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:u,y1:t,x2:l,y2:m};b=O(b);w&&$(this._eventManager.ghostCtx,u,a.axisX.reversed?m:t,l,a.axisX.reversed?t:m,b,0,null,!1,!1,!1,!1);(r[f].indexLabel||
...
c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<r&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);
p=p-a.plotType.plotUnits.length*r/2+a.index*r<<0;var x=p+r<<0,z;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y)t[b]=u[k].y+(t[b]?t[b]:0),0<t[b]&&(z=f[b]?f[b]:q,f[b]=n=a.axisY.convertValueToPixel(t[b]));else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)C[b]=u[k].y+(C[b]?C[b]:0),n=l[b]?l[b]:q,l[b]=z=a.axisY.convertValueToPixel(C[b]);else if(n=a.axisY.convertValueToPixel(u[k].y),0<=u[k].y){var F=f[b]?f[b]:0;z=q+F;n+=
F;f[b]=F+(n-z)}else F=l[b]?l[b]:0,z=n-F,n=q-F,l[b]=F+(n-z);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];$(c,a.axisY.reversed?n:z,p,a.axisY.reversed?z:n,x,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:z,y1:p,x2:n,y2:x};b=O(b);w&&$(this._eventManager.ghostCtx,z,p,n,x,b,0,null,!1,!1,!1,!1);(u[k].indexLabel||m.indexLabel||u[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar",
dataPoint:u[k],dataSeries:m,point:{x:0<=u[k].y?n:z,y:p+(x-p)/2},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(z,n),y1:p,x2:Math.max(z,n),y2:x},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
Math.log(a.axisX.range):Math.abs(r)/Math.abs(a.axisX.range))/a.plotType.plotUnits.length)<<0;this.dataPointMaxWidth&&k>g&&(k=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,g));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&g<k)&&(g=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,k));r<k&&(r=k);r>g&&(r=g);c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(e.x1,e.y1,e.width,e.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(e.x1,
e.y1,e.width,e.height),this._eventManager.ghostCtx.clip());for(g=0;g<a.dataSeriesIndexes.length;g++){var h=a.dataSeriesIndexes[g],m=this.data[h],u=m.dataPoints;if(0<u.length){var s=5<r&&m.bevelEnabled?!0:!1;c.strokeStyle="#4572A7 ";for(k=0;k<u.length;k++)if(b=u[k].x.getTime?u[k].x.getTime():u[k].x,!(b<a.axisX.dataInfo.viewPortMin||b>a.axisX.dataInfo.viewPortMax)&&"number"===typeof u[k].y){p=a.axisX.convertValueToPixel(b);var x;x=0!==a.dataPointYSums[b]?100*(u[k].y/a.dataPointYSums[b]):0;p=p-a.plotType.plotUnits.length*
r/2+a.index*r<<0;var z=p+r<<0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0<u[k].y){t[b]=x+(t[b]?t[b]:0);if(0>=t[b])continue;x=f[b]?f[b]:q;f[b]=n=a.axisY.convertValueToPixel(t[b])}else if(a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length&&0>=u[k].y)C[b]=x+(C[b]?C[b]:0),n=l[b]?l[b]:q,l[b]=x=a.axisY.convertValueToPixel(C[b]);else if(n=a.axisY.convertValueToPixel(x),0<=u[k].y){var F=f[b]?f[b]:0;x=q+F;n+=F;a.dataSeriesIndexes.length-1===g&&
1>=Math.abs(e.x2-n)&&(n=e.x2);f[b]=F+(n-x)}else F=l[b]?l[b]:0,x=n-F,n=q-F,a.dataSeriesIndexes.length-1===g&&1>=Math.abs(e.x1-x)&&(x=e.x1),l[b]=F+(n-x);b=u[k].color?u[k].color:m._colorSet[k%m._colorSet.length];$(c,a.axisY.reversed?n:x,p,a.axisY.reversed?x:n,z,b,0,null,s,!1,!1,!1,m.fillOpacity);b=m.dataPointIds[k];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:k,x1:x,y1:p,x2:n,y2:z};b=O(b);w&&$(this._eventManager.ghostCtx,x,p,n,z,b,0,null,!1,!1,!1,!1);
(u[k].indexLabel||m.indexLabel||u[k].indexLabelFormatter||m.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedBar100",dataPoint:u[k],dataSeries:m,point:{x:0<=u[k].y?n:x,y:p+(z-p)/2},direction:0>u[k].y===a.axisY.reversed?1:-1,bounds:{x1:Math.min(x,n),y1:p,x2:Math.max(x,n),y2:z},color:b})}}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&
...
c;function b(){F&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=x:0>a.axisY.viewportMaximum?z=t.y1:0<a.axisY.viewportMinimum&&(z=x),f.lineTo(m,z),f.lineTo(F.x,z),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(m,z),l.lineTo(F.x,z),l.closePath(),l.fill()),f.beginPath(),f.moveTo(m,u),l.beginPath(),l.moveTo(m,u),F={x:m,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:e;if(!(0>=a.dataSeriesIndexes.length)){var l=
this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,C=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,C=g.id;this._eventManager.objectMap[C]={objectType:"dataSeries",dataSeriesIndex:q};C=O(C);l.fillStyle=C;C=[];d=!0;var h=0,m,u,s,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),z,F=null;if(0<r.length){var B=g._colorSet[h%g._colorSet.length],v=g.lineColor=g.options.lineColor||B,A=v;f.fillStyle=B;f.strokeStyle=v;f.lineWidth=g.lineThickness;c="solid";if(f.setLineDash){var L=J(g.nullDataLineDashType,g.lineThickness);c=g.lineDashType;var aa=J(c,g.lineThickness);f.setLineDash(aa)}for(var ea=!0;h<r.length;h++)if(s=r[h].x.getTime?r[h].x.getTime():r[h].x,!(s<a.axisX.dataInfo.viewPortMin||s>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!ea)))if("number"!==
typeof r[h].y)g.connectNullData||(ea||d)||b(),ea=!0;else{m=a.axisX.convertValueToPixel(s);u=a.axisY.convertValueToPixel(r[h].y);d||ea?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||c===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=m,c=u,m=n.x,u=n.y,b(),f.moveTo(n.x,n.y),m=d,u=c,F=n,c=g.nullDataLineDashType,f.setLineDash(L)),f.lineTo(m,u),w&&l.lineTo(m,u)):(f.beginPath(),f.moveTo(m,u),w&&(l.beginPath(),l.moveTo(m,u)),F={x:m,y:u}),ea=d=!1):(f.lineTo(m,u),w&&l.lineTo(m,
u),0==h%250&&b());n={x:m,y:u};h<r.length-1&&(A!==(r[h].lineColor||v)||c!==(r[h].lineDashType||g.lineDashType))&&(b(),A=r[h].lineColor||v,f.strokeStyle=A,f.setLineDash&&(r[h].lineDashType?(c=r[h].lineDashType,f.setLineDash(J(c,g.lineThickness))):(c=g.lineDashType,f.setLineDash(aa))));var Z=g.dataPointIds[h];this._eventManager.objectMap[Z]={id:Z,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:h,x1:m,y1:u};0!==r[h].markerSize&&(0<r[h].markerSize||0<g.markerSize)&&(s=g.getMarkerProperties(h,m,
u,f),C.push(s),Z=O(Z),w&&C.push({x:m,y:u,ctx:l,type:s.type,size:s.size,color:Z,borderColor:Z,borderThickness:s.borderThickness}));(r[h].indexLabel||g.indexLabel||r[h].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"area",dataPoint:r[h],dataSeries:g,point:{x:m,y:u},direction:0>r[h].y===a.axisY.reversed?1:-1,color:B})}b();X.drawMarkers(C)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),f.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&f.drawImage(a.axisX.maskCanvas,
...
1].x,s);b.lineTo(u.x,s);b.closePath();b.globalAlpha=n.fillOpacity;b.fill();b.globalAlpha=1;w&&(e.lineTo(c[c.length-1].x,s),e.lineTo(u.x,s),e.closePath(),e.fill())}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=a.axisY.lineCoordinates,l=[],t=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(e.beginPath(),e.rect(t.x1,t.y1,t.width,t.height),e.clip());for(var h=
0;h<a.dataSeriesIndexes.length;h++){var k=a.dataSeriesIndexes[h],n=this.data[k],p=n.dataPoints,l=n.id;this._eventManager.objectMap[l]={objectType:"dataSeries",dataSeriesIndex:k};l=O(l);e.fillStyle=l;var l=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),s,u=null,y=[];if(0<p.length){var x=n._colorSet[q%n._colorSet.length],z=n.lineColor=n.options.lineColor||x,F=z;b.fillStyle=x;b.strokeStyle=z;b.lineWidth=n.lineThickness;var B="solid";if(b.setLineDash){var A=J(n.nullDataLineDashType,
n.lineThickness),B=n.lineDashType,D=J(B,n.lineThickness);b.setLineDash(D)}for(r=!1;q<p.length;q++)if(g=p[q].x.getTime?p[q].x.getTime():p[q].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!r)))if("number"!==typeof p[q].y)0<q&&!r&&(n.connectNullData?b.setLineDash&&(0<y.length&&(n.options.nullDataLineDashType||!p[q-1].lineDashType))&&(y[y.length-1].newLineDashArray=A,B=n.nullDataLineDashType):(d(),y=[])),r=!0;else{g=a.axisX.convertValueToPixel(g);r=a.axisY.convertValueToPixel(p[q].y);
var L=n.dataPointIds[q];this._eventManager.objectMap[L]={id:L,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:q,x1:g,y1:r};y[y.length]={x:g,y:r};q<p.length-1&&(F!==(p[q].lineColor||z)||B!==(p[q].lineDashType||n.lineDashType))&&(F=p[q].lineColor||z,y[y.length-1].newStrokeStyle=F,b.setLineDash&&(p[q].lineDashType?(B=p[q].lineDashType,y[y.length-1].newLineDashArray=J(B,n.lineThickness)):(B=n.lineDashType,y[y.length-1].newLineDashArray=D)));if(0!==p[q].markerSize&&(0<p[q].markerSize||0<n.markerSize)){var aa=
n.getMarkerProperties(q,g,r,b);l.push(aa);L=O(L);w&&l.push({x:g,y:r,ctx:e,type:aa.type,size:aa.size,color:L,borderColor:L,borderThickness:aa.borderThickness})}(p[q].indexLabel||n.indexLabel||p[q].indexLabelFormatter||n.indexLabelFormatter)&&this._indexLabels.push({chartType:"splineArea",dataPoint:p[q],dataSeries:n,point:{x:g,y:r},direction:0>p[q].y===a.axisY.reversed?1:-1,color:x});r=!1}d();X.drawMarkers(l)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation=
...
function(a){var d,c;function b(){F&&(0<g.lineThickness&&f.stroke(),a.axisY.logarithmic||0>=a.axisY.viewportMinimum&&0<=a.axisY.viewportMaximum?z=x:0>a.axisY.viewportMaximum?z=t.y1:0<a.axisY.viewportMinimum&&(z=x),f.lineTo(s,z),f.lineTo(F.x,z),f.closePath(),f.globalAlpha=g.fillOpacity,f.fill(),f.globalAlpha=1,w&&(l.lineTo(s,z),l.lineTo(F.x,z),l.closePath(),l.fill()),f.beginPath(),f.moveTo(s,u),l.beginPath(),l.moveTo(s,u),F={x:s,y:u})}var e=a.targetCanvasCtx||this.plotArea.ctx,f=w?this._preRenderCtx:
e;if(!(0>=a.dataSeriesIndexes.length)){var l=this._eventManager.ghostCtx,t=a.axisY.lineCoordinates,h=[],k=this.plotArea,n;f.save();w&&l.save();f.beginPath();f.rect(k.x1,k.y1,k.width,k.height);f.clip();w&&(l.beginPath(),l.rect(k.x1,k.y1,k.width,k.height),l.clip());for(var p=0;p<a.dataSeriesIndexes.length;p++){var q=a.dataSeriesIndexes[p],g=this.data[q],r=g.dataPoints,h=g.id;this._eventManager.objectMap[h]={objectType:"dataSeries",dataSeriesIndex:q};h=O(h);l.fillStyle=h;h=[];d=!0;var m=0,s,u,y,x=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),z,F=null;c=!1;if(0<r.length){var B=g._colorSet[m%g._colorSet.length],v=g.lineColor=g.options.lineColor||B,A=v;f.fillStyle=B;f.strokeStyle=v;f.lineWidth=g.lineThickness;var L="solid";if(f.setLineDash){var aa=J(g.nullDataLineDashType,g.lineThickness),L=g.lineDashType,ea=J(L,g.lineThickness);f.setLineDash(ea)}for(;m<r.length;m++)if(y=r[m].x.getTime?r[m].x.getTime():r[m].x,!(y<a.axisX.dataInfo.viewPortMin||y>a.axisX.dataInfo.viewPortMax&&(!g.connectNullData||!c))){var Z=u;"number"!==
typeof r[m].y?(g.connectNullData||(c||d)||b(),c=!0):(s=a.axisX.convertValueToPixel(y),u=a.axisY.convertValueToPixel(r[m].y),d||c?(!d&&g.connectNullData?(f.setLineDash&&(g.options.nullDataLineDashType||L===g.lineDashType&&g.lineDashType!==g.nullDataLineDashType)&&(d=s,c=u,s=n.x,u=n.y,b(),f.moveTo(n.x,n.y),s=d,u=c,F=n,L=g.nullDataLineDashType,f.setLineDash(aa)),f.lineTo(s,Z),f.lineTo(s,u),w&&(l.lineTo(s,Z),l.lineTo(s,u))):(f.beginPath(),f.moveTo(s,u),w&&(l.beginPath(),l.moveTo(s,u)),F={x:s,y:u}),c=
d=!1):(f.lineTo(s,Z),w&&l.lineTo(s,Z),f.lineTo(s,u),w&&l.lineTo(s,u),0==m%250&&b()),n={x:s,y:u},m<r.length-1&&(A!==(r[m].lineColor||v)||L!==(r[m].lineDashType||g.lineDashType))&&(b(),A=r[m].lineColor||v,f.strokeStyle=A,f.setLineDash&&(r[m].lineDashType?(L=r[m].lineDashType,f.setLineDash(J(L,g.lineThickness))):(L=g.lineDashType,f.setLineDash(ea)))),y=g.dataPointIds[m],this._eventManager.objectMap[y]={id:y,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:m,x1:s,y1:u},0!==r[m].markerSize&&(0<
r[m].markerSize||0<g.markerSize)&&(Z=g.getMarkerProperties(m,s,u,f),h.push(Z),y=O(y),w&&h.push({x:s,y:u,ctx:l,type:Z.type,size:Z.size,color:y,borderColor:y,borderThickness:Z.borderThickness})),(r[m].indexLabel||g.indexLabel||r[m].indexLabelFormatter||g.indexLabelFormatter)&&this._indexLabels.push({chartType:"stepArea",dataPoint:r[m],dataSeries:g,point:{x:s,y:u},direction:0>r[m].y===a.axisY.reversed?1:-1,color:B}))}b();X.drawMarkers(h)}}w&&(e.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
m.prototype.renderStackedArea=function(a){function d(){if(!(1>k.length)){for(0<B.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&s.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(s.closePath(),s.fill(),s.beginPath());k=[]}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=[],t=this.plotArea,h=[],k=[],n=[],p=[],q=0,g,r,m=a.axisY.convertValueToPixel(a.axisY.logarithmic?
a.axisY.viewportMinimum:0),s=this._eventManager.ghostCtx,u,y,x;w&&s.beginPath();b.save();w&&s.save();b.beginPath();b.rect(t.x1,t.y1,t.width,t.height);b.clip();w&&(s.beginPath(),s.rect(t.x1,t.y1,t.width,t.height),s.clip());for(var e=[],z=0;z<a.dataSeriesIndexes.length;z++){var F=a.dataSeriesIndexes[z],B=this.data[F],v=B.dataPoints;B.dataPointIndexes=[];for(q=0;q<v.length;q++)F=v[q].x.getTime?v[q].x.getTime():v[q].x,B.dataPointIndexes[F]=q,e[F]||(n.push(F),e[F]=!0);n.sort(Ra)}for(z=0;z<a.dataSeriesIndexes.length;z++){F=
a.dataSeriesIndexes[z];B=this.data[F];v=B.dataPoints;y=!0;k=[];q=B.id;this._eventManager.objectMap[q]={objectType:"dataSeries",dataSeriesIndex:F};q=O(q);s.fillStyle=q;if(0<n.length){var e=B._colorSet[0],A=B.lineColor=B.options.lineColor||e,L=A;b.fillStyle=e;b.strokeStyle=A;b.lineWidth=B.lineThickness;x="solid";if(b.setLineDash){var aa=J(B.nullDataLineDashType,B.lineThickness);x=B.lineDashType;var ea=J(x,B.lineThickness);b.setLineDash(ea)}for(var Z=!0,q=0;q<n.length;q++){var f=n[q],ha=null,ha=0<=B.dataPointIndexes[f]?
v[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Z)))if("number"!==typeof ha.y)B.connectNullData||(Z||y)||d(),Z=!0;else{g=a.axisX.convertValueToPixel(f);var oa=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=ha.y+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(ha.y),r-=oa;k.push({x:g,
y:m-oa});h[f]=m-r;y||Z?(!y&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||x===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(y=k.pop(),x=k[k.length-1],d(),b.moveTo(u.x,u.y),k.push(x),k.push(y),x=B.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),w&&s.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(s.beginPath(),s.moveTo(g,r))),Z=y=!1):(b.lineTo(g,r),w&&s.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&s.moveTo(g,r),k.push({x:g,y:m-oa})));u={x:g,y:r};q<v.length-1&&(L!==
(v[q].lineColor||A)||x!==(v[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:m-oa}),L=v[q].lineColor||A,b.strokeStyle=L,b.setLineDash&&(v[q].lineDashType?(x=v[q].lineDashType,b.setLineDash(J(x,B.lineThickness))):(x=B.lineDashType,b.setLineDash(ea))));if(0<=B.dataPointIndexes[f]){var D=B.dataPointIds[B.dataPointIndexes[f]];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:F,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:r}}0<=B.dataPointIndexes[f]&&
0!==ha.markerSize&&(0<ha.markerSize||0<B.markerSize)&&(oa=B.getMarkerProperties(B.dataPointIndexes[f],g,r,b),l.push(oa),f=O(D),w&&l.push({x:g,y:r,ctx:s,type:oa.type,size:oa.size,color:f,borderColor:f,borderThickness:oa.borderThickness}));(ha.indexLabel||B.indexLabel||ha.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea",dataPoint:ha,dataSeries:B,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&s.moveTo(g,r)}delete B.dataPointIndexes}X.drawMarkers(l);
...
easingFunction:M.easing.linear,animationBase:0}}};m.prototype.renderStackedArea100=function(a){function d(){for(0<B.lineThickness&&b.stroke();0<k.length;){var a=k.pop();b.lineTo(a.x,a.y);w&&x.lineTo(a.x,a.y)}b.closePath();b.globalAlpha=B.fillOpacity;b.fill();b.globalAlpha=1;b.beginPath();w&&(x.closePath(),x.fill(),x.beginPath());k=[]}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=null,f=null,l=this.plotArea,t=[],h=[],k=[],n=[],p=[],q=
0,g,r,m,s,u,y=a.axisY.convertValueToPixel(a.axisY.logarithmic?a.axisY.viewportMinimum:0),x=this._eventManager.ghostCtx;b.save();w&&x.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(x.beginPath(),x.rect(l.x1,l.y1,l.width,l.height),x.clip());for(var e=[],z=0;z<a.dataSeriesIndexes.length;z++){var F=a.dataSeriesIndexes[z],B=this.data[F],v=B.dataPoints;B.dataPointIndexes=[];for(q=0;q<v.length;q++)F=v[q].x.getTime?v[q].x.getTime():v[q].x,B.dataPointIndexes[F]=q,e[F]||(n.push(F),e[F]=
!0);n.sort(Ra)}for(z=0;z<a.dataSeriesIndexes.length;z++){F=a.dataSeriesIndexes[z];B=this.data[F];v=B.dataPoints;s=!0;e=B.id;this._eventManager.objectMap[e]={objectType:"dataSeries",dataSeriesIndex:F};e=O(e);x.fillStyle=e;k=[];if(0<n.length){var e=B._colorSet[q%B._colorSet.length],A=B.lineColor=B.options.lineColor||e,L=A;b.fillStyle=e;b.strokeStyle=A;b.lineWidth=B.lineThickness;u="solid";if(b.setLineDash){var aa=J(B.nullDataLineDashType,B.lineThickness);u=B.lineDashType;var D=J(u,B.lineThickness);
b.setLineDash(D)}for(var Z=!0,q=0;q<n.length;q++){var f=n[q],ha=null,ha=0<=B.dataPointIndexes[f]?v[B.dataPointIndexes[f]]:{x:f,y:null};if(!(f<a.axisX.dataInfo.viewPortMin||f>a.axisX.dataInfo.viewPortMax&&(!B.connectNullData||!Z)))if("number"!==typeof ha.y)B.connectNullData||(Z||s)||d(),Z=!0;else{var oa;oa=0!==a.dataPointYSums[f]?100*(ha.y/a.dataPointYSums[f]):0;g=a.axisX.convertValueToPixel(f);var na=h[f]?h[f]:0;if(a.axisY.logarithmic||a.axisY.scaleBreaks&&0<a.axisY.scaleBreaks._appliedBreaks.length){p[f]=
oa+(p[f]?p[f]:0);if(0>=p[f]&&a.axisY.logarithmic)continue;r=a.axisY.convertValueToPixel(p[f])}else r=a.axisY.convertValueToPixel(oa),r-=na;k.push({x:g,y:y-na});h[f]=y-r;s||Z?(!s&&B.connectNullData?(b.setLineDash&&(B.options.nullDataLineDashType||u===B.lineDashType&&B.lineDashType!==B.nullDataLineDashType)&&(s=k.pop(),u=k[k.length-1],d(),b.moveTo(m.x,m.y),k.push(u),k.push(s),u=B.nullDataLineDashType,b.setLineDash(aa)),b.lineTo(g,r),w&&x.lineTo(g,r)):(b.beginPath(),b.moveTo(g,r),w&&(x.beginPath(),x.moveTo(g,
r))),Z=s=!1):(b.lineTo(g,r),w&&x.lineTo(g,r),0==q%250&&(d(),b.moveTo(g,r),w&&x.moveTo(g,r),k.push({x:g,y:y-na})));m={x:g,y:r};q<v.length-1&&(L!==(v[q].lineColor||A)||u!==(v[q].lineDashType||B.lineDashType))&&(d(),b.beginPath(),b.moveTo(g,r),k.push({x:g,y:y-na}),L=v[q].lineColor||A,b.strokeStyle=L,b.setLineDash&&(v[q].lineDashType?(u=v[q].lineDashType,b.setLineDash(J(u,B.lineThickness))):(u=B.lineDashType,b.setLineDash(D))));if(0<=B.dataPointIndexes[f]){var G=B.dataPointIds[B.dataPointIndexes[f]];
this._eventManager.objectMap[G]={id:G,objectType:"dataPoint",dataSeriesIndex:F,dataPointIndex:B.dataPointIndexes[f],x1:g,y1:r}}0<=B.dataPointIndexes[f]&&0!==ha.markerSize&&(0<ha.markerSize||0<B.markerSize)&&(na=B.getMarkerProperties(q,g,r,b),t.push(na),f=O(G),w&&t.push({x:g,y:r,ctx:x,type:na.type,size:na.size,color:f,borderColor:f,borderThickness:na.borderThickness}));(ha.indexLabel||B.indexLabel||ha.indexLabelFormatter||B.indexLabelFormatter)&&this._indexLabels.push({chartType:"stackedArea100",dataPoint:ha,
dataSeries:B,point:{x:g,y:r},direction:0>v[q].y===a.axisY.reversed?1:-1,color:e})}}d();b.moveTo(g,r);w&&x.moveTo(g,r)}delete B.dataPointIndexes}X.drawMarkers(t);w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
f,l,c);c.globalAlpha=k.fillOpacity;X.drawMarker(g.x,g.y,g.ctx,g.type,g.size,g.color,g.borderColor,g.borderThickness);c.globalAlpha=1;Math.sqrt((p-f)*(p-f)+(q-l)*(q-l))<Math.min(g.size,5)&&n.length>Math.min(this.plotArea.width,this.plotArea.height)||(p=k.dataPointIds[e],this._eventManager.objectMap[p]={id:p,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:e,x1:f,y1:l},p=O(p),w&&X.drawMarker(g.x,g.y,this._eventManager.ghostCtx,g.type,g.size,p,p,g.borderThickness),(n[e].indexLabel||k.indexLabel||
...
this.dataPointMaxWidth&&e>f&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,f));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&f<e)&&(f=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));r<e&&(r=e);r>f&&(r=f);c.save();w&&b.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(b.beginPath(),b.rect(l.x1,l.y1,l.width,l.height),b.clip());for(var m=0;m<a.dataSeriesIndexes.length;m++){var ga=a.dataSeriesIndexes[m],u=this.data[ga],y=u.dataPoints;
if(0<y.length)for(var x=5<r&&u.bevelEnabled?!0:!1,t=0;t<y.length;t++)if(y[t].getTime?g=y[t].x.getTime():g=y[t].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(y[t].y)&&y[t].y.length&&"number"===typeof y[t].y[0]&&"number"===typeof y[t].y[1]&&"number"===typeof y[t].y[2]&&"number"===typeof y[t].y[3]){h=a.axisX.convertValueToPixel(g);k=a.axisY.convertValueToPixel(y[t].y[0]);n=a.axisY.convertValueToPixel(y[t].y[1]);p=a.axisY.convertValueToPixel(y[t].y[2]);q=a.axisY.convertValueToPixel(y[t].y[3]);
var z=h-r/2<<0,F=z+r<<0,f=u.options.fallingColor?u.fallingColor:u._colorSet[0],e=y[t].color?y[t].color:u._colorSet[0],B=Math.round(Math.max(1,0.15*r)),v=0===B%2?0:0.5,A=u.dataPointIds[t];this._eventManager.objectMap[A]={id:A,objectType:"dataPoint",dataSeriesIndex:ga,dataPointIndex:t,x1:z,y1:k,x2:F,y2:n,x3:h,y3:p,x4:h,y4:q,borderThickness:B,color:e};c.strokeStyle=e;c.beginPath();c.lineWidth=B;b.lineWidth=Math.max(B,4);"candlestick"===u.type?(c.moveTo(h-v,n),c.lineTo(h-v,Math.min(k,q)),c.stroke(),c.moveTo(h-
v,Math.max(k,q)),c.lineTo(h-v,p),c.stroke(),$(c,z,Math.min(k,q),F,Math.max(k,q),y[t].y[0]<=y[t].y[3]?u.risingColor:f,B,e,x,x,!1,!1,u.fillOpacity),w&&(e=O(A),b.strokeStyle=e,b.moveTo(h-v,n),b.lineTo(h-v,Math.min(k,q)),b.stroke(),b.moveTo(h-v,Math.max(k,q)),b.lineTo(h-v,p),b.stroke(),$(b,z,Math.min(k,q),F,Math.max(k,q),e,0,null,!1,!1,!1,!1))):"ohlc"===u.type&&(c.moveTo(h-v,n),c.lineTo(h-v,p),c.stroke(),c.beginPath(),c.moveTo(h,k),c.lineTo(z,k),c.stroke(),c.beginPath(),c.moveTo(h,q),c.lineTo(F,q),c.stroke(),
w&&(e=O(A),b.strokeStyle=e,b.moveTo(h-v,n),b.lineTo(h-v,p),b.stroke(),b.beginPath(),b.moveTo(h,k),b.lineTo(z,k),b.stroke(),b.beginPath(),b.moveTo(h,q),b.lineTo(F,q),b.stroke()));(y[t].indexLabel||u.indexLabel||y[t].indexLabelFormatter||u.indexLabelFormatter)&&this._indexLabels.push({chartType:u.type,dataPoint:y[t],dataSeries:u,point:{x:z+(F-z)/2,y:a.axisY.reversed?p:n},direction:1,bounds:{x1:z,y1:Math.min(n,p),x2:F,y2:Math.max(n,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,
...
r=this.options.dataPointWidth?this.dataPointWidth:0.7*f.width*(a.axisX.logarithmic?Math.log(r)/Math.log(a.axisX.range):Math.abs(r)/Math.abs(a.axisX.range))<<0;this.dataPointMaxWidth&&e>l&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,l));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&l<e)&&(l=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));r<e&&(r=e);r>l&&(r=l);c.save();w&&b.save();c.beginPath();c.rect(f.x1,f.y1,f.width,f.height);c.clip();w&&(b.beginPath(),
b.rect(f.x1,f.y1,f.width,f.height),b.clip());for(var m=!1,m=!!a.axisY.reversed,ga=0;ga<a.dataSeriesIndexes.length;ga++){var u=a.dataSeriesIndexes[ga],y=this.data[u],x=y.dataPoints;if(0<x.length)for(var z=5<r&&y.bevelEnabled?!0:!1,l=0;l<x.length;l++)if(x[l].getTime?g=x[l].x.getTime():g=x[l].x,!(g<a.axisX.dataInfo.viewPortMin||g>a.axisX.dataInfo.viewPortMax)&&!s(x[l].y)&&x[l].y.length&&"number"===typeof x[l].y[0]&&"number"===typeof x[l].y[1]&&"number"===typeof x[l].y[2]&&"number"===typeof x[l].y[3]&&
"number"===typeof x[l].y[4]&&5===x[l].y.length){t=a.axisX.convertValueToPixel(g);h=a.axisY.convertValueToPixel(x[l].y[0]);k=a.axisY.convertValueToPixel(x[l].y[1]);n=a.axisY.convertValueToPixel(x[l].y[2]);p=a.axisY.convertValueToPixel(x[l].y[3]);q=a.axisY.convertValueToPixel(x[l].y[4]);var F=t-r/2<<0,B=t+r/2<<0,e=x[l].color?x[l].color:y._colorSet[0],v=Math.round(Math.max(1,0.15*r)),A=0===v%2?0:0.5,L=x[l].whiskerColor?x[l].whiskerColor:x[l].color?y.whiskerColor?y.whiskerColor:x[l].color:y.whiskerColor?
y.whiskerColor:e,aa="number"===typeof x[l].whiskerThickness?x[l].whiskerThickness:"number"===typeof y.options.whiskerThickness?y.whiskerThickness:v,D=x[l].whiskerDashType?x[l].whiskerDashType:y.whiskerDashType,Z=s(x[l].whiskerLength)?s(y.options.whiskerLength)?r:y.whiskerLength:x[l].whiskerLength,Z="number"===typeof Z?0>=Z?0:Z>=r?r:Z:"string"===typeof Z?parseInt(Z)*r/100>r?r:parseInt(Z)*r/100:r,ha=1===Math.round(aa)%2?0.5:0,oa=x[l].stemColor?x[l].stemColor:x[l].color?y.stemColor?y.stemColor:x[l].color:
y.stemColor?y.stemColor:e,na="number"===typeof x[l].stemThickness?x[l].stemThickness:"number"===typeof y.options.stemThickness?y.stemThickness:v,G=1===Math.round(na)%2?0.5:0,E=x[l].stemDashType?x[l].stemDashType:y.stemDashType,K=x[l].lineColor?x[l].lineColor:x[l].color?y.lineColor?y.lineColor:x[l].color:y.lineColor?y.lineColor:e,H="number"===typeof x[l].lineThickness?x[l].lineThickness:"number"===typeof y.options.lineThickness?y.lineThickness:v,P=x[l].lineDashType?x[l].lineDashType:y.lineDashType,
N=1===Math.round(H)%2?0.5:0,S=y.upperBoxColor,R=y.lowerBoxColor,ta=s(y.options.fillOpacity)?1:y.fillOpacity,Q=y.dataPointIds[l];this._eventManager.objectMap[Q]={id:Q,objectType:"dataPoint",dataSeriesIndex:u,dataPointIndex:l,x1:F,y1:h,x2:B,y2:k,x3:t,y3:n,x4:t,y4:p,y5:q,borderThickness:v,color:e,stemThickness:na,stemColor:oa,whiskerThickness:aa,whiskerLength:Z,whiskerColor:L,lineThickness:H,lineColor:K};c.save();0<na&&(c.beginPath(),c.strokeStyle=oa,c.lineWidth=na,c.setLineDash&&c.setLineDash(J(E,na)),
c.moveTo(t-G,k),c.lineTo(t-G,h),c.stroke(),c.moveTo(t-G,p),c.lineTo(t-G,n),c.stroke());c.restore();b.lineWidth=Math.max(v,4);c.beginPath();$(c,F,Math.min(q,k),B,Math.max(k,q),R,0,e,m?z:!1,m?!1:z,!1,!1,ta);c.beginPath();$(c,F,Math.min(n,q),B,Math.max(q,n),S,0,e,m?!1:z,m?z:!1,!1,!1,ta);c.beginPath();c.lineWidth=v;c.strokeStyle=e;c.rect(F-A,Math.min(k,n)-A,B-F+2*A,Math.max(k,n)-Math.min(k,n)+2*A);c.stroke();c.save();0<H&&(c.beginPath(),c.globalAlpha=1,c.setLineDash&&c.setLineDash(J(P,H)),c.strokeStyle=
K,c.lineWidth=H,c.moveTo(F,q-N),c.lineTo(B,q-N),c.stroke());c.restore();c.save();0<aa&&(c.beginPath(),c.setLineDash&&c.setLineDash(J(D,aa)),c.strokeStyle=L,c.lineWidth=aa,c.moveTo(t-Z/2<<0,p-ha),c.lineTo(t+Z/2<<0,p-ha),c.stroke(),c.moveTo(t-Z/2<<0,h+ha),c.lineTo(t+Z/2<<0,h+ha),c.stroke());c.restore();w&&(e=O(Q),b.strokeStyle=e,b.lineWidth=na,0<na&&(b.moveTo(t-A-G,k),b.lineTo(t-A-G,Math.max(h,p)),b.stroke(),b.moveTo(t-A-G,Math.min(h,p)),b.lineTo(t-A-G,n),b.stroke()),$(b,F,Math.max(k,n),B,Math.min(k,
n),e,0,null,!1,!1,!1,!1),0<aa&&(b.beginPath(),b.lineWidth=aa,b.moveTo(t+Z/2,p-ha),b.lineTo(t-Z/2,p-ha),b.stroke(),b.moveTo(t+Z/2,h+ha),b.lineTo(t-Z/2,h+ha),b.stroke()));(x[l].indexLabel||y.indexLabel||x[l].indexLabelFormatter||y.indexLabelFormatter)&&this._indexLabels.push({chartType:y.type,dataPoint:x[l],dataSeries:y,point:{x:F+(B-F)/2,y:a.axisY.reversed?h:p},direction:1,bounds:{x1:F,y1:Math.min(h,p),x2:B,y2:Math.max(h,p)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),
...
a.axisY.convertValueToPixel(g[f].y[0]);t=a.axisY.convertValueToPixel(g[f].y[1]);var m=a.axisX.reversed?b+a.plotType.totalDataSeries*k/2-(a.previousDataSeriesCount+n)*k<<0:b-a.plotType.totalDataSeries*k/2+(a.previousDataSeriesCount+n)*k<<0,ga=a.axisX.reversed?m-k<<0:m+k<<0,b=g[f].color?g[f].color:q._colorSet[f%q._colorSet.length];if(l>t){var u=l;l=t;t=u}u=q.dataPointIds[f];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:p,dataPointIndex:f,x1:m,y1:l,x2:ga,y2:t};$(c,a.axisX.reversed?
ga:m,l,a.axisX.reversed?m:ga,t,b,0,b,r,r,!1,!1,q.fillOpacity);b=O(u);w&&$(this._eventManager.ghostCtx,a.axisX.reversed?ga:m,l,a.axisX.reversed?m:ga,t,b,0,null,!1,!1,!1,!1);if(g[f].indexLabel||q.indexLabel||g[f].indexLabelFormatter||q.indexLabelFormatter)this._indexLabels.push({chartType:"rangeColumn",dataPoint:g[f],dataSeries:q,indexKeyword:0,point:{x:m+(ga-m)/2,y:g[f].y[1]>=g[f].y[0]?t:l},direction:g[f].y[1]>=g[f].y[0]?-1:1,bounds:{x1:m,y1:Math.min(l,t),x2:ga,y2:Math.max(l,t)},color:b}),this._indexLabels.push({chartType:"rangeColumn",
dataPoint:g[f],dataSeries:q,indexKeyword:1,point:{x:m+(ga-m)/2,y:g[f].y[1]>=g[f].y[0]?l:t},direction:g[f].y[1]>=g[f].y[0]?1:-1,bounds:{x1:m,y1:Math.min(l,t),x2:ga,y2:Math.max(l,t)},color:b})}}w&&(d.drawImage(this._preRenderCanvas,0,0,this.width,this.height),c.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&c.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&c.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,
...
t=0,h,k,n,p,q,g,r,m=a.axisX.dataInfo.minDiff;isFinite(m)||(m=0.3*Math.abs(a.axisX.range));c.save();w&&this._eventManager.ghostCtx.save();c.beginPath();c.rect(l.x1,l.y1,l.width,l.height);c.clip();w&&(this._eventManager.ghostCtx.beginPath(),this._eventManager.ghostCtx.rect(l.x1,l.y1,l.width,l.height),this._eventManager.ghostCtx.clip());for(var ga=0,u=0;u<this.data.length;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&ga||ga++;for(var y=
0;y<a.dataSeriesIndexes.length;y++){var x=a.dataSeriesIndexes[y],z=this.data[x],v=z.dataPoints,B=s(z._linkedSeries)?!1:z._linkedSeries.type.match(/(bar|column)/ig)&&z._linkedSeries.visible?!0:!1,A=0;if(B)for(e=z._linkedSeries.id,u=0;u<e;u++)!this.data[u].type.match(/(bar|column)/ig)||!this.data[u].visible||this.data[u].type.match(/(stacked)/ig)&&A||(this.data[u].type.match(/(range)/ig)&&(f=!0),A++);e=this.options.dataPointMinWidth?this.dataPointMinWidth:this.options.dataPointWidth?this.dataPointWidth:
1;t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(B?ga:1)))<<0:0.3*this.width;f&&(t=this.options.dataPointMaxWidth?this.dataPointMaxWidth:this.options.dataPointWidth?this.dataPointWidth:b?Math.min(0.15*this.height,0.9*(this.plotArea.height/(B?ga:1)))<<0:0.03*this.width);u=this.options.dataPointWidth?this.dataPointWidth:0.9*((b?l.height:l.width)*(a.axisX.logarithmic?Math.log(m)/Math.log(a.axisX.range):
Math.abs(m)/Math.abs(a.axisX.range))/(B?ga:1))<<0;this.dataPointMaxWidth&&e>t&&(e=Math.min(this.options.dataPointWidth?this.dataPointWidth:Infinity,t));!this.dataPointMaxWidth&&(this.dataPointMinWidth&&t<e)&&(t=Math.max(this.options.dataPointWidth?this.dataPointWidth:-Infinity,e));u<e&&(u=e);u>t&&(u=t);if(0<v.length)for(var E=z._colorSet,t=0;t<v.length;t++){var e=z.lineColor=z.options.color?z.options.color:E[0],L={color:v[t].whiskerColor?v[t].whiskerColor:v[t].color?z.whiskerColor?z.whiskerColor:
v[t].color:z.whiskerColor?z.whiskerColor:e,thickness:s(v[t].whiskerThickness)?z.whiskerThickness:v[t].whiskerThickness,dashType:v[t].whiskerDashType?v[t].whiskerDashType:z.whiskerDashType,length:s(v[t].whiskerLength)?s(z.options.whiskerLength)?u:z.options.whiskerLength:v[t].whiskerLength,trimLength:s(v[t].whiskerLength)?s(z.options.whiskerLength)?50:0:0};L.length="number"===typeof L.length?0>=L.length?0:L.length>=u?u:L.length:"string"===typeof L.length?parseInt(L.length)*u/100>u?u:parseInt(L.length)*
u/100>u:u;L.thickness="number"===typeof L.thickness?0>L.thickness?0:Math.round(L.thickness):2;var aa={color:v[t].stemColor?v[t].stemColor:v[t].color?z.stemColor?z.stemColor:v[t].color:z.stemColor?z.stemColor:e,thickness:v[t].stemThickness?v[t].stemThickness:z.stemThickness,dashType:v[t].stemDashType?v[t].stemDashType:z.stemDashType};aa.thickness="number"===typeof aa.thickness?0>aa.thickness?0:Math.round(aa.thickness):2;v[t].getTime?r=v[t].x.getTime():r=v[t].x;if(!(r<a.axisX.dataInfo.viewPortMin||
r>a.axisX.dataInfo.viewPortMax)&&!s(v[t].y)&&v[t].y.length&&"number"===typeof v[t].y[0]&&"number"===typeof v[t].y[1]){var ea=a.axisX.convertValueToPixel(r);b?k=ea:h=ea;ea=a.axisY.convertValueToPixel(v[t].y[0]);b?n=ea:q=ea;ea=a.axisY.convertValueToPixel(v[t].y[1]);b?p=ea:g=ea;b?(q=a.axisX.reversed?k+(B?ga:1)*u/2-(B?A-1:0)*u<<0:k-(B?ga:1)*u/2+(B?A-1:0)*u<<0,g=a.axisX.reversed?q-u<<0:q+u<<0):(n=a.axisX.reversed?h+(B?ga:1)*u/2-(B?A-1:0)*u<<0:h-(B?ga:1)*u/2+(B?A-1:0)*u<<0,p=a.axisX.reversed?n-u<<0:n+u<<
0);!b&&q>g&&(ea=q,q=g,g=ea);b&&n>p&&(ea=n,n=p,p=ea);ea=z.dataPointIds[t];this._eventManager.objectMap[ea]={id:ea,objectType:"dataPoint",dataSeriesIndex:x,dataPointIndex:t,x1:Math.min(n,p),y1:Math.min(q,g),x2:Math.max(p,n),y2:Math.max(g,q),isXYSwapped:b,stemProperties:aa,whiskerProperties:L};D(c,Math.min(n,p),Math.min(q,g),Math.max(p,n),Math.max(g,q),e,L,aa,b);w&&D(this._eventManager.ghostCtx,n,q,p,g,e,L,aa,b);if(v[t].indexLabel||z.indexLabel||v[t].indexLabelFormatter||z.indexLabelFormatter)this._indexLabels.push({chartType:"error",
...
n<<0:h-a.plotType.totalDataSeries*n/2+(a.previousDataSeriesCount+p)*n<<0;var v=a.axisX.reversed?h-n<<0:h+n<<0;l>t&&(b=l,l=t,t=b);b=r[f].color?r[f].color:g._colorSet[f%g._colorSet.length];$(c,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,null,m,!1,!1,!1,g.fillOpacity);b=g.dataPointIds[f];this._eventManager.objectMap[b]={id:b,objectType:"dataPoint",dataSeriesIndex:q,dataPointIndex:f,x1:l,y1:h,x2:t,y2:v};b=O(b);w&&$(this._eventManager.ghostCtx,l,a.axisX.reversed?v:h,t,a.axisX.reversed?h:v,b,0,null,
!1,!1,!1,!1);if(r[f].indexLabel||g.indexLabel||r[f].indexLabelFormatter||g.indexLabelFormatter)this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:0,point:{x:r[f].y[1]>=r[f].y[0]?l:t,y:h+(v-h)/2},direction:r[f].y[1]>=r[f].y[0]?-1:1,bounds:{x1:Math.min(l,t),y1:h,x2:Math.max(l,t),y2:v},color:b}),this._indexLabels.push({chartType:"rangeBar",dataPoint:r[f],dataSeries:g,indexKeyword:1,point:{x:r[f].y[1]>=r[f].y[0]?t:l,y:h+(v-h)/2},direction:r[f].y[1]>=r[f].y[0]?1:-1,bounds:{x1:Math.min(l,
...
b.lineTo(a.x,a.y1);b.stroke()}b.beginPath();b.moveTo(r,m);e.beginPath();e.moveTo(r,m);y={x:r,y:m};h=[];h.push({x:r,y1:m,y2:s})}}var c=a.targetCanvasCtx||this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=[],k=a.dataSeriesIndexes[t],
n=this.data[k],p=n.dataPoints,f=n.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:k};f=O(f);e.fillStyle=f;var f=[],q=!0,g=0,r,m,s,u,y=null;if(0<p.length){var x=n._colorSet[g%n._colorSet.length],v=n.lineColor=n.options.lineColor||x,A=v;b.fillStyle=x;b.strokeStyle=v;b.lineWidth=n.lineThickness;var B="solid";if(b.setLineDash){var D=J(n.nullDataLineDashType,n.lineThickness),B=n.lineDashType,E=J(B,n.lineThickness);b.setLineDash(E)}for(var L=!0;g<p.length;g++)if(u=p[g].x.getTime?
p[g].x.getTime():p[g].x,!(u<a.axisX.dataInfo.viewPortMin||u>a.axisX.dataInfo.viewPortMax&&(!n.connectNullData||!L)))if(null!==p[g].y&&p[g].y.length&&"number"===typeof p[g].y[0]&&"number"===typeof p[g].y[1]){r=a.axisX.convertValueToPixel(u);m=a.axisY.convertValueToPixel(p[g].y[0]);s=a.axisY.convertValueToPixel(p[g].y[1]);q||L?(n.connectNullData&&!q?(b.setLineDash&&(n.options.nullDataLineDashType||B===n.lineDashType&&n.lineDashType!==n.nullDataLineDashType)&&(h[h.length-1].newLineDashArray=E,B=n.nullDataLineDashType,
b.setLineDash(D)),b.lineTo(r,m),w&&e.lineTo(r,m),h.push({x:r,y1:m,y2:s})):(b.beginPath(),b.moveTo(r,m),y={x:r,y:m},h=[],h.push({x:r,y1:m,y2:s}),w&&(e.beginPath(),e.moveTo(r,m))),L=q=!1):(b.lineTo(r,m),h.push({x:r,y1:m,y2:s}),w&&e.lineTo(r,m),0==g%250&&d());u=n.dataPointIds[g];this._eventManager.objectMap[u]={id:u,objectType:"dataPoint",dataSeriesIndex:k,dataPointIndex:g,x1:r,y1:m,y2:s};g<p.length-1&&(A!==(p[g].lineColor||v)||B!==(p[g].lineDashType||n.lineDashType))&&(d(),A=p[g].lineColor||v,h[h.length-
1].newStrokeStyle=A,b.strokeStyle=A,b.setLineDash&&(p[g].lineDashType?(B=p[g].lineDashType,h[h.length-1].newLineDashArray=J(B,n.lineThickness),b.setLineDash(h[h.length-1].newLineDashArray)):(B=n.lineDashType,h[h.length-1].newLineDashArray=E,b.setLineDash(E))));if(0!==p[g].markerSize&&(0<p[g].markerSize||0<n.markerSize)){var aa=n.getMarkerProperties(g,r,s,b);f.push(aa);var ea=O(u);w&&f.push({x:r,y:s,ctx:e,type:aa.type,size:aa.size,color:ea,borderColor:ea,borderThickness:aa.borderThickness});aa=n.getMarkerProperties(g,
r,m,b);f.push(aa);ea=O(u);w&&f.push({x:r,y:m,ctx:e,type:aa.type,size:aa.size,color:ea,borderColor:ea,borderThickness:aa.borderThickness})}if(p[g].indexLabel||n.indexLabel||p[g].indexLabelFormatter||n.indexLabelFormatter)this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:0,point:{x:r,y:m},direction:p[g].y[0]>p[g].y[1]===a.axisY.reversed?-1:1,color:x}),this._indexLabels.push({chartType:"rangeArea",dataPoint:p[g],dataSeries:n,indexKeyword:1,point:{x:r,y:s},direction:p[g].y[0]>
...
this.plotArea.ctx,b=w?this._preRenderCtx:c;if(!(0>=a.dataSeriesIndexes.length)){var e=this._eventManager.ghostCtx,f=[],l=this.plotArea;b.save();w&&e.save();b.beginPath();b.rect(l.x1,l.y1,l.width,l.height);b.clip();w&&(e.beginPath(),e.rect(l.x1,l.y1,l.width,l.height),e.clip());for(var t=0;t<a.dataSeriesIndexes.length;t++){var h=a.dataSeriesIndexes[t],k=this.data[h],n=k.dataPoints,f=k.id;this._eventManager.objectMap[f]={objectType:"dataSeries",dataSeriesIndex:h};f=O(f);e.fillStyle=f;var f=[],p=0,q,
g,r,m=[],s=[];if(0<n.length){var u=k._colorSet[p%k._colorSet.length],y=k.lineColor=k.options.lineColor||u,x=y;b.fillStyle=u;b.lineWidth=k.lineThickness;var z="solid",A;if(b.setLineDash){var B=J(k.nullDataLineDashType,k.lineThickness),z=k.lineDashType;A=J(z,k.lineThickness)}for(g=!1;p<n.length;p++)if(q=n[p].x.getTime?n[p].x.getTime():n[p].x,!(q<a.axisX.dataInfo.viewPortMin||q>a.axisX.dataInfo.viewPortMax&&(!k.connectNullData||!g)))if(null!==n[p].y&&n[p].y.length&&"number"===typeof n[p].y[0]&&"number"===
typeof n[p].y[1]){q=a.axisX.convertValueToPixel(q);g=a.axisY.convertValueToPixel(n[p].y[0]);r=a.axisY.convertValueToPixel(n[p].y[1]);var D=k.dataPointIds[p];this._eventManager.objectMap[D]={id:D,objectType:"dataPoint",dataSeriesIndex:h,dataPointIndex:p,x1:q,y1:g,y2:r};m[m.length]={x:q,y:g};s[s.length]={x:q,y:r};p<n.length-1&&(x!==(n[p].lineColor||y)||z!==(n[p].lineDashType||k.lineDashType))&&(x=n[p].lineColor||y,m[m.length-1].newStrokeStyle=x,b.setLineDash&&(n[p].lineDashType?(z=n[p].lineDashType,
m[m.length-1].newLineDashArray=J(z,k.lineThickness)):(z=k.lineDashType,m[m.length-1].newLineDashArray=A)));if(0!==n[p].markerSize&&(0<n[p].markerSize||0<k.markerSize)){var H=k.getMarkerProperties(p,q,g,b);f.push(H);var L=O(D);w&&f.push({x:q,y:g,ctx:e,type:H.type,size:H.size,color:L,borderColor:L,borderThickness:H.borderThickness});H=k.getMarkerProperties(p,q,r,b);f.push(H);L=O(D);w&&f.push({x:q,y:r,ctx:e,type:H.type,size:H.size,color:L,borderColor:L,borderThickness:H.borderThickness})}if(n[p].indexLabel||
...
1].newLineDashArray=B,z=k.nullDataLineDashType):(d(A,y),m=[],s=[])),g=!0;d(A,y);X.drawMarkers(f)}}w&&(c.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.globalCompositeOperation="source-atop",a.axisX.maskCanvas&&b.drawImage(a.axisX.maskCanvas,0,0,this.width,this.height),a.axisY.maskCanvas&&b.drawImage(a.axisY.maskCanvas,0,0,this.width,this.height),this._breaksCanvasCtx&&this._breaksCanvasCtx.drawImage(this._preRenderCanvas,0,0,this.width,this.height),b.clearRect(l.x1,l.y1,l.width,l.height),
...
a.dataSeriesIndexes[g],s=this.data[m],v=s.dataPoints,e=s._colorSet[0];s.risingColor=s.options.risingColor?s.options.risingColor:e;s.fallingColor=s.options.fallingColor?s.options.fallingColor:"#e40a0a";var u="number"===typeof s.options.lineThickness?Math.round(s.lineThickness):1,y=1===Math.round(u)%2?-0.5:0;if(0<v.length)for(var x=5<q&&s.bevelEnabled?!0:!1,z=!1,A=null,B=null,l=0;l<v.length;l++)if(v[l].getTime?n=v[l].x.getTime():n=v[l].x,"number"!==typeof v[l].y){if(0<l&&!z&&s.connectNullData)var D=
s.options.nullDataLineDashType||!v[l-1].lineDashType?s.nullDataLineDashType:v[l-1].lineDashType;z=!0}else{t=a.axisX.convertValueToPixel(n);h=0===s.dataPointEOs[l].cumulativeSum?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSum);k=0===s.dataPointEOs[l].cumulativeSumYStartValue?p:a.axisY.convertValueToPixel(s.dataPointEOs[l].cumulativeSumYStartValue);t=a.axisX.reversed?t+a.plotType.totalDataSeries*q/2-(a.previousDataSeriesCount+g)*q<<0:t-a.plotType.totalDataSeries*q/2+(a.previousDataSeriesCount+
g)*q<<0;var E=a.axisX.reversed?t-q<<0:t+q<<0;h>k&&(e=h,h=k,k=e);a.axisY.reversed&&(e=h,h=k,k=e);e=s.dataPointIds[l];this._eventManager.objectMap[e]={id:e,objectType:"dataPoint",dataSeriesIndex:m,dataPointIndex:l,x1:t,y1:h,x2:E,y2:k};var L=v[l].color?v[l].color:0<v[l].y?s.risingColor:s.fallingColor;$(c,a.axisX.reversed?E:t,a.axisY.reversed?k:h,a.axisX.reversed?t:E,a.axisY.reversed?h:k,L,0,L,x,x,!1,!1,s.fillOpacity);e=O(e);w&&$(this._eventManager.ghostCtx,a.axisX.reversed?E:t,h,a.axisX.reversed?t:E,
k,e,0,null,!1,!1,!1,!1);var aa,L=t;aa="undefined"!==typeof v[l].isIntermediateSum&&!0===v[l].isIntermediateSum||"undefined"!==typeof v[l].isCumulativeSum&&!0===v[l].isCumulativeSum?0<v[l].y?h:k:0<v[l].y?k:h;0<l&&A&&(!z||s.connectNullData)&&(z&&c.setLineDash&&c.setLineDash(J(D,u)),c.beginPath(),c.moveTo(A,B-y),c.lineTo(L,aa-y),0<u&&c.stroke(),w&&(b.beginPath(),b.moveTo(A,B-y),b.lineTo(L,aa-y),0<u&&b.stroke()));z=!1;A=E;B=0<v[l].y?h:k;L=v[l].lineDashType?v[l].lineDashType:s.options.lineDashType?s.options.lineDashType:
"shortDash";c.strokeStyle=v[l].lineColor?v[l].lineColor:s.options.lineColor?s.options.lineColor:"#9e9e9e";c.lineWidth=u;c.setLineDash&&(L=J(L,u),c.setLineDash(L));(v[l].indexLabel||s.indexLabel||v[l].indexLabelFormatter||s.indexLabelFormatter)&&this._indexLabels.push({chartType:"waterfall",dataPoint:v[l],dataSeries:s,point:{x:t+(E-t)/2,y:0<=v[l].y?h:k},direction:0>v[l].y===a.axisY.reversed?1:-1,bounds:{x1:t,y1:Math.min(h,k),x2:E,y2:Math.max(h,k)},color:e})}}w&&(d.drawImage(this._preRenderCanvas,0,
...
f.indexLabel?m.replaceKeywordsWithValue(f.indexLabel,f,k,e):k.indexLabelFormatter?k.indexLabelFormatter(t):k.indexLabel?m.replaceKeywordsWithValue(k.indexLabel,f,k,e):f.label?f.label:"";m._eventManager.objectMap[l]=h;h.center={x:x.x,y:x.y};h.y=f.y;h.radius=B;h.percentInnerRadius=E;h.indexLabelText=p;h.indexLabelPlacement=k.indexLabelPlacement;h.indexLabelLineColor=f.indexLabelLineColor?f.indexLabelLineColor:k.options.indexLabelLineColor?k.options.indexLabelLineColor:f.color?f.color:k._colorSet[e%
...
2+c-h);c=p.indexLabelTextBlock.y+c;k=0;k="right"===p.hemisphere?x.x+Math.sqrt(Math.pow(w,2)-Math.pow(c-x.y,2)):x.x-Math.sqrt(Math.pow(w,2)-Math.pow(c-x.y,2));t=x.x+B*Math.cos(p.midAngle);q=x.y+B*Math.sin(p.midAngle);q=Math.sqrt(Math.pow(k-t,2)+Math.pow(c-q,2));t=Math.acos(B/w);q=Math.acos((w*w+B*B-q*q)/(2*B*w));c=q<t?c-p.indexLabelTextBlock.y:0;k=null;for(h=1;h<n.length;h++)if(k=(a-h+g.length)%g.length,g[k].hemisphere!==g[a].hemisphere){k=null;break}else if(g[k].indexLabelText&&g[k].hemisphere===
...
15)),p.indexLabelTextBlock.y=d,p.indexLabelTextBlock.x=c,p.indexLabelAngle=Math.atan2(p.indexLabelTextBlock.y-x.y,p.indexLabelTextBlock.x-x.x))}return l}function l(){var a=m.plotArea.ctx;a.fillStyle="grey";a.strokeStyle="grey";a.font="16px Arial";a.textBaseline="middle";for(var c=a=0,d=0,l=!0,c=0;10>c&&(1>c||0<d);c++){if(k.radius||!k.radius&&"undefined"!==typeof k.innerRadius&&null!==k.innerRadius&&B-d<=D)l=!1;l&&(B-=d);d=0;if("inside"!==k.indexLabelPlacement){w=B*v;for(a=0;a<n.length;a++){var h=
g[a];h.indexLabelTextBlock.x=x.x+w*Math.cos(h.midAngle);h.indexLabelTextBlock.y=x.y+w*Math.sin(h.midAngle);h.indexLabelAngle=h.midAngle;h.radius=B;h.percentInnerRadius=E}for(var t,s,a=0;a<n.length;a++){var h=g[a],u=e(a);if(null!==u){t=g[a];s=g[u];var z=0,z=b(t,s)-r;if(0>z){for(var A=s=0,F=0;F<n.length;F++)F!==a&&g[F].hemisphere===h.hemisphere&&(g[F].indexLabelTextBlock.y<h.indexLabelTextBlock.y?s++:A++);s=z/(s+A||1)*A;var A=-1*(z-s),J=F=0;"right"===h.hemisphere?(F=f(a,s),A=-1*(z-F),J=f(u,A),+J.toFixed(y)<
+A.toFixed(y)&&+F.toFixed(y)<=+s.toFixed(y)&&f(a,-(A-J))):(F=f(u,s),A=-1*(z-F),J=f(a,A),+J.toFixed(y)<+A.toFixed(y)&&+F.toFixed(y)<=+s.toFixed(y)&&f(u,-(A-J)))}}}}else for(a=0;a<n.length;a++)h=g[a],w="pie"===k.type?0.7*B:0.8*B,u=x.x+w*Math.cos(h.midAngle),s=x.y+w*Math.sin(h.midAngle),h.indexLabelTextBlock.x=u,h.indexLabelTextBlock.y=s;for(a=0;a<n.length;a++)if(h=g[a],u=h.indexLabelTextBlock.measureText(),0!==u.height&&0!==u.width)u=u=0,"right"===h.hemisphere?(u=q.x2-(h.indexLabelTextBlock.x+h.indexLabelTextBlock.width+
p),u*=-1):u=q.x1-(h.indexLabelTextBlock.x-h.indexLabelTextBlock.width-p),0<u&&(!l&&h.indexLabelText&&(s="right"===h.hemisphere?q.x2-h.indexLabelTextBlock.x:h.indexLabelTextBlock.x-q.x1,0.3*h.indexLabelTextBlock.maxWidth>s?h.indexLabelText="":h.indexLabelTextBlock.maxWidth=0.85*s,0.3*h.indexLabelTextBlock.maxWidth<s&&(h.indexLabelTextBlock.x-="right"===h.hemisphere?2:-2)),Math.abs(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-x.y)<B||Math.abs(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/
2-x.y)<B)&&(u/=Math.abs(Math.cos(h.indexLabelAngle)),9<u&&(u*=0.3),u>d&&(d=u)),u=u=0,0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?(u=q.y2-(h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2+5),u*=-1):u=q.y1-(h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2-5),0<u&&(!l&&h.indexLabelText&&(s=0<h.indexLabelAngle&&h.indexLabelAngle<Math.PI?-1:1,0===f(a,u*s)&&f(a,2*s)),Math.abs(h.indexLabelTextBlock.x-x.x)<B&&(u/=Math.abs(Math.sin(h.indexLabelAngle)),9<u&&(u*=0.3),u>d&&(d=u)));var H=function(a,
b,c){for(var d=[],e=0;d.push(g[b]),b!==c;b=(b+1+n.length)%n.length);d.sort(function(a,b){return a.y-b.y});for(b=0;b<d.length;b++)if(c=d[b],e<0.7*a)e+=c.indexLabelTextBlock.height,c.indexLabelTextBlock.text="",c.indexLabelText="",c.indexLabelTextBlock.measureText();else break};(function(){for(var a=-1,c=-1,d=0,f=!1,k=0;k<n.length;k++)if(f=!1,t=g[k],t.indexLabelText){var l=e(k);if(null!==l){var h=g[l];z=0;z=b(t,h);var q;if(q=0>z){q=t.indexLabelTextBlock.x;var m=t.indexLabelTextBlock.y-t.indexLabelTextBlock.height/
2,r=t.indexLabelTextBlock.y+t.indexLabelTextBlock.height/2,s=h.indexLabelTextBlock.y-h.indexLabelTextBlock.height/2,u=h.indexLabelTextBlock.x+h.indexLabelTextBlock.width,C=h.indexLabelTextBlock.y+h.indexLabelTextBlock.height/2;q=t.indexLabelTextBlock.x+t.indexLabelTextBlock.width<h.indexLabelTextBlock.x-p||q>u+p||m>C+p||r<s-p?!1:!0}q?(0>a&&(a=k),l!==a&&(c=l,d+=-z),0===k%Math.max(n.length/10,3)&&(f=!0)):f=!0;f&&(0<d&&0<=a&&0<=c)&&(H(d,a,c),c=a=-1,d=0)}}0<d&&H(d,a,c)})()}}function h(){m.plotArea.layoutManager.reset();
...
function(a){function d(){for(var a=0,b=[],c=0;c<y.length;c++){if("undefined"===typeof y[c].y)return-1;y[c].y="number"===typeof y[c].y?y[c].y:0;a+=Math.abs(y[c].y)}if(0===a)return-1;for(c=b[0]=0;c<y.length;c++)b.push(Math.abs(y[c].y)*D/a);return b}function c(){var a=V,b=U,c=N,d=X,e,f;e=Z;f=P-O;d=Math.abs((f-e)*(b-a+(d-c))/2);c=X-N;e=f-e;f=c*(f-P);f=Math.abs(f);f=d+f;for(var d=[],g=0,k=0;k<y.length;k++){if("undefined"===typeof y[k].y)return-1;y[k].y="number"===typeof y[k].y?y[k].y:0;g+=Math.abs(y[k].y)}if(0===
g)return-1;for(var l=d[0]=0,h=0,n,p,b=b-a,l=!1,k=0;k<y.length;k++)a=Math.abs(y[k].y)*f/g,l?n=0==Number(c.toFixed(3))?0:a/c:(p=ba*ba*b*b-4*Math.abs(ba)*a,0>p?(p=c,l=(b+p)*(e-h)/2,a-=l,n=e-h,h+=e-h,n+=0==p?0:a/p,h+=a/p,l=!0):(n=(Math.abs(ba)*b-Math.sqrt(p))/2,p=b-2*n/Math.abs(ba),h+=n,h>e&&(h-=n,p=c,l=(b+p)*(e-h)/2,a-=l,n=e-h,h+=e-h,n+=a/p,h+=a/p,l=!0),b=p)),d.push(n);return d}function b(){if(u&&y){for(var a,b,c,d,e,f,k,l,h,n,p,q,t,m,r,C=[],x=[],v={percent:null,total:null},z=null,B=0;B<y.length;B++)r=
Q[B],r="undefined"!==typeof r.x5?(r.y2+r.y4)/2:(r.y2+r.y3)/2,r=g(r).x2+1,C[B]=K-r-W;r=0.5*W;for(var B=0,Qa=y.length-1;B<y.length||0<=Qa;B++,Qa--){b=u.reversed?y[Qa]:y[B];a=b.color?b.color:u.reversed?u._colorSet[(y.length-1-B)%u._colorSet.length]:u._colorSet[B%u._colorSet.length];c=b.indexLabelPlacement||u.indexLabelPlacement||"outside";m=b.indexLabelTextAlign||u.indexLabelTextAlign||"left";d=b.indexLabelBackgroundColor||u.indexLabelBackgroundColor||(w?"transparent":null);e=b.indexLabelFontColor||
u.indexLabelFontColor||"#979797";f=s(b.indexLabelFontSize)?u.indexLabelFontSize:b.indexLabelFontSize;k=b.indexLabelFontStyle||u.indexLabelFontStyle||"normal";l=b.indexLabelFontFamily||u.indexLabelFontFamily||"arial";h=b.indexLabelFontWeight||u.indexLabelFontWeight||"normal";a=b.indexLabelLineColor||u.options.indexLabelLineColor||a;n="number"===typeof b.indexLabelLineThickness?b.indexLabelLineThickness:"number"===typeof u.indexLabelLineThickness?u.indexLabelLineThickness:2;p=b.indexLabelLineDashType||
u.indexLabelLineDashType||"solid";q="undefined"!==typeof b.indexLabelWrap?b.indexLabelWrap:"undefined"!==typeof u.indexLabelWrap?u.indexLabelWrap:!0;t=u.dataPointIds[B];A._eventManager.objectMap[t]={id:t,objectType:"dataPoint",dataPointIndex:B,dataSeriesIndex:0,funnelSection:Q[u.reversed?y.length-1-B:B]};"inside"===u.indexLabelPlacement&&(C[B]=B!==ca?u.reversed?Q[B].x2-Q[B].x1:Q[B].x3-Q[B].x4:Q[B].x3-Q[B].x6,20>C[B]&&(C[B]=B!==ca?u.reversed?Q[B].x3-Q[B].x4:Q[B].x2-Q[B].x1:Q[B].x2-Q[B].x1,C[B]/=2));
t=b.indexLabelMaxWidth?b.indexLabelMaxWidth:u.options.indexLabelMaxWidth?u.indexLabelMaxWidth:C[B];if(t>C[B]||0>t)t=C[B];x[B]="inside"===u.indexLabelPlacement?Q[B].height:!1;v=A.getPercentAndTotal(u,b);if(u.indexLabelFormatter||b.indexLabelFormatter)z={chart:A.options,dataSeries:u,dataPoint:b,total:v.total,percent:v.percent};b=b.indexLabelFormatter?b.indexLabelFormatter(z):b.indexLabel?A.replaceKeywordsWithValue(b.indexLabel,b,u,B):u.indexLabelFormatter?u.indexLabelFormatter(z):u.indexLabel?A.replaceKeywordsWithValue(u.indexLabel,
b,u,B):b.label?b.label:"";0>=n&&(n=0);1E3>t&&1E3-t<r&&(t+=1E3-t);R.roundRect||Ca(R);c=new ka(R,{fontSize:f,fontFamily:l,fontColor:e,fontStyle:k,fontWeight:h,horizontalAlign:c,textAlign:m,backgroundColor:d,maxWidth:t,maxHeight:!1===x[B]?q?4.28571429*f:1.5*f:x[B],text:b,padding:da});c.measureText();I.push({textBlock:c,id:u.reversed?Qa:B,isDirty:!1,lineColor:a,lineThickness:n,lineDashType:p,height:c.height<c.maxHeight?c.height:c.maxHeight,width:c.width<c.maxWidth?c.width:c.maxWidth})}}}function e(){var a,
b,c,d,e,f=[];e=!1;c=0;for(var g,k=K-U-W/2,k=u.options.indexLabelMaxWidth?u.indexLabelMaxWidth>k?k:u.indexLabelMaxWidth:k,l=I.length-1;0<=l;l--){g=y[I[l].id];c=I[l];d=c.textBlock;b=(a=q(l)<Q.length?I[q(l)]:null)?a.textBlock:null;c=c.height;a&&d.y+c+da>b.y&&(e=!0);c=g.indexLabelMaxWidth||k;if(c>k||0>c)c=k;f.push(c)}if(e)for(l=I.length-1;0<=l;l--)a=Q[l],I[l].textBlock.maxWidth=f[f.length-(l+1)],I[l].textBlock.measureText(),I[l].textBlock.x=K-k,c=I[l].textBlock.height<I[l].textBlock.maxHeight?I[l].textBlock.height:
I[l].textBlock.maxHeight,e=I[l].textBlock.width<I[l].textBlock.maxWidth?I[l].textBlock.width:I[l].textBlock.maxWidth,I[l].height=c,I[l].width=e,c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,I[l].textBlock.y=c-I[l].height/2,u.reversed?(I[l].textBlock.y+I[l].height>T+z&&(I[l].textBlock.y=T+z-I[l].height),I[l].textBlock.y<ta-z&&(I[l].textBlock.y=ta-z)):(I[l].textBlock.y<T-z&&(I[l].textBlock.y=T-z),I[l].textBlock.y+I[l].height>ta+z&&(I[l].textBlock.y=ta+z-I[l].height))}function f(){var a,b,
c,d;if("inside"!==u.indexLabelPlacement)for(var e=0;e<Q.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=Q[e],c="undefined"!==typeof a.x5?(a.y2+a.y4)/2:(a.y2+a.y3)/2,b=u.reversed?"undefined"!==typeof a.x5?c>Ba?g(c).x2+1:(a.x2+a.x3)/2+1:(a.x2+a.x3)/2+1:"undefined"!==typeof a.x5?c<Ba?g(c).x2+1:(a.x4+a.x3)/2+1:(a.x2+a.x3)/2+1,I[e].textBlock.x=b+W,I[e].textBlock.y=c-I[e].height/2,u.reversed?(I[e].textBlock.y+I[e].height>T+z&&(I[e].textBlock.y=T+z-I[e].height),I[e].textBlock.y<ta-z&&(I[e].textBlock.y=
ta-z)):(I[e].textBlock.y<T-z&&(I[e].textBlock.y=T-z),I[e].textBlock.y+I[e].height>ta+z&&(I[e].textBlock.y=ta+z-I[e].height)));else for(e=0;e<Q.length;e++)0==I[e].textBlock.text.length?I[e].isDirty=!0:(a=Q[e],b=a.height,c=I[e].height,d=I[e].width,b>=c?(b=e!=ca?(a.x4+a.x3)/2-d/2:(a.x5+a.x4)/2-d/2,c=e!=ca?(a.y1+a.y3)/2-c/2:(a.y1+a.y4)/2-c/2,I[e].textBlock.x=b,I[e].textBlock.y=c):I[e].isDirty=!0)}function l(){function a(b,c){var d;if(0>b||b>=I.length)return 0;var e,f=I[b].textBlock;if(0>c){c*=-1;e=p(b);
d=h(e,b);if(d>=c)return f.y-=c,c;if(0==b)return 0<d&&(f.y-=d),d;d+=a(e,-(c-d));0<d&&(f.y-=d);return d}e=q(b);d=h(b,e);if(d>=c)return f.y+=c,c;if(b==Q.length-1)return 0<d&&(f.y+=d),d;d+=a(e,c-d);0<d&&(f.y+=d);return d}function b(){var a,d,e,f,g=0,l;f=(P-Z+2*z)/n;l=n;for(var k,h=1;h<l;h++){e=h*f;for(var t=I.length-1;0<=t;t--)!I[t].isDirty&&(I[t].textBlock.y<e&&I[t].textBlock.y+I[t].height>e)&&(k=q(t),!(k>=I.length-1)&&I[t].textBlock.y+I[t].height+da>I[k].textBlock.y&&(I[t].textBlock.y=I[t].textBlock.y+
I[t].height-e>e-I[t].textBlock.y?e+1:e-I[t].height-1))}for(k=Q.length-1;0<k;k--)if(!I[k].isDirty){e=p(k);if(0>e&&(e=0,I[e].isDirty))break;if(I[k].textBlock.y<I[e].textBlock.y+I[e].height){d=d||k;f=k;for(l=0;I[f].textBlock.y<I[e].textBlock.y+I[e].height+da;){a=a||I[f].textBlock.y+I[f].height;l+=I[f].height;l+=da;f=e;if(0>=f){f=0;l+=I[f].height;break}e=p(f);if(0>e){f=0;l+=I[f].height;break}}if(f!=k){g=I[f].textBlock.y;a-=g;a=l-a;g=c(a,d,f);break}}}return g}function c(a,b,d){var e=[],f=0,g=0;for(a=Math.abs(a);d<=
b;d++)e.push(Q[d]);e.sort(function(a,b){return a.height-b.height});for(d=0;d<e.length;d++)if(b=e[d],f<a)g++,f+=I[b.id].height+da,I[b.id].textBlock.text="",I[b.id].indexLabelText="",I[b.id].isDirty=!0,I[b.id].textBlock.measureText();else break;return g}for(var d,e,f,g,l,k,n=1,m=0;m<2*n;m++){for(var r=I.length-1;0<=r&&!(0<=p(r)&&p(r),f=I[r],g=f.textBlock,k=(l=q(r)<Q.length?I[q(r)]:null)?l.textBlock:null,d=+f.height.toFixed(6),e=+g.y.toFixed(6),!f.isDirty&&(l&&e+d+da>+k.y.toFixed(6))&&(d=g.y+d+da-k.y,
e=a(r,-d),e<d&&(0<e&&(d-=e),e=a(q(r),d),e!=d)));r--);b()}}function h(a,b){return(b<Q.length?I[b].textBlock.y:u.reversed?T+z:ta+z)-(0>a?u.reversed?ta-z:T-z:I[a].textBlock.y+I[a].height+da)}function m(a,b,c){var d,e,g,l=[],h=z,p=[];-1!==b&&(0<=Y.indexOf(b)?(e=Y.indexOf(b),Y.splice(e,1)):(Y.push(b),Y=Y.sort(function(a,b){return a-b})));if(0===Y.length)l=ja;else{e=z*(1!=Y.length||0!=Y[0]&&Y[0]!=Q.length-1?2:1)/k();for(var t=0;t<Q.length;t++){if(1==Y.length&&0==Y[0]){if(0===t){l.push(ja[t]);d=h;continue}}else 0===
...
b}};a._animator.animate(0,c,function(c){var d=a.plotArea.ctx||a.ctx;ia=!0;d.clearRect(x.x1,x.y1,x.x2-x.x1,x.y2-x.y1);d.fillStyle=a.backgroundColor;d.fillRect(x.x1,x.y1,x.width,x.height);q.changeSection(c,b);var e={};e.dataSeries=u;e.dataPoint=u.reversed?u.dataPoints[y.length-1-b]:u.dataPoints[b];e.index=u.reversed?y.length-1-b:b;a.toolTip.highlightObjects([e]);for(e=0;e<Q.length;e++)sa(d,Q[e],u.fillOpacity);v(d);L&&("inside"!==u.indexLabelPlacement?n(d):f(),r(d));1<=c&&(ia=!1)},null,M.easing.easeOutQuart)}
function k(){for(var a=0,b=0;b<Q.length-1;b++)(0<=Y.indexOf(b)||0<=Y.indexOf(b+1))&&a++;return a}function n(a){for(var b,c,d,e,f=0;f<Q.length;f++)e=1===I[f].lineThickness%2?0.5:0,c=((Q[f].y2+Q[f].y4)/2<<0)+e,b=g(c).x2-1,d=I[f].textBlock.x,e=(I[f].textBlock.y+I[f].height/2<<0)+e,I[f].isDirty||0==I[f].lineThickness||(a.strokeStyle=I[f].lineColor,a.lineWidth=I[f].lineThickness,a.setLineDash&&a.setLineDash(J(I[f].lineDashType,I[f].lineThickness)),a.beginPath(),a.moveTo(b,c),a.lineTo(d,e),a.stroke())}
function p(a){for(a-=1;-1<=a&&-1!=a&&I[a].isDirty;a--);return a}function q(a){for(a+=1;a<=Q.length&&a!=Q.length&&I[a].isDirty;a++);return a}function g(a){for(var b,c=0;c<y.length;c++)if(Q[c].y1<a&&Q[c].y4>a){b=Q[c];break}return b?(a=b.y6?a>b.y6?b.x3+(b.x4-b.x3)/(b.y4-b.y3)*(a-b.y3):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2):b.x2+(b.x3-b.x2)/(b.y3-b.y2)*(a-b.y2),{x1:a,x2:a}):-1}function r(a){for(var b=0;b<Q.length;b++)I[b].isDirty||(a&&(I[b].textBlock.ctx=a),I[b].textBlock.render(!0))}function v(a){A.plotArea.layoutManager.reset();
...
S.fNg&&S.fNg(A)}var A=this;if(!(0>=a.dataSeriesIndexes.length)){for(var u=this.data[a.dataSeriesIndexes[0]],y=u.dataPoints,x=this.plotArea,z=0.025*x.width,F=0.01*x.width,B=0,D=x.height-2*z,E=Math.min(x.width-2*F,2.8*x.height),L=!1,H=0;H<y.length;H++)if(!L&&("undefined"!==typeof y[H].indexLabel&&null!==y[H].indexLabel&&0<y[H].indexLabel.toString().length)&&(L=!0),!L&&("undefined"!==typeof y[H].label&&null!==y[H].label&&0<y[H].label.toString().length)&&(L=!0),!L&&"function"===typeof u.indexLabelFormatter||
"function"===typeof y[H].indexLabelFormatter)L=!0;L=L||"undefined"!==typeof u.indexLabel&&null!==u.indexLabel&&0<u.indexLabel.toString().length;"inside"!==u.indexLabelPlacement&&L||(F=(x.width-0.75*E)/2);var H=x.x1+F,K=x.x2-F,Z=x.y1+z,P=x.y2-z,R=a.targetCanvasCtx||this.plotArea.ctx||this.ctx;if(0!=u.length&&(u.dataPoints&&u.visible)&&0!==y.length){var O,G;a=75*E/100;var W=30*(K-a)/100;"funnel"===u.type?(O=s(u.options.neckHeight)?0.35*D:u.neckHeight,G=s(u.options.neckWidth)?0.25*a:u.neckWidth,"string"===
typeof O&&O.match(/%$/)?(O=parseInt(O),O=O*D/100):O=parseInt(O),"string"===typeof G&&G.match(/%$/)?(G=parseInt(G),G=G*a/100):G=parseInt(G),O>D?O=D:0>=O&&(O=0),G>a?G=a-0.5:0>=G&&(G=0)):"pyramid"===u.type&&(G=O=0,u.reversed=u.reversed?!1:!0);var F=H+a/2,V=H,U=H+a,T=u.reversed?P:Z,N=F-G/2,X=F+G/2,Ba=u.reversed?Z+O:P-O,ta=u.reversed?Z:P;a=[];var F=[],Q=[],E=[],$=Z,ca,ba=(Ba-T)/(N-V),fa=-ba,H="area"===(u.valueRepresents?u.valueRepresents:"height")?c():d();if(-1!==H){if(u.reversed)for(E.push($),G=H.length-
1;0<G;G--)$+=H[G],E.push($);else for(G=0;G<H.length;G++)$+=H[G],E.push($);if(u.reversed)for(G=0;G<H.length;G++)E[G]<Ba?(a.push(N),F.push(X),ca=G):(a.push((E[G]-T+ba*V)/ba),F.push((E[G]-T+fa*U)/fa));else for(G=0;G<H.length;G++)E[G]<Ba?(a.push((E[G]-T+ba*V)/ba),F.push((E[G]-T+fa*U)/fa),ca=G):(a.push(N),F.push(X));for(G=0;G<H.length-1;G++)$=u.reversed?y[y.length-1-G].color?y[y.length-1-G].color:u._colorSet[(y.length-1-G)%u._colorSet.length]:y[G].color?y[G].color:u._colorSet[G%u._colorSet.length],G===
ca?Q.push({x1:a[G],y1:E[G],x2:F[G],y2:E[G],x3:X,y3:Ba,x4:F[G+1],y4:E[G+1],x5:a[G+1],y5:E[G+1],x6:N,y6:Ba,id:G,height:E[G+1]-E[G],color:$}):Q.push({x1:a[G],y1:E[G],x2:F[G],y2:E[G],x3:F[G+1],y3:E[G+1],x4:a[G+1],y4:E[G+1],id:G,height:E[G+1]-E[G],color:$});var da=2,I=[],ia=!1,Y=[],ja=[],H=!1;a=a=0;Da(Y);for(G=0;G<y.length;G++)y[G].exploded&&(H=!0,u.reversed?Y.push(y.length-1-G):Y.push(G));R.clearRect(x.x1,x.y1,x.width,x.height);R.fillStyle=A.backgroundColor;R.fillRect(x.x1,x.y1,x.width,x.height);if(L&&
u.visible&&(b(),f(),e(),"inside"!==u.indexLabelPlacement)){l();for(G=0;G<y.length;G++)I[G].isDirty||(a=I[G].textBlock.x+I[G].width,a=(K-a)/2,0==G&&(B=a),B>a&&(B=a));for(G=0;G<Q.length;G++)Q[G].x1+=B,Q[G].x2+=B,Q[G].x3+=B,Q[G].x4+=B,Q[G].x5&&(Q[G].x5+=B,Q[G].x6+=B),I[G].textBlock.x+=B}for(G=0;G<Q.length;G++)B=Q[G],sa(R,B,u.fillOpacity),ja.push(B.y1);v(R);L&&u.visible&&("inside"===u.indexLabelPlacement||A.animationEnabled||n(R),A.animationEnabled||r());if(!L)for(G=0;G<y.length;G++)B=u.dataPointIds[G],
a={id:B,objectType:"dataPoint",dataPointIndex:G,dataSeriesIndex:0,funnelSection:Q[u.reversed?y.length-1-G:G]},A._eventManager.objectMap[B]=a;!A.animationEnabled&&H?m(A,-1,0):A.animationEnabled&&!A.animatedRender&&m(A,-1,0);this.funnelPyramidClickHandler=function(a){var b=-1;if(!ia&&!A.isAnimating&&(s(a.dataSeries.explodeOnClick)||a.dataSeries.explodeOnClick)&&(b=u.reversed?y.length-1-a.dataPointIndex:a.dataPointIndex,0<=b)){a=b;if("funnel"===u.type||"pyramid"===u.type)u.reversed?y[y.length-1-a].exploded=
y[y.length-1-a].exploded?!1:!0:y[a].exploded=y[a].exploded?!1:!0;m(A,b,500)}};return{source:R,dest:this.plotArea.ctx,animationCallback:function(a,b){M.fadeInAnimation(a,b);1<=a&&(m(A,-1,500),v(A.plotArea.ctx||A.ctx))},easingFunction:M.easing.easeInQuad,animationBase:0}}}}};m.prototype.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){window.setTimeout(a,
...
d.setAttribute("class","canvasjs-chart-print-frame");H(d,{position:"absolute",width:"100%",border:"0px",margin:"0px 0px 0px 0px",padding:"0px 0px 0px 0px"});d.style.height=this.height+"px";this._canvasJSContainer.appendChild(d);var c=this,b=d.contentWindow||d.contentDocument.document||d.contentDocument;b.document.open();b.document.write('<!DOCTYPE HTML>\n<html><body><img src="'+a+'"/><body/></html>');b.document.body&&b.document.body.style&&(b.document.body.style.margin="0px 0px 0px 0px",b.document.body.style.padding=
...
a?da(g,d.yValueFormatString?d.yValueFormatString:c.yValueFormatString?c.yValueFormatString:c.yValueFormatString="#,##0.########",f._cultureInfo):"z"===a?da(g,d.zValueFormatString?d.zValueFormatString:c.zValueFormatString?c.zValueFormatString:c.zValueFormatString="#,##0.########",f._cultureInfo):g})};pa(K,U);K.prototype.setLayout=function(){var a=this.dockInsidePlotArea?this.chart.plotArea:this.chart,d=a.layoutManager.getFreeSpace(),c=null,b=0,e=0,f=0,l=0,h=this.markerMargin=this.chart.options.legend&&
...
p.type&&"bubble"!==p.type||!p.markerType?"error"===p.type&&p._linkedSeries?p._linkedSeries.legendMarkerType?p._linkedSeries.legendMarkerType:V.getDefaultLegendMarker(p._linkedSeries.type):V.getDefaultLegendMarker(p.type):p.markerType,g=p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:null}):p.name,r=p.legendMarkerColor=p.legendMarkerColor?p.legendMarkerColor:p.markerColor?p.markerColor:"error"===p.type?s(p.whiskerColor)?
...
markerSize:w,lineColor:p._colorSet[0],dataSeriesIndex:p.index,dataPointIndex:null,markerBorderColor:v,markerBorderThickness:u};m.push(q)}else for(var y=0;y<p.dataPoints.length;y++){var x=p.dataPoints[y],q=x.legendMarkerType?x.legendMarkerType:p.legendMarkerType?p.legendMarkerType:V.getDefaultLegendMarker(p.type),g=x.legendText?x.legendText:p.legendText?p.legendText:this.itemTextFormatter?this.itemTextFormatter({chart:this.chart,legend:this.options,dataSeries:p,dataPoint:x}):x.name?x.name:"DataPoint: "+
(y+1),r=x.legendMarkerColor?x.legendMarkerColor:p.legendMarkerColor?p.legendMarkerColor:x.color?x.color:p.color?p.color:p._colorSet[y%p._colorSet.length],w=0.75*this.lineHeight,v=x.legendMarkerBorderColor?x.legendMarkerBorderColor:p.legendMarkerBorderColor?p.legendMarkerBorderColor:x.markerBorderColor?x.markerBorderColor:p.markerBorderColor,u=x.legendMarkerBorderThickness?x.legendMarkerBorderThickness:p.legendMarkerBorderThickness?p.legendMarkerBorderThickness:x.markerBorderThickness||p.markerBorderThickness?
Math.max(1,Math.round(0.2*w)):0,g=this.chart.replaceKeywordsWithValue(g,x,p,y),q={markerType:q,markerColor:r,text:g,textBlock:null,chartType:p.type,markerSize:w,dataSeriesIndex:n,dataPointIndex:y,markerBorderColor:v,markerBorderThickness:u};(x.showInLegend||p.showInLegend&&!1!==x.showInLegend)&&m.push(q)}}!0===this.reversed&&m.reverse();if(0<m.length){p=null;r=g=x=y=0;x=null!==this.itemWidth?null!==this.itemMaxWidth?Math.min(this.itemWidth,this.itemMaxWidth,f):this.itemMaxWidth=Math.min(this.itemWidth,
...
a||"stackedLine100"===a||"stepArea"===a||"candlestick"===a||"ohlc"===a||"rangeColumn"===a||"rangeBar"===a||"rangeArea"===a||"rangeSplineArea"===a||"boxAndWhisker"===a||"waterfall"===a)return"square";if("line"===a||"stepLine"===a||"spline"===a||"pie"===a||"doughnut"===a)return"circle";if("area"===a||"splineArea"===a||"stackedArea"===a||"stackedArea100"===a||"funnel"===a||"pyramid"===a)return"triangle";if("error"===a)return"none";window.console.log("Unknown Chart Type: "+a);return null};V.prototype.getDataPointAtX=
...
q.x1&&(a<=q.x2&&d>=q.y1&&d<=q.y2)&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:Math.min(Math.abs(q.x1-a),Math.abs(q.x2-a),Math.abs(q.y1-d),Math.abs(q.y2-d))}),h=!0);break;case "line":case "stepLine":case "spline":case "area":case "stepArea":case "stackedArea":case "stackedArea100":case "splineArea":case "scatter":var s=ma("markerSize",g,this)||4,w=c?20:s,r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=
Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=s/2&&(h=!0);break;case "rangeArea":case "rangeSplineArea":s=ma("markerSize",g,this)||4;w=c?20:s;r=Math.min(Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2)),Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y2-d,2)));r<=w&&b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,distance:r});q=Math.abs(q.x1-a);q<=m?m=q:0<l?k++:n++;r<=s/2&&(h=!0);break;case "bubble":s=q.size;r=Math.sqrt(Math.pow(q.x1-a,2)+Math.pow(q.y1-d,2));r<=s/2&&(b.push({dataPoint:g,dataPointIndex:f,dataSeries:this,
...
Math.abs(q.x2-a),Math.abs(q.y2-d),Math.abs(q.y3-d))}),h=!0}if(h||1E3<k&&1E3<n)break}}else if(0>p-e&&p+e>=this.dataPoints.length)break;-1===l?(e++,l=1):l=-1}a=null;for(d=0;d<b.length;d++)a?b[d].distance<=a.distance&&(a=b[d]):a=b[d];return a};V.prototype.getMarkerProperties=function(a,d,c,b){var e=this.dataPoints;return{x:d,y:c,ctx:b,type:e[a].markerType?e[a].markerType:this.markerType,size:e[a].markerSize?e[a].markerSize:this.markerSize,color:e[a].markerColor?e[a].markerColor:this.markerColor?this.markerColor:
e[a].color?e[a].color:this.color?this.color:this._colorSet[a%this._colorSet.length],borderColor:e[a].markerBorderColor?e[a].markerBorderColor:this.markerBorderColor?this.markerBorderColor:null,borderThickness:e[a].markerBorderThickness?e[a].markerBorderThickness:this.markerBorderThickness?this.markerBorderThickness:null}};pa(A,U);A.prototype.createExtraLabelsForLog=function(a){a=(a||0)+1;if(!(5<a)){var d=this.logLabelValues[0]||this.intervalStartPosition;if(Math.log(this.range)/Math.log(d/this.viewportMinimum)<
...
Math.log(this.range)/Math.log(this.logarithmBase):Math.abs(this.range))*W[this.intervalType+"Duration"]*this.interval,f="undefined"===typeof this.options.labelMaxWidth?0.5*this.chart.width>>0:this.options.labelMaxWidth,this.chart.panEnabled||(l="undefined"===typeof this.options.labelWrap||this.labelWrap?0.8*this.chart.height>>0:1.5*this.labelFontSize);else if("left"===this._position||"right"===this._position)h=this.logarithmic&&!this.equidistantInterval&&2<=this._labels.length?this.lineCoordinates.height*
Math.log(Math.min(this._labels[this._labels.length-1].position/this._labels[this._labels.length-2].position,this._labels[1].position/this._labels[0].position))/Math.log(this.range):this.lineCoordinates.height/(this.logarithmic&&this.equidistantInterval?Math.log(this.range)/Math.log(this.logarithmBase):Math.abs(this.range))*W[this.intervalType+"Duration"]*this.interval,this.chart.panEnabled||(f="undefined"===typeof this.options.labelMaxWidth?0.3*this.chart.width>>0:this.options.labelMaxWidth),l="undefined"===
...
q[g].scaleBreaks._appliedBreaks.length)for(var r=q[g].scaleBreaks._appliedBreaks,w=0;w<r.length&&!(r[w].startValue>q[g].viewportMaximum);w++)r[w].endValue<q[g].viewportMinimum||(s(q[g].scaleBreaks.firstBreakIndex)&&(q[g].scaleBreaks.firstBreakIndex=w),r[w].startValue>=q[g].viewPortMinimum&&(q[g].scaleBreaks.lastBreakIndex=w));for(var v=w=0,u=0,y=0,x=0,z=0,A=0,B,E,D=h=0,H,J,K,r=H=J=K=!1,g=0;g<q.length;g++)q[g]&&q[g].title&&(q[g]._titleTextBlock=new ka(q[g].ctx,{text:q[g].title,horizontalAlign:"center",
fontSize:q[g].titleFontSize,fontFamily:q[g].titleFontFamily,fontWeight:q[g].titleFontWeight,fontColor:q[g].titleFontColor,fontStyle:q[g].titleFontStyle,borderColor:q[g].titleBorderColor,borderThickness:q[g].titleBorderThickness,backgroundColor:q[g].titleBackgroundColor,cornerRadius:q[g].titleCornerRadius,textBaseline:"top"}));for(g=0;g<q.length;g++)if(q[g].title)switch(q[g]._position){case "left":q[g]._titleTextBlock.maxWidth=q[g].titleMaxWidth||f.height;q[g]._titleTextBlock.maxHeight=q[g].titleWrap?
0.8*f.width:1.5*q[g].titleFontSize;q[g]._titleTextBlock.angle=-90;break;case "right":q[g]._titleTextBlock.maxWidth=q[g].titleMaxWidth||f.height;q[g]._titleTextBlock.maxHeight=q[g].titleWrap?0.8*f.width:1.5*q[g].titleFontSize;q[g]._titleTextBlock.angle=90;break;default:q[g]._titleTextBlock.maxWidth=q[g].titleMaxWidth||f.width,q[g]._titleTextBlock.maxHeight=q[g].titleWrap?0.8*f.height:1.5*q[g].titleFontSize,q[g]._titleTextBlock.angle=0}if("normal"===e){for(var y=[],x=[],z=[],A=[],M=[],P=[],O=[],R=[];4>
w;){var G=0,S=0,T=0,W=0,V=e=0,N=0,Y=0,U=0,X=0,Q=0,$=0;if(c&&0<c.length)for(z=[],g=Q=0;g<c.length;g++)z.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateWidth():0)),Q+=z[g],N+=c[g]&&!n.isNavigator?c[g].margin:0;else z.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateWidth():0));O.push(z);if(b&&0<b.length)for(A=[],g=$=0;g<b.length;g++)A.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateWidth():0)),$+=A[g],Y+=b[g]?b[g].margin:0;else A.push(Math.ceil(b[0]?b[0].createLabelsAndCalculateWidth():0));R.push(A);
l=Math.round(f.x1+Q+N);m=Math.round(f.x2-$-Y>n.width-p?n.width-p:f.x2-$-Y);if(a&&0<a.length)for(y=[],g=U=0;g<a.length;g++)a[g]&&(a[g].lineCoordinates={}),a[g].lineCoordinates.width=Math.abs(m-l),a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.width?a[g].titleMaxWidth:a[g].lineCoordinates.width),y.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateHeight():0)),U+=y[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else y.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateHeight():
0));M.push(y);if(d&&0<d.length)for(x=[],g=X=0;g<d.length;g++)d[g]&&(d[g].lineCoordinates={}),d[g].lineCoordinates.width=Math.abs(m-l),d[g].title&&(d[g]._titleTextBlock.maxWidth=0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.width?d[g].titleMaxWidth:d[g].lineCoordinates.width),x.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateHeight():0)),X+=x[g],V+=d[g]&&!n.isNavigator?d[g].margin:0;else x.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateHeight():0));P.push(x);if(a&&0<a.length)for(g=
0;g<a.length;g++)a[g]&&(a[g].lineCoordinates.x1=l,m=Math.round(f.x2-$-Y>n.width-p?n.width-p:f.x2-$-Y),a[g]._labels&&1<a[g]._labels.length&&(h=k=0,k=a[g]._labels[1],h="dateTime"===a[g].valueType?a[g]._labels[a[g]._labels.length-2]:a[g]._labels[a[g]._labels.length-1],v=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),u=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),!a[g]||(!a[g].labelAutoFit||s(B)||s(E)||n.isNavigator||n.stockChart)||(h=0,0<a[g].labelAngle?E+u>m&&(h+=0<a[g].labelAngle?E+u-m-$:0):0>a[g].labelAngle?B-v<l&&B-v<a[g].viewportMinimum&&(D=l-(N+a[g].tickLength+z+B-v+a[g].labelFontSize/2)):0===a[g].labelAngle&&(E+u>m&&(h=E+u/2-m-$),B-v<l&&B-v<a[g].viewportMinimum&&(D=l-N-a[g].tickLength-z-B+v/2)),a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0<a[g].labelAngle&&
0<h?m-=h:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0>a[g].labelAngle&&0<D?l+=D:a[g].viewportMaximum===a[g].maximum&&a[g].viewportMinimum===a[g].minimum&&0===a[g].labelAngle&&(0<D&&(l+=D),0<h&&(m-=h))),n.panEnabled?U=s(n.sessionVariables.axisX.height)?n.sessionVariables.axisX.height=U:n.sessionVariables.axisX.height:n.sessionVariables.axisX.height=U,h=Math.round(f.y2-U-e+G),k=Math.round(f.y2),a[g].lineCoordinates.x2=m,a[g].lineCoordinates.width=m-l,a[g].lineCoordinates.y1=
h,a[g].lineCoordinates.y2=h+a[g].lineThickness/2,"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.y1=a[g].lineCoordinates.y1+y[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0)-("inside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.y2=a[g].lineCoordinates.y1+a[g].lineThickness/2),a[g].bounds={x1:l,y1:h,x2:m,y2:k-(U+e-y[g]-G),width:m-l,height:k-h}),G+=y[g]+a[g].margin;if(d&&0<d.length)for(g=0;g<d.length;g++)d[g].lineCoordinates.x1=Math.round(f.x1+Q+N),d[g].lineCoordinates.x2=
Math.round(f.x2-$-Y>n.width-p?n.width-p:f.x2-$-Y),d[g].lineCoordinates.width=Math.abs(m-l),d[g]._labels&&1<d[g]._labels.length&&(k=d[g]._labels[1],h="dateTime"===d[g].valueType?d[g]._labels[d[g]._labels.length-2]:d[g]._labels[d[g]._labels.length-1],v=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),u=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-
h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle))),n.panEnabled?X=s(n.sessionVariables.axisX2.height)?n.sessionVariables.axisX2.height=X:n.sessionVariables.axisX2.height:n.sessionVariables.axisX2.height=X,h=Math.round(f.y1),k=Math.round(f.y2+d[g].margin),d[g].lineCoordinates.y1=h+X+V-S,d[g].lineCoordinates.y2=h,"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.y1=d[g-1].bounds.y1-x[g]+(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)),d[g].bounds={x1:l,y1:h+(X+
V-x[g]-S),x2:m,y2:k,width:m-l,height:k-h},S+=x[g]+d[g].margin;if(c&&0<c.length)for(g=0;g<c.length;g++)N=n.isNavigator?0:10,c[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=c[g]._labels&&0<c[g]._labels.length?c[g]._labels[c[g]._labels.length-1].textBlock.height/2:p,h=Math.round(f.y1+X+V<Math.max(N,p)?Math.max(N,p):f.y1+X+V),m=Math.round(a[0]?a[0].lineCoordinates.x1:d[0].lineCoordinates.x1),N=0<a.length?0:c[g]._labels&&0<c[g]._labels.length?c[g]._labels[0].textBlock.height/
2:p,k=Math.round(f.y2-U-e-N),c[g].lineCoordinates={x1:l-T,y1:h,x2:m-T,y2:k,height:Math.abs(k-h)},"inside"===c[g].labelPlacement&&0<g&&(c[g].lineCoordinates.x1=c[g].lineCoordinates.x1-(z[g]-(c[g]._titleTextBlock?c[g]._titleTextBlock.height:0))+("outside"===c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.x2=c[g].lineCoordinates.x1+c[g].lineThickness/2),c[g].bounds={x1:l-(z[g]+T),y1:h,x2:m,y2:k,width:m-l,height:k-h},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.height?c[g].titleMaxWidth:c[g].lineCoordinates.height),T+=z[g]+c[g].margin);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g]&&(l=Math.round(a[0]?a[0].lineCoordinates.x2:d[0].lineCoordinates.x2),m=Math.round(l),N=b[g]._labels&&0<b[g]._labels.length?b[g]._labels[b[g]._labels.length-1].textBlock.height/2:0,h=Math.round(f.y1+X+V<Math.max(N,p)?Math.max(N,p):f.y1+X+V),N=0<a.length?0:b[g]._labels&&0<b[g]._labels.length?b[g]._labels[0].textBlock.height/2:0,k=Math.round(f.y2-(U+e+N)),b[g].lineCoordinates=
...
b[g].lineCoordinates.height),W+=A[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++)a[g]&&(a[g].calculateValueToPixelConversionParameters(),a[g].calculateBreaksSizeInValues(),a[g]._labels&&1<a[g]._labels.length&&(B=(a[g].logarithmic?Math.log(a[g]._labels[1].position/a[g].viewportMinimum)/a[g].conversionParameters.lnLogarithmBase:a[g]._labels[1].position-a[g].viewportMinimum)*Math.abs(a[g].conversionParameters.pixelPerUnit)+a[g].lineCoordinates.x1,l=a[g]._labels[a[g]._labels.length-("dateTime"===
...
(0<l?l*Math.abs(d[g].conversionParameters.pixelPerUnit):0)+d[g].lineCoordinates.x1);for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<w){if(a&&0<a.length)for(g=0;g<a.length;g++)r=M[w-1][g]===M[w][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=P[w-1][g]===P[w][g]?!0:!1;else H=!0;if(c&&0<c.length)for(g=0;g<c.length;g++)J=O[w-1][g]===O[w][g]?!0:!1;else J=!0;if(b&&0<b.length)for(g=0;g<b.length;g++)K=R[w-
...
[];B=[];D=[];v=[];E=[];u=[];M=[];for(P=[];4>w;){U=W=S=T=Y=N=V=e=R=O=G=X=0;if(a&&0<a.length)for(D=[],g=W=0;g<a.length;g++)D.push(Math.ceil(a[g]?a[g].createLabelsAndCalculateWidth():0)),W+=D[g],e+=a[g]&&!n.isNavigator?a[g].margin:0;else D.push(Math.ceil(a[0]?a[0].createLabelsAndCalculateWidth():0));M.push(D);if(d&&0<d.length)for(v=[],g=U=0;g<d.length;g++)v.push(Math.ceil(d[g]?d[g].createLabelsAndCalculateWidth():0)),U+=v[g],V+=d[g]?d[g].margin:0;else v.push(Math.ceil(d[0]?d[0].createLabelsAndCalculateWidth():
0));P.push(v);if(c&&0<c.length)for(g=0;g<c.length;g++)c[g].lineCoordinates={},l=Math.round(f.x1+W+e),m=Math.round(f.x2-U-V>n.width-10?n.width-10:f.x2-U-V),c[g].labelAutoFit&&!s(y)&&(0<!a.length&&(l=0>c[g].labelAngle?Math.max(l,y):0===c[g].labelAngle?Math.max(l,y/2):l),0<!d.length&&(m=0<c[g].labelAngle?m-x/2:0===c[g].labelAngle?m-x/2:m)),c[g].lineCoordinates.x1=l,c[g].lineCoordinates.x2=m,c[g].lineCoordinates.width=Math.abs(m-l),c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<
c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width);if(b&&0<b.length)for(g=0;g<b.length;g++)b[g].lineCoordinates={},l=Math.round(f.x1+W+e),m=Math.round(f.x2-U-V>b[g].chart.width-10?b[g].chart.width-10:f.x2-U-V),b[g]&&b[g].labelAutoFit&&!s(z)&&(0<!a.length&&(l=0<b[g].labelAngle?Math.max(l,z):0===b[g].labelAngle?Math.max(l,z/2):l),0<!d.length&&(m-=A/2)),b[g].lineCoordinates.x1=l,b[g].lineCoordinates.x2=m,b[g].lineCoordinates.width=Math.abs(m-l),b[g].title&&(b[g]._titleTextBlock.maxWidth=
0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width);if(c&&0<c.length)for(p=[],g=T=0;g<c.length;g++)p.push(Math.ceil(c[g]?c[g].createLabelsAndCalculateHeight():0)),T+=p[g]+c[g].margin,N+=c[g].margin;else p.push(Math.ceil(c[0]?c[0].createLabelsAndCalculateHeight():0));E.push(p);if(b&&0<b.length)for(B=[],g=S=0;g<b.length;g++)B.push(Math.ceil(b[g]?b[g].createLabelsAndCalculateHeight():0)),S+=B[g],Y+=b[g].margin;else B.push(Math.ceil(b[0]?
b[0].createLabelsAndCalculateHeight():0));u.push(B);if(c&&0<c.length)for(g=0;g<c.length;g++)0<c[g]._labels.length&&(k=c[g]._labels[0],h=c[g]._labels[c[g]._labels.length-1],y=k.textBlock.width*Math.cos(Math.PI/180*Math.abs(k.textBlock.angle))+(k.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(k.textBlock.angle)),x=h.textBlock.width*Math.cos(Math.PI/180*Math.abs(h.textBlock.angle))+(h.textBlock.height-h.textBlock.fontSize/2)*Math.sin(Math.PI/180*Math.abs(h.textBlock.angle)));
...
c[g].tickPlacement?c[g].tickLength:0),c[g].lineCoordinates.y2=c[g].lineCoordinates.y1+c[g].lineThickness/2),c[g].bounds={x1:l,y1:h-(p[g]+X+c[g].margin),x2:m,y2:k-(X+c[g].margin),width:m-l,height:p[g]},c[g].title&&(c[g]._titleTextBlock.maxWidth=0<c[g].titleMaxWidth&&c[g].titleMaxWidth<c[g].lineCoordinates.width?c[g].titleMaxWidth:c[g].lineCoordinates.width),X+=p[g]+c[g].margin;if(b&&0<b.length)for(g=b.length-1;0<=g;g--)b[g]&&(h=Math.round(f.y1),k=Math.round(f.y1+(B[g]+b[g].margin+G)),b[g].lineCoordinates.y1=
k,b[g].lineCoordinates.y2=k,"inside"===b[g].labelPlacement&&0<g&&(b[g].lineCoordinates.y1=k-B[g]+(b[g]._titleTextBlock?b[g]._titleTextBlock.height:0)),b[g].bounds={x1:l,y1:h+(b[g].margin+G),x2:m,y2:k,width:m-l,height:S},b[g].title&&(b[g]._titleTextBlock.maxWidth=0<b[g].titleMaxWidth&&b[g].titleMaxWidth<b[g].lineCoordinates.width?b[g].titleMaxWidth:b[g].lineCoordinates.width),G+=B[g]+b[g].margin);if(a&&0<a.length)for(g=0;g<a.length;g++){N=a[g]._labels&&0<a[g]._labels.length?a[g]._labels[0].textBlock.fontSize/
2:0;l=Math.round(f.x1+e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<Math.max(N,10)?Math.max(N,10):f.y1):f.y1<Math.max(N,10)?Math.max(N,10):f.y1;m=Math.round(f.x1+W+e);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-T>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2-T):f.y2>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2;if(c&&0<c.length)for(N=0;N<c.length;N++)c[N]&&c[N].labelAutoFit&&(m=0>c[N].labelAngle?Math.max(m,y):0===c[N].labelAngle?Math.max(m,y/2):m,l=
0>c[N].labelAngle||0===c[N].labelAngle?m-W:l);if(b&&0<b.length)for(N=0;N<b.length;N++)b[N]&&b[N].labelAutoFit&&(m=b[N].lineCoordinates.x1,l=m-W);a[g].lineCoordinates={x1:m-O,y1:h,x2:m-O,y2:k,height:Math.abs(k-h)};"inside"===a[g].labelPlacement&&0<g&&(a[g].lineCoordinates.x1=a[g].lineCoordinates.x1-(D[g]-(a[g]._titleTextBlock?a[g]._titleTextBlock.height:0))+("outside"===a[g].tickPlacement?a[g].tickLength:0),a[g].lineCoordinates.x2=a[g].lineCoordinates.x1+a[g].lineThickness/2);a[g].bounds={x1:m-(D[g]+
O),y1:h,x2:m,y2:k,width:m-l,height:k-h};a[g].title&&(a[g]._titleTextBlock.maxWidth=0<a[g].titleMaxWidth&&a[g].titleMaxWidth<a[g].lineCoordinates.height?a[g].titleMaxWidth:a[g].lineCoordinates.height);a[g].calculateValueToPixelConversionParameters();a[g].calculateBreaksSizeInValues();O+=D[g]+a[g].margin}if(d&&0<d.length)for(g=0;g<d.length;g++){N=d[g]._labels&&0<d[g]._labels.length?d[g]._labels[0].textBlock.fontSize/2:0;l=Math.round(f.x1-e);h=b&&0<b.length?Math.round(b[0]?b[0].lineCoordinates.y2:f.y1<
Math.max(N,10)?Math.max(N,10):f.y1):f.y1<Math.max(N,10)?Math.max(N,10):f.y1;m=Math.round(f.x2-U-V);k=c&&0<c.length?Math.round(c[0]?c[0].lineCoordinates.y1:f.y2-T>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2-T):f.y2>n.height-Math.max(N,10)?n.height-Math.max(N,10):f.y2;if(c&&0<c.length)for(N=0;N<c.length;N++)c[N]&&c[N].labelAutoFit&&(m=0>c[N].labelAngle?Math.max(m,y):0===c[N].labelAngle?Math.max(m,y/2):m,l=0>c[N].labelAngle||0===c[N].labelAngle?m-U:l);if(b&&0<b.length)for(N=0;N<b.length;N++)b[N]&&
b[N].labelAutoFit&&(m=b[N].lineCoordinates.x2,l=m-U);d[g].lineCoordinates={x1:m+R,y1:h,x2:m+R,y2:k,height:Math.abs(k-h)};"inside"===d[g].labelPlacement&&0<g&&(d[g].lineCoordinates.x1=d[g].lineCoordinates.x1+(v[g]-(d[g]._titleTextBlock?d[g]._titleTextBlock.height:0)-2)-("outside"===d[g].tickPlacement?d[g].tickLength:0),d[g].lineCoordinates.x2=d[g].lineCoordinates.x1+d[g].lineThickness/2);d[g].bounds={x1:d[g].lineCoordinates.x1,y1:h,x2:m+v[g]+R,y2:k,width:m-l,height:k-h};d[g].title&&(d[g]._titleTextBlock.maxWidth=
0<d[g].titleMaxWidth&&d[g].titleMaxWidth<d[g].lineCoordinates.height?d[g].titleMaxWidth:d[g].lineCoordinates.height);d[g].calculateValueToPixelConversionParameters();d[g].calculateBreaksSizeInValues();R+=v[g]+d[g].margin}for(g=0;g<q.length;g++)"axisY"===q[g].type&&(q[g].calculateValueToPixelConversionParameters(),q[g].calculateBreaksSizeInValues());if(0<w){if(a&&0<a.length)for(g=0;g<a.length;g++)r=M[w-1][g]===M[w][g]?!0:!1;else r=!0;if(d&&0<d.length)for(g=0;g<d.length;g++)H=P[w-1][g]===P[w][g]?!0:
...
b/250<=a?(this.interval=250,this.intervalType="millisecond"):b/300<=a?(this.interval=300,this.intervalType="millisecond"):b/400<=a?(this.interval=400,this.intervalType="millisecond"):b/500<=a?(this.interval=500,this.intervalType="millisecond"):b/(1*W.secondDuration)<=a?(this.interval=1,this.intervalType="second"):b/(2*W.secondDuration)<=a?(this.interval=2,this.intervalType="second"):b/(5*W.secondDuration)<=a?(this.interval=5,this.intervalType="second"):b/(10*W.secondDuration)<=a?(this.interval=10,
this.intervalType="second"):b/(15*W.secondDuration)<=a?(this.interval=15,this.intervalType="second"):b/(20*W.secondDuration)<=a?(this.interval=20,this.intervalType="second"):b/(30*W.secondDuration)<=a?(this.interval=30,this.intervalType="second"):b/(1*W.minuteDuration)<=a?(this.interval=1,this.intervalType="minute"):b/(2*W.minuteDuration)<=a?(this.interval=2,this.intervalType="minute"):b/(5*W.minuteDuration)<=a?(this.interval=5,this.intervalType="minute"):b/(10*W.minuteDuration)<=a?(this.interval=
10,this.intervalType="minute"):b/(15*W.minuteDuration)<=a?(this.interval=15,this.intervalType="minute"):b/(20*W.minuteDuration)<=a?(this.interval=20,this.intervalType="minute"):b/(30*W.minuteDuration)<=a?(this.interval=30,this.intervalType="minute"):b/(1*W.hourDuration)<=a?(this.interval=1,this.intervalType="hour"):b/(2*W.hourDuration)<=a?(this.interval=2,this.intervalType="hour"):b/(3*W.hourDuration)<=a?(this.interval=3,this.intervalType="hour"):b/(6*W.hourDuration)<=a?(this.interval=6,this.intervalType=
"hour"):b/(1*W.dayDuration)<=a?(this.interval=1,this.intervalType="day"):b/(2*W.dayDuration)<=a?(this.interval=2,this.intervalType="day"):b/(4*W.dayDuration)<=a?(this.interval=4,this.intervalType="day"):b/(1*W.weekDuration)<=a?(this.interval=1,this.intervalType="week"):b/(2*W.weekDuration)<=a?(this.interval=2,this.intervalType="week"):b/(3*W.weekDuration)<=a?(this.interval=3,this.intervalType="week"):b/(1*W.monthDuration)<=a?(this.interval=1,this.intervalType="month"):b/(2*W.monthDuration)<=a?(this.interval=
2,this.intervalType="month"):b/(3*W.monthDuration)<=a?(this.interval=3,this.intervalType="month"):b/(6*W.monthDuration)<=a?(this.interval=6,this.intervalType="month"):(this.interval=b/(1*W.yearDuration)<=a?1:b/(2*W.yearDuration)<=a?2:b/(4*W.yearDuration)<=a?4:Math.floor(A.getNiceNumber(b/(a-1),!0)/W.yearDuration),this.intervalType="year"));if(null===this.viewportMinimum||isNaN(this.viewportMinimum))this.viewportMinimum=e-l/2;if(null===this.viewportMaximum||isNaN(this.viewportMaximum))this.viewportMaximum=
...
A.prototype.getLabelStartPoint=function(){var a=W[this.intervalType+"Duration"]*this.interval,a=new Date(Math.floor(this.viewportMinimum/a)*a);if("millisecond"!==this.intervalType)if("second"===this.intervalType)0<a.getMilliseconds()&&(a.setSeconds(a.getSeconds()+1),a.setMilliseconds(0));else if("minute"===this.intervalType){if(0<a.getSeconds()||0<a.getMilliseconds())a.setMinutes(a.getMinutes()+1),a.setSeconds(0),a.setMilliseconds(0)}else if("hour"===this.intervalType){if(0<a.getMinutes()||0<a.getSeconds()||
...
this.lineColor;this.ctx.fillStyle=this.color;this.ctx.beginPath();this.ctx.globalAlpha=1;O(this.id);var f,l,h,m,k,n;a=Math.max(this.spacing,3);var p=Math.max(0,this.lineThickness);this.ctx.lineWidth=p;this.ctx.setLineDash&&this.ctx.setLineDash(J(this.lineDashType,p));if("bottom"===this.scaleBreaks.parent._position||"top"===this.scaleBreaks.parent._position)if(b=1===p%2?(b.x<<0)+0.5:b.x<<0,l=1===p%2?(e.x<<0)+0.5:e.x<<0,"top"===this.scaleBreaks.parent._position?(e=this.chart.plotArea.y1,h=this.chart.plotArea.y2+
...
0,n=[];if("xySwapped"===this.chart.plotInfo.axisPlacement){var v=null;if("bottom"===this.parent._position||"top"===this.parent._position)r=this.parent.dataSeries[0].axisX.convertPixelToValue({y:d});else if("left"===this.parent._position||"right"===this.parent._position)r=this.parent.convertPixelToValue({y:d});for(var D=0;D<this.parent.dataSeries.length;D++)(v=this.parent.dataSeries[D].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[D],null!==v.dataPoint.y&&v.dataSeries.visible&&
n.push(v));v=null;if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));D=0;if("rangeBar"===n[0].dataSeries.type||"error"===n[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(n[D].dataPoint.y[0])),u=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(var y=0;y<n[r].dataPoint.y.length;y++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),u<v&&(v=u,D=r);else u=
Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<v&&(v=u,D=r);else if("stackedBar"===n[0].dataSeries.type)for(var v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),x=u=0,r=D=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),u<v&&(v=u,D=r);else x+=n[r].dataPoint.y,u=Math.abs(a-this.parent.convertValueToPixel(x)),u<v&&(v=u,D=r);else if("stackedBar100"===n[0].dataSeries.type)for(var v=
Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),z=x=u=0,r=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),u<v&&(v=u,D=r);else x+=n[r].dataPoint.y,z=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,z=100*(x/n[r].dataSeries.plotUnit.dataPointYSums[z]),u=Math.abs(a-this.parent.convertValueToPixel(z)),u<v&&(v=u,D=r);else for(v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y)),
r=D=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),u<v&&(v=u,D=r);else u=Math.abs(a-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<v&&(v=u,D=r);y=n[D];if("bottom"===this.parent._position||"top"===this.parent._position){b=0;if("rangeBar"===this.parent.dataSeries[D].type||"error"===this.parent.dataSeries[D].type){v=Math.abs(a-this.parent.convertValueToPixel(y.dataPoint.y[0]));
for(r=u=0;r<y.dataPoint.y.length;r++)u=Math.abs(a-this.parent.convertValueToPixel(y.dataPoint.y[r])),u<v&&(v=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y[b])<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y[b])<<0;this.value=y.dataPoint.y[b];k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y[b]}):s(this.options.label)?da(s(c)?y.dataPoint.y[b]:c,this.valueFormatString,this.chart._cultureInfo):
this.label}else if("stackedBar"===this.parent.dataSeries[D].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));x=u=0;for(r=D;0<=r;r--)x+=n[r].dataPoint.y,u=Math.abs(a-this.parent.convertValueToPixel(x)),u<v&&(v=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(x)<<0)+0.5:this.parent.convertValueToPixel(x)<<0;this.value=x;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):s(this.options.label)?
da(s(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label}else if("stackedBar100"===this.parent.dataSeries[D].type){v=Math.abs(a-this.parent.convertValueToPixel(n[0].dataPoint.y));z=x=u=0;for(r=D;0<=r;r--)x+=n[r].dataPoint.y,z=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,z=100*(x/n[r].dataSeries.plotUnit.dataPointYSums[z]),u=Math.abs(a-this.parent.convertValueToPixel(z)),u<v&&(v=u,b=r);m=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:
this.parent.convertValueToPixel(z)<<0;this.value=z;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z}):s(this.options.label)?da(s(c)?z:c,this.valueFormatString,this.chart._cultureInfo):this.label}else m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.y)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.y)<<0,this.value=y.dataPoint.y,k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,
crosshair:this.options,value:y.dataPoint.y}):s(this.options.label)?da(s(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;b=e=m;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};k.x=b-k.measureText().width/2;k.x+k.width>this.chart.bounds.x2?k.x=this.chart.bounds.x2-k.width:k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1);k.y=this.parent.lineCoordinates.y2+("top"===this.parent._position?-k.height+this.parent.tickLength:k.fontSize/
...
n)if(this.parent.labels[r])z=!0;else{z=!1;break}if(z){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,D=0;D<this.parent.dataSeries.length;D++)(v=this.parent.dataSeries[D].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?Aa(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?da(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);this.value=y.dataPoint.x;k.y=h+k.fontSize/2-k.measureText().height/
2+2;k.y-k.fontSize/2<this.chart.bounds.y1?k.y=this.chart.bounds.y1+k.fontSize/2+2:k.y+k.measureText().height-k.fontSize/2>this.chart.bounds.y2&&(k.y=this.chart.bounds.y2-k.measureText().height+k.fontSize/2);"left"===this.parent._position?k.x=this.parent.lineCoordinates.x2-k.measureText().width:"right"===this.parent._position&&(k.x=this.parent.lineCoordinates.x2)}}else if("bottom"===this.parent._position||"top"===this.parent._position){r=this.parent.convertPixelToValue({x:a});for(D=0;D<this.parent.dataSeries.length;D++)(v=
this.parent.dataSeries[D].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[D],null!==v.dataPoint.y&&v.dataSeries.visible&&n.push(v));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});y=n[0];b=e=m=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataPoint.x)<<0)+0.5:this.parent.convertValueToPixel(y.dataPoint.x)<<0;f=this.chart.plotArea.y1;h=this.chart.plotArea.y2;this.bounds={x1:b-p/2,y1:f,x2:e+p/2,y2:h};z=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),
r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])z=!0;else{z=!1;break}if(z){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({x:a}),v=null,D=0;D<this.parent.dataSeries.length;D++)(v=this.parent.dataSeries[D].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?
k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?Aa(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:y.dataPoint.x}):s(this.options.label)?da(y.dataPoint.x,this.valueFormatString,this.chart._cultureInfo):this.label);
...
for(D=0;D<this.parent.dataSeries.length;D++)(v=this.parent.dataSeries[D].getDataPointAtX(r,!0))&&0<=v.index&&(v.dataSeries=this.parent.dataSeries[D],null!==v.dataPoint.y&&v.dataSeries.visible&&n.push(v));if(0===n.length)return;n.sort(function(a,b){return a.distance-b.distance});D=0;if("rangeColumn"===n[0].dataSeries.type||"rangeArea"===n[0].dataSeries.type||"error"===n[0].dataSeries.type||"rangeSplineArea"===n[0].dataSeries.type||"candlestick"===n[0].dataSeries.type||"ohlc"===n[0].dataSeries.type||
"boxAndWhisker"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y[0])),r=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),u<v&&(v=u,D=r);else u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<v&&(v=u,D=r);else if("stackedColumn"===n[0].dataSeries.type||"stackedArea"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),
r=x=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),u<v&&(v=u,D=r);else x+=n[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(x)),u<v&&(v=u,D=r);else if("stackedColumn100"===n[0].dataSeries.type||"stackedArea100"===n[0].dataSeries.type)for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=z=x=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=
0;y<n[r].dataPoint.y.length;y++)u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),u<v&&(v=u,D=r);else x+=n[r].dataPoint.y,z=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,z=100*(x/n[r].dataSeries.plotUnit.dataPointYSums[z]),u=Math.abs(d-this.parent.convertValueToPixel(z)),u<v&&(v=u,D=r);else for(v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y)),r=u=0;r<n.length;r++)if(n[r].dataPoint.y&&n[r].dataPoint.y.length)for(y=0;y<n[r].dataPoint.y.length;y++)u=
Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y[y])),u<v&&(v=u,D=r);else u=Math.abs(d-this.parent.convertValueToPixel(n[r].dataPoint.y)),u<v&&(v=u,D=r);y=n[D];b=0;if("rangeColumn"===this.parent.dataSeries[D].type||"rangeArea"===this.parent.dataSeries[D].type||"error"===this.parent.dataSeries[D].type||"rangeSplineArea"===this.parent.dataSeries[D].type||"candlestick"===this.parent.dataSeries[D].type||"ohlc"===this.parent.dataSeries[D].type||"boxAndWhisker"===this.parent.dataSeries[D].type){v=
...
this.chart._cultureInfo):this.label;this.value=y.dataPoint.y[b]}else if("stackedColumn"===this.parent.dataSeries[D].type||"stackedArea"===this.parent.dataSeries[D].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));x=u=0;for(r=D;0<=r;r--)x+=n[r].dataPoint.y,u=Math.abs(d-this.parent.convertValueToPixel(x)),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(x)<<0)+0.5:this.parent.convertValueToPixel(x)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
axis:this.parent.options,crosshair:this.options,value:y.dataPoint.y}):s(this.options.label)?da(s(c)?y.dataPoint.y:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=x}else if("stackedColumn100"===this.parent.dataSeries[D].type||"stackedArea100"===this.parent.dataSeries[D].type){v=Math.abs(d-this.parent.convertValueToPixel(n[0].dataPoint.y));x=u=0;for(r=D;0<=r;r--)x+=n[r].dataPoint.y,z=n[r].dataPoint.x.getTime?n[r].dataPoint.x.getTime():n[r].dataPoint.x,z=100*(x/n[r].dataSeries.plotUnit.dataPointYSums[z]),
u=Math.abs(d-this.parent.convertValueToPixel(z)),u<v&&(v=u,b=r);w=1===q.lineWidth%2?(this.parent.convertValueToPixel(z)<<0)+0.5:this.parent.convertValueToPixel(z)<<0;k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:z}):s(this.options.label)?da(s(c)?z:c,this.valueFormatString,this.chart._cultureInfo):this.label;this.value=z}else"waterfall"===this.parent.dataSeries[D].type?(w=1===q.lineWidth%2?(this.parent.convertValueToPixel(y.dataSeries.dataPointEOs[y.index].cumulativeSum)<<
...
this.parent._position||"right"===this.parent._position){z=!1;if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])z=!0;else{z=!1;break}if(z){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({y:d}),v=null,D=0;D<this.parent.dataSeries.length;D++)(v=this.parent.dataSeries[D].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,
value:s(c)?this.parent.convertPixelToValue(a):c}):s(this.options.label)?v.dataPoint.label:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?this.parent.convertPixelToValue(d):c}):s(this.options.label)?Aa(s(c)?this.parent.convertPixelToValue(d):c,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,
...
2,k.x+k.width>this.chart.bounds.x2&&(k.x=this.chart.bounds.x2-k.width),k.x<this.chart.bounds.x1&&(k.x=this.chart.bounds.x1),"bottom"===this.parent._position?k.y=this.parent.lineCoordinates.y2+k.fontSize/2+2:"top"===this.parent._position&&(k.y=this.parent.lineCoordinates.y1-k.height+k.fontSize/2+2)}else if("bottom"===this.parent._position||"top"===this.parent._position){z=!1;n="";if(this.parent.labels)for(n=Math.ceil(this.parent.interval),r=0;r<this.parent.viewportMaximum;r+=n)if(this.parent.labels[r])z=
!0;else{z=!1;break}if(z){if("axisX"===this.parent.type)for(r=this.parent.convertPixelToValue({x:a}),v=null,D=0;D<this.parent.dataSeries.length;D++)(v=this.parent.dataSeries[D].getDataPointAtX(r,!0))&&0<=v.index&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?this.parent.convertPixelToValue(a):c}):s(this.options.label)?s(c)?v.dataPoint.label:c:this.label)}else"dateTime"===this.parent.valueType?k.text=this.labelFormatter?
this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?this.parent.convertPixelToValue(a):c}):s(this.options.label)?Aa(s(c)?this.parent.convertPixelToValue(a):c,this.valueFormatString,this.chart._cultureInfo):this.label:"number"===this.parent.valueType&&(k.text=this.labelFormatter?this.labelFormatter({chart:this.chart,axis:this.parent.options,crosshair:this.options,value:s(c)?0<this.parent.dataSeries.length?this.parent.convertPixelToValue(a):"":c}):s(this.options.label)?
...
"right"===this.parent._position)this._updatedValue=this.parent.convertPixelToValue(w);this._textBlock=k;s(c)||this.renderLabel();q.globalAlpha=g};ca.prototype.renderLabel=function(){s(this._textBlock)||(s(this._textBlock.text)||!("number"===typeof this._textBlock.text.valueOf()||0<this._textBlock.text.length)||this._hidden)||this._textBlock.render(!0)};pa(T,U);T.prototype._initialize=function(){this.updateOption("updated");this.updateOption("hidden");if(this.enabled){this.container=document.createElement("div");
...
dataSeriesIndex:f[b].dataSeries._index});d={chart:this.chart,toolTip:this.options,content:c,entries:d};this._entries=f;this.dispatchEvent("updated",d,this)}}else this.hide(),this.enabled&&this.dispatchEvent("hidden",{chart:this.chart,toolTip:this},this)}};T.prototype.highlightObjects=function(a){var d=this.chart.overlaidCanvasCtx;if(s(this.chart.clearedOverlayedCanvas)||"toolTip"===this.chart.clearedOverlayedCanvas)this.chart.resetOverlayedCanvas(),d.clearRect(0,0,this.chart.width,this.chart.height),
...
"rangeColumn"===b.type||"waterfall"===b.type?$(d,e.x1,e.y1,e.x2,e.y2,"white",0,null,!1,!1,!1,!1,0.3):"pie"===b.type||"doughnut"===b.type?qa(d,e.center,e.radius,"white",b.type,e.startAngle,e.endAngle,0.3,e.percentInnerRadius):"funnel"===b.type||"pyramid"===b.type?sa(d,e.funnelSection,0.3,"white"):"candlestick"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,Math.min(e.y2,e.y3)),d.lineTo(e.x3-b,Math.min(e.y1,e.y4)),
d.stroke(),d.beginPath(),d.moveTo(e.x3-b,Math.max(e.y1,e.y4)),d.lineTo(e.x3-b,Math.max(e.y2,e.y3)),d.stroke(),$(d,e.x1,Math.min(e.y1,e.y4),e.x2,Math.max(e.y1,e.y4),"transparent",2*e.borderThickness,e.color,!1,!1,!1,!1),d.globalAlpha=1):"ohlc"===b.type?(d.globalAlpha=1,d.strokeStyle=e.color,d.lineWidth=2*e.borderThickness,b=0===d.lineWidth%2?0:0.5,d.beginPath(),d.moveTo(e.x3-b,e.y2),d.lineTo(e.x3-b,e.y3),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y1),d.lineTo(e.x1,e.y1),d.stroke(),d.beginPath(),d.moveTo(e.x3,
e.y4),d.lineTo(e.x2,e.y4),d.stroke(),d.globalAlpha=1):"boxAndWhisker"===b.type?(d.save(),d.globalAlpha=1,d.strokeStyle=e.stemColor,d.lineWidth=2*e.stemThickness,0<e.stemThickness&&(d.beginPath(),d.moveTo(e.x3,e.y2+e.borderThickness/2),d.lineTo(e.x3,e.y1+e.whiskerThickness/2),d.stroke(),d.beginPath(),d.moveTo(e.x3,e.y4-e.whiskerThickness/2),d.lineTo(e.x3,e.y3-e.borderThickness/2),d.stroke()),d.beginPath(),$(d,e.x1-e.borderThickness/2,Math.max(e.y2+e.borderThickness/2,e.y3+e.borderThickness/2),e.x2+
...
e.lineColor,d.lineWidth=2*e.lineThickness,0<e.lineThickness&&(d.beginPath(),d.moveTo(e.x1,e.y5),d.lineTo(e.x2,e.y5),d.stroke()),d.restore(),d.globalAlpha=1):"error"===b.type&&D(d,e.x1,e.y1,e.x2,e.y2,"white",e.whiskerProperties,e.stemProperties,e.isXYSwapped,0.3))}}d.restore();d.globalAlpha=1;d.beginPath()};T.prototype.getToolTipInnerHTML=function(a){a=a.entries;var d=null,c=null,b=null,e=0,f="";this.isToolTipDefinedInData=!0;for(var h=0;h<a.length;h++)if(a[h].dataSeries.toolTipContent||a[h].dataPoint.toolTipContent){this.isToolTipDefinedInData=
...
null===d&&(d="");d+=this.chart.replaceKeywordsWithValue(f,b,c,e)}return d};T.prototype.enableAnimation=function(){if(!this.container.style.WebkitTransition){var a=this.getContainerTransition(this.containerTransitionDuration);this.container.style.WebkitTransition=a;this.container.style.MsTransition=a;this.container.style.transition=a;this.container.style.MozTransition=this.mozContainerTransition}};T.prototype.disableAnimation=function(){this.container.style.WebkitTransition&&(this.container.style.WebkitTransition=
"",this.container.style.MozTransition="",this.container.style.MsTransition="",this.container.style.transition="")};T.prototype.hide=function(a){this.container&&(this.container.style.display="none",this.currentSeriesIndex=-1,this._prevY=this._prevX=NaN,("undefined"===typeof a||a)&&this.chart.resetOverlayedCanvas())};T.prototype.show=function(a,d,c){this._updateToolTip(a,d,"undefined"===typeof c?!1:c)};T.prototype.showAtIndex=function(a,d){};T.prototype.showAtX=function(a,d){if(!this.enabled)return!1;
...
this.mozContainerTransition);this.container.style.left=c+"px";this.container.style.bottom=f+"px"}else return this.hide(!1),!1}else return this.hide(),!1;return!0};T.prototype.fixMozTransitionDelay=function(a,d){if(20<this.chart._eventManager.lastObjectId)this.mozContainerTransition=this.getContainerTransition(0);else{var c=parseFloat(this.container.style.left),c=isNaN(c)?0:c,b=parseFloat(this.container.style.bottom),b=isNaN(b)?0:b;10<Math.sqrt(Math.pow(c-a,2)+Math.pow(b-d,2))?this.mozContainerTransition=
this.getContainerTransition(0.1):this.mozContainerTransition=this.getContainerTransition(0)}};T.prototype.getContainerTransition=function(a){return"left "+a+"s ease-out 0s, bottom "+a+"s ease-out 0s"};Y.prototype.reset=function(){this.lastObjectId=0;this.objectMap=[];this.rectangularRegionEventSubscriptions=[];this.previousDataPointEventObject=null;this.eventObjects=[];w&&(this.ghostCtx.clearRect(0,0,this.chart.width,this.chart.height),this.ghostCtx.beginPath())};Y.prototype.getNewObjectTrackingId=
function(){return++this.lastObjectId};Y.prototype.mouseEventHandler=function(a){if("mousemove"===a.type||"click"===a.type){var d=[],c=Oa(a),b=null;if((b=this.chart.getObjectAtXY(c.x,c.y,!1))&&"undefined"!==typeof this.objectMap[b])if(b=this.objectMap[b],"dataPoint"===b.objectType){var e=this.chart.data[b.dataSeriesIndex],f=e.dataPoints[b.dataPointIndex],h=b.dataPointIndex;b.eventParameter={x:c.x,y:c.y,dataPoint:f,dataSeries:e.options,dataPointIndex:h,dataSeriesIndex:e.index,chart:this.chart};b.eventContext=
...
break}f?this.fireEvent(this.mouseoveredObjectMaps[c],"mouseout",a):e.push(this.mouseoveredObjectMaps[c])}this.mouseoveredObjectMaps=e;for(c=0;c<d.length;c++){e=!1;for(b=0;b<this.mouseoveredObjectMaps.length;b++)if(d[c].id===this.mouseoveredObjectMaps[b].id){e=!0;break}e||(this.fireEvent(d[c],"mouseover",a),this.mouseoveredObjectMaps.push(d[c]));"click"===a.type?this.fireEvent(d[c],"click",a):"mousemove"===a.type&&this.fireEvent(d[c],"mousemove",a)}}};Y.prototype.fireEvent=function(a,d,c){if(a&&d){var b=
...
D.version="v3.7.2 GA";window.CanvasJS&&(D&&!window.CanvasJS.Chart)&&(window.CanvasJS.Chart=D)})();
